...
```
$ tsvkit --help
usage: tsvkit [-h] [-H] [-v] [-s] [-p PATTERN] [-a ADD] [-r REORDER] [-l LIMIT] [-n NLINES] [-V] [input]
...
optional arguments:
  ...
  -l LIMIT, --limit LIMIT
                        limit of column width, used with -v, 0 for unlimited, default: 100
...
std     14.431   2.024    0.4665      0.5292      0.0877  0.085   0.1515  0.092      123.315  406.0       451.3
```
