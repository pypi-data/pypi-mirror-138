...
ColorRGB = Union[Tuple[float, float, float], Sequence[float]]           #: color red, green and blue parts
ColorRGBA = Union[Tuple[float, float, float, float], Sequence[float]]   #: ink is rgb color and alpha
