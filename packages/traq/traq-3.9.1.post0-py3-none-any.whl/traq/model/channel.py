...
class Channel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, parent_id, archived, force, topic, name, children, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, parent_id, archived, force, topic, name, children, *args, **kwargs):  # noqa: E501
        """Channel - a model defined in OpenAPI
