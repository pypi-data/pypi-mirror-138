...
class OAuth2Client(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, description, developer_id, scopes, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, description, developer_id, scopes, *args, **kwargs):  # noqa: E501
        """OAuth2Client - a model defined in OpenAPI
