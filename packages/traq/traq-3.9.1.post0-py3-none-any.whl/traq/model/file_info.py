...
class FileInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'size': (int,),  # noqa: E501
            'md5': (str,),  # noqa: E501
            'is_animated_image': (bool,),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'thumbnails': ([ThumbnailInfo],),  # noqa: E501
            'thumbnail': (FileInfoThumbnail,),  # noqa: E501
            'channel_id': (str, none_type,),  # noqa: E501
            'uploader_id': (str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, mime, size, md5, is_animated_image, created_at, thumbnails, thumbnail, channel_id, uploader_id, *args, **kwargs):  # noqa: E501
        ...
        self.size = size
        self.md5 = md5
        self.is_animated_image = is_animated_image
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, mime, size, md5, is_animated_image, created_at, thumbnails, thumbnail, channel_id, uploader_id, *args, **kwargs):  # noqa: E501
        """FileInfo - a model defined in OpenAPI
