...
class ExternalProviderUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, provider_name, linked_at, external_name, *args, **kwargs):  # noqa: E501
        """ExternalProviderUser - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, provider_name, linked_at, external_name, *args, **kwargs):  # noqa: E501
        """ExternalProviderUser - a model defined in OpenAPI
