...
class PostWebhookRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, description, channel_id, secret, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, channel_id, secret, *args, **kwargs):  # noqa: E501
        """PostWebhookRequest - a model defined in OpenAPI
