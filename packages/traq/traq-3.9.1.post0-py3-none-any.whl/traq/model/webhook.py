...
class Webhook(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, bot_user_id, display_name, description, secure, channel_id, owner_id, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, bot_user_id, display_name, description, secure, channel_id, owner_id, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """Webhook - a model defined in OpenAPI
