...
class StampStats(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, count, total_count, *args, **kwargs):  # noqa: E501
        """StampStats - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, count, total_count, *args, **kwargs):  # noqa: E501
        """StampStats - a model defined in OpenAPI
