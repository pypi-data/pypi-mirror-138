...
class PostMessageRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, content, *args, **kwargs):  # noqa: E501
        """PostMessageRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            embed (bool): メンション・チャンネルリンクを自動埋め込みするか. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
