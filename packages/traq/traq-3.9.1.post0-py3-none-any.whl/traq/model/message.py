...
class Message(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, user_id, channel_id, content, created_at, updated_at, pinned, stamps, thread_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, user_id, channel_id, content, created_at, updated_at, pinned, stamps, thread_id, *args, **kwargs):  # noqa: E501
        """Message - a model defined in OpenAPI
