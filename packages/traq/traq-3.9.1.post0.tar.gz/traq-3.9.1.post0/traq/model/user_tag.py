...
class UserTag(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tag_id, tag, is_locked, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, tag_id, tag, is_locked, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """UserTag - a model defined in OpenAPI
