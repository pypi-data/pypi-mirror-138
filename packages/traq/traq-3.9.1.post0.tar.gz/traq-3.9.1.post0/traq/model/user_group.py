...
class UserGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, description, type, icon, members, created_at, updated_at, admins, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, description, type, icon, members, created_at, updated_at, admins, *args, **kwargs):  # noqa: E501
        """UserGroup - a model defined in OpenAPI
