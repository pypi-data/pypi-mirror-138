...
from traq import rest
from traq.configuration import Configuration
from traq.exceptions import ApiTypeError, ApiValueError, ApiException
from traq.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/3.9.1-0/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_activity_timeline  # this is an instance of the class Endpoint
        api_instance.get_activity_timeline()  # this invokes api_instance.get_activity_timeline.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_activity_timeline.callable or self.callable in this class
