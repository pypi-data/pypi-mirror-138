    ...
    **Autogenerated function**
    ...
    if before:
        ...
        try:
            ...
            if parents:
                source_parent_id = parents["ret"]["Parents"][0]["Id"]

                result["old_state"]["ParentId"] = source_parent_id

                if parent_id is not None and source_parent_id != parent_id:
            ...
            if tags is not None and old_tags["result"]:
                ...
                if not update_tags_ret["result"]:
                    result["comment"] = "{} , {}".format(
                        result["comment"], str(update_tags_ret["comment"])
                    )
                    return result
    ...
    if not before or update_parent or update_tag:
        try:
            ...
            if after.get("ret"):
                ...
                if parents:
                    source_parent_id = parents["ret"]["Parents"][0]["Id"]
                    result["new_state"]["ParentId"] = source_parent_id
