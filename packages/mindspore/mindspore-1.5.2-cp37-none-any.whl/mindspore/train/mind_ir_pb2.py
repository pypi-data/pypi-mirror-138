...
_ATTRIBUTEPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type_val', full_name='mind_ir.AttributeProto.type_val', index=17,
...
_ATTRIBUTEPROTO.fields_by_name['type_val'].enum_type = _ATTRIBUTEPROTO_ATTRIBUTETYPE
