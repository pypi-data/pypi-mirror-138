...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, pulp_created=None, sock_connect_timeout=None, tls_validation=None, pulp_href=None, ca_cert=None, connect_timeout=None, rate_limit=None, max_retries=None, pulp_last_updated=None, sock_read_timeout=None, download_concurrency=None, name=None, client_cert=None, pulp_labels=None, url=None, total_timeout=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
