...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, sock_connect_timeout=None, password=None, tls_validation=None, client_key=None, proxy_username=None, ca_cert=None, connect_timeout=None, rate_limit=None, max_retries=None, sock_read_timeout=None, download_concurrency=None, proxy_password=None, name=None, client_cert=None, pulp_labels=None, url=None, total_timeout=None, headers=None, username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
