...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, name=None, pulp_last_updated=None, headers=None, url=None, sock_read_timeout=None, tls_validation=None, proxy_url=None, ca_cert=None, rate_limit=None, total_timeout=None, pulp_labels=None, pulp_created=None, client_cert=None, max_retries=None, pulp_href=None, connect_timeout=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
