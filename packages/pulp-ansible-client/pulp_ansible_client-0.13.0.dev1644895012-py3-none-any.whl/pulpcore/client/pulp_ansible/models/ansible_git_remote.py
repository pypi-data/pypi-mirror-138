...
class AnsibleGitRemote(object):
    ...
    def __init__(self, download_concurrency=None, name=None, password=None, proxy_password=None, proxy_username=None, client_key=None, headers=None, url=None, sock_read_timeout=None, tls_validation=None, proxy_url=None, ca_cert=None, rate_limit=None, total_timeout=None, pulp_labels=None, client_cert=None, max_retries=None, connect_timeout=None, sock_connect_timeout=None, username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
