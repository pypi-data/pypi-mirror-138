...
if 'sdist' not in dist.commands and compiler.find_library_file([library_path],
    ...
    # the sources.
    if compiler.compiler_type == 'msvc':
        compile_flags = ['/D'+flag for flag in convert_CMake_list_to_Python_list('_USE_MATH_DEFINES;NOMINMAX;JSBSIM_VERSION="1.1.11 [GitHub build 741/commit 10e077b486c42d38e76d1dd7f0aeb744f92d96a0]";HAVE_EXPAT_CONFIG_H')]
        if sys.version_info < (3,9):
            compile_flags = [flag.replace('"', '\\"') for flag in compile_flags]
    else:
        compile_flags = ['-D'+flag for flag in convert_CMake_list_to_Python_list('JSBSIM_VERSION="1.1.11 [GitHub build 741/commit 10e077b486c42d38e76d1dd7f0aeb744f92d96a0]";HAVE_EXPAT_CONFIG_H')]
