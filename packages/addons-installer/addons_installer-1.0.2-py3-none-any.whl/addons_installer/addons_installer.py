...
class ABCSubDirAddons(LocalOdooAddons, abc.ABC):
    def __init__(self, base_key):
        of_ref = base_key.split("_OF_")[-1]
        super(LocalOdooAddons, self).__init__(self.identifier, base_key)
