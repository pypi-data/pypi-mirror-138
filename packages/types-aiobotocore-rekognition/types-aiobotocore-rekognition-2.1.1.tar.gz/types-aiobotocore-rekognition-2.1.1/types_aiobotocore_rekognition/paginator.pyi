...
class DescribeProjectVersionsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeProjectVersionsResponseTypeDef]:
        """
...
class DescribeProjectsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeProjectsResponseTypeDef]:
        """
...
class ListCollectionsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListCollectionsResponseTypeDef]:
        """
...
class ListDatasetEntriesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        HasErrors: bool = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListDatasetEntriesResponseTypeDef]:
        """
...
class ListDatasetLabelsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListDatasetLabelsResponseTypeDef]:
        """
...
class ListFacesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListFacesResponseTypeDef]:
        """
...
class ListStreamProcessorsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListStreamProcessorsResponseTypeDef]:
        """
