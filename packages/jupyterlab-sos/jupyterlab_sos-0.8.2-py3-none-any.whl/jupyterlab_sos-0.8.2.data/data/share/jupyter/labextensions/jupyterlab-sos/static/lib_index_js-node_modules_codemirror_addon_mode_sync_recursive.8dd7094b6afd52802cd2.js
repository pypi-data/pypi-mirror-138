...
const extension = {
    ...
    activate: async (app, notebook_tracker, console_tracker, palette, codeMirror, settingRegistry) => {
        ...
        if (settingRegistry) {
            ...
            _manager__WEBPACK_IMPORTED_MODULE_10__.Manager.manager.update_config(setting);
        }
...
function saveKernelInfo() {
    let panel = _manager__WEBPACK_IMPORTED_MODULE_1__.Manager.currentNotebook;
    let info = _manager__WEBPACK_IMPORTED_MODULE_1__.Manager.manager.get_info(panel);
...
function changeStyleOnKernel(cell, kernel, info) {
    ...
    cell.node.classList.add((0,_manager__WEBPACK_IMPORTED_MODULE_1__.safe_css_name)(`sos_lan_${kernel}`));
    // cell.user_highlight = {
    //     name: 'sos',
...
function updateCellStyles(panel, info) {
    ...
    let panels = _manager__WEBPACK_IMPORTED_MODULE_1__.Manager.consolesOfNotebook(panel);
...
//# sourceMappingURL=lib_index_js-node_modules_codemirror_addon_mode_sync_recursive.8dd7094b6afd52802cd2.js.map