...
for a in address:
    tx_dict[a]=(account.get_staking_transaction_history(a, include_full_tx=True, order='ASC', endpoint=end_point))

with open('harmonyONE_staking.csv', 'w') as w:
