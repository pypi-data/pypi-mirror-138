...
versions = {}
ver_path = convert_path('aiconfig/version.py')
...
setuptools.setup(
    ...
    description="AI task configuration  with YAML.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/lf1-io/aiconfig",
    ...
    entry_points={
	'console_scripts': [
            'aiconfig = aiconfig.__main__:build'
        ]
    }
)
