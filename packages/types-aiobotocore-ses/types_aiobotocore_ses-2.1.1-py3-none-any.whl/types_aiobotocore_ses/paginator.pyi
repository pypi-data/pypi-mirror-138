...
class ListCustomVerificationEmailTemplatesPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListCustomVerificationEmailTemplatesResponseTypeDef]:
        """
...
class ListIdentitiesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListIdentitiesResponseTypeDef]:
        """
...
class ListReceiptRuleSetsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListReceiptRuleSetsResponseTypeDef]:
        """
