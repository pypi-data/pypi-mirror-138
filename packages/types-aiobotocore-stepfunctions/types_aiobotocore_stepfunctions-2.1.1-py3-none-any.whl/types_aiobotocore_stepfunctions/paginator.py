...
class GetExecutionHistoryPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[GetExecutionHistoryOutputTypeDef]:
        """
...
class ListActivitiesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListActivitiesOutputTypeDef]:
        """
...
class ListExecutionsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListExecutionsOutputTypeDef]:
        """
...
class ListStateMachinesPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListStateMachinesOutputTypeDef]:
        """
