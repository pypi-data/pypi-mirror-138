...
.. autoclass:: saorm14.orm.AppenderQuery
    :members:
...
.. currentmodule:: saorm14.orm.collections
...
with a ``@property`` as mentioned earlier::
    ...
    from saorm14.orm.collections import mapped_collection
...
parent's :class:`~saorm14.orm.session.Session` (i.e. the ``save-update``
...
.. sourcecode:: python+sql
    ...
    from saorm14.orm.collections import MappedCollection
...
.. note::
   ...
   can be used::
    ...
    from saorm14.orm.collections import _instrument_class, MappedCollection
...
.. autoclass:: saorm14.orm.collections.MappedCollection
   :members:
