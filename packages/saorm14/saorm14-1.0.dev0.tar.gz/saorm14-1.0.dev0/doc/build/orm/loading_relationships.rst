...
the most common are
:func:`~saorm14.orm.joinedload`,
:func:`~saorm14.orm.subqueryload`, :func:`~saorm14.orm.selectinload`
and :func:`~saorm14.orm.lazyload`.   The option accepts either
...
collection attribute associated with a :func:`~saorm14.orm.relationship`
...
raised::
    ...
    from saorm14.orm import raiseload
...
data fetched. Lets take two examples, a :func:`~saorm14.orm.relationship`
which references a collection, and a :func:`~saorm14.orm.relationship` that
 ...
 * When using joined loading, the load of 100 objects will emit only one SQL statement.   The join
   ...
   usually specified within the :func:`~saorm14.orm.relationship`.   For a load of objects where
...
The behavior of :func:`~saorm14.orm.joinedload()` is such that joins are
...
For this SQLAlchemy supplies the :func:`~saorm14.orm.contains_eager()`
option. This option is used in the same manner as the
:func:`~saorm14.orm.joinedload()` option except it is assumed that the
:class:`~saorm14.orm.query.Query` will specify the appropriate joins
...
Given the following mapping::
    ...
    from saorm14.orm import relationship, backref
