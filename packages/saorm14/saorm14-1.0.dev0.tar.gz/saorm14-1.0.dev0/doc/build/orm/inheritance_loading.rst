...
set up, we could get the same result as follows::
    ...
    from saorm14.orm import with_polymorphic, selectin_polymorphic
...
The :func:`~saorm14.orm.interfaces.PropComparator.of_type` method allows the
construction of joins along :func:`~saorm14.orm.relationship` paths while
...
can be used with :func:`~saorm14.orm.interfaces.PropComparator.of_type`,
...
.. autofunction:: saorm14.orm.with_polymorphic

.. autofunction:: saorm14.orm.selectin_polymorphic
