...
The :mod:`saorm14.sql.visitors` module consists of classes and functions
...
.. note:: the :mod:`saorm14.sql.visitors` module is an internal API and
...
The :mod:`saorm14.sql.visitors` module is part of the **internals** of
...
.. automodule:: saorm14.sql.visitors
   :members:
   :private-members:
