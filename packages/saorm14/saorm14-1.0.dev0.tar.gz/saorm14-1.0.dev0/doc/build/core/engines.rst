...
.. autofunction:: saorm14.engine_from_config

.. autofunction:: sqlalchemy.create_mock_engine

.. autofunction:: saorm14.engine.make_url


.. autoclass:: saorm14.engine.URL
    :members:
    ...
    .. py:attribute::  query
        ...
        for keys and either strings or tuples of strings for values, e.g.::
            ...
            >>> from saorm14.engine import make_url
...
* ``saorm14.engine`` - controls SQL echoing.  Set to ``logging.INFO`` for
...
* ``saorm14.pool`` - controls connection pool logging.  Set to
...
* ``saorm14.orm`` - controls logging of various ORM functions to the extent
...
``echo=True`` flag::
    ...
    logging.basicConfig()
    logging.getLogger('saorm14.engine').setLevel(logging.INFO)
...
parameters are a shortcut to immediate logging to ``sys.stdout``::
    ...
    ...
    2020-10-24 12:54:57,701 DEBUG saorm14.pool.impl.SingletonThreadPool Created new connection <sqlite3.Connection object at 0x7f287819ac60>
    2020-10-24 12:54:57,701 DEBUG saorm14.pool.impl.SingletonThreadPool Connection <sqlite3.Connection object at 0x7f287819ac60> checked out from pool
    2020-10-24 12:54:57,702 INFO saorm14.engine.Engine select 'hi'
    2020-10-24 12:54:57,702 INFO saorm14.engine.Engine ()
    hi
    2020-10-24 12:54:57,703 DEBUG saorm14.pool.impl.SingletonThreadPool Connection <sqlite3.Connection object at 0x7f287819ac60> being returned to pool
    2020-10-24 12:54:57,704 DEBUG saorm14.pool.impl.SingletonThreadPool Connection <sqlite3.Connection object at 0x7f287819ac60> rollback-on-return
...
Use of these flags is roughly equivalent to::
    ...
    logging.basicConfig()
    logging.getLogger("saorm14.engine").setLevel(logging.INFO)
    logging.getLogger("saorm14.pool").setLevel(logging.DEBUG)
...
The logger name of instance such as an :class:`~saorm14.engine.Engine` or
:class:`~saorm14.pool.Pool` defaults to using a truncated hex identifier
...
:func:`sqlalchemy.create_engine`::
    ...
    ...
    2020-10-24 12:47:04,291 INFO saorm14.engine.Engine.myengine select 'hi'
    2020-10-24 12:47:04,292 INFO saorm14.engine.Engine.myengine ()
...
tokens::
    ...
    2021-02-03 11:48:45,754 INFO saorm14.engine.Engine [track1] select 1
    2021-02-03 11:48:45,754 INFO saorm14.engine.Engine [track1] [raw sql] ()
    2021-02-03 11:48:45,754 DEBUG saorm14.engine.Engine [track1] Col ('1',)
    2021-02-03 11:48:45,755 DEBUG saorm14.engine.Engine [track1] Row (1,)
...
of an application without creating new engines::
    ...
    ...     conn.execute("select 1").all()
    2021-02-03 11:51:08,960 INFO saorm14.engine.Engine [track1] select 1
    2021-02-03 11:51:08,960 INFO saorm14.engine.Engine [track1] [raw sql] ()
    2021-02-03 11:51:08,960 DEBUG saorm14.engine.Engine [track1] Col ('1',)
    2021-02-03 11:51:08,961 DEBUG saorm14.engine.Engine [track1] Row (1,)

    >>> with e2.connect() as conn:
    ...     conn.execute("select 2").all()
    2021-02-03 11:52:05,518 INFO saorm14.engine.Engine [track2] Select 1
    2021-02-03 11:52:05,519 INFO saorm14.engine.Engine [track2] [raw sql] ()
    2021-02-03 11:52:05,520 DEBUG saorm14.engine.Engine [track2] Col ('1',)
    2021-02-03 11:52:05,520 DEBUG saorm14.engine.Engine [track2] Row (1,)
...
:paramref:`_sa.create_engine.hide_parameters` flag::
    ...
    ...
    2020-10-24 12:48:32,808 INFO saorm14.engine.Engine select ?
    2020-10-24 12:48:32,808 INFO saorm14.engine.Engine [SQL parameters hidden due to hide_parameters=True]
