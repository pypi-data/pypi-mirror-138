...
in conjunction with :data:`~.saorm14.sql.expression.func`::
...
datatype. For example::
    ...
    INFO saorm14.engine.base.Engine
...
created; we instead get back :class:`.BLOB`::
    ...
    INFO saorm14.engine.base.Engine PRAGMA main.table_info("my_table")
    INFO saorm14.engine.base.Engine ()
    DEBUG saorm14.engine.base.Engine Col ('cid', 'name', 'type', 'notnull', 'dflt_value', 'pk')
    DEBUG saorm14.engine.base.Engine Row (0, 'id', 'INTEGER', 0, None, 0)
    DEBUG saorm14.engine.base.Engine Row (1, 'data', 'BLOB', 0, None, 0)
