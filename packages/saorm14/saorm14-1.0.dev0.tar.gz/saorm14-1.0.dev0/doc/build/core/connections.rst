...
The :class:`~saorm14.engine.Connection` object always emits SQL statements
...
.. tip::
    ...
    emitted on the :class:`_engine.Connection` until the block ends::
        ...
        ...     conn.begin()
        ...
        2021-11-08 09:49:07,517 INFO saorm14.engine.Engine BEGIN (implicit)
        2021-11-08 09:49:07,517 INFO saorm14.engine.Engine COMMIT
...
it probably will have no effect due to autocommit mode::
    ...
    INFO saorm14.engine.Engine BEGIN (implicit)
    ...
    INFO saorm14.engine.Engine COMMIT using DBAPI connection.commit(), DBAPI should ignore due to autocommit mode
...
checking for the existence of the "a" and "b" tables::
  ...
  INFO saorm14.engine.Engine PRAGMA temp.table_info("a")
  INFO saorm14.engine.Engine [raw sql] ()
  INFO saorm14.engine.Engine PRAGMA main.table_info("b")
  INFO saorm14.engine.Engine [raw sql] ()
...
The next statements we see are the CREATE TABLE statements::
  ...
  INFO saorm14.engine.Engine [no key 0.00007s] ()
  INFO saorm14.engine.Engine
  CREATE TABLE b (
    id INTEGER NOT NULL,
    a_id INTEGER,
  ...
  INFO saorm14.engine.Engine [no key 0.00006s] ()
...
a segment looks like::
  ...
  INFO saorm14.engine.Engine INSERT INTO a (data) VALUES (?)
  INFO saorm14.engine.Engine [generated in 0.00011s] (None,)
  INFO saorm14.engine.Engine INSERT INTO a (data) VALUES (?)
  INFO saorm14.engine.Engine [cached since 0.0003533s ago] (None,)
  INFO saorm14.engine.Engine INSERT INTO a (data) VALUES (?)
  INFO saorm14.engine.Engine [cached since 0.0005326s ago] (None,)
  INFO saorm14.engine.Engine INSERT INTO b (a_id, data) VALUES (?, ?)
  INFO saorm14.engine.Engine [generated in 0.00010s] (1, None)
  INFO saorm14.engine.Engine INSERT INTO b (a_id, data) VALUES (?, ?)
  INFO saorm14.engine.Engine [cached since 0.0003232s ago] (1, None)
  INFO saorm14.engine.Engine INSERT INTO b (a_id, data) VALUES (?, ?)
  INFO saorm14.engine.Engine [cached since 0.0004887s ago] (1, None)
...
as for subsequent lazy loads of the "b" table::
  ...
  INFO saorm14.engine.Engine SELECT a.id AS a_id, a.data AS a_data
  FROM a
  INFO saorm14.engine.Engine [generated in 0.00009s] ()
  INFO saorm14.engine.Engine SELECT b.id AS b_id, b.a_id AS b_a_id, b.data AS b_data
  FROM b
  WHERE ? = b.a_id
  INFO saorm14.engine.Engine [generated in 0.00010s] (1,)
  INFO saorm14.engine.Engine SELECT b.id AS b_id, b.a_id AS b_a_id, b.data AS b_data
  FROM b
  WHERE ? = b.a_id
  INFO saorm14.engine.Engine [cached since 0.0005922s ago] (2,)
  INFO saorm14.engine.Engine SELECT b.id AS b_id, b.a_id AS b_a_id, b.data AS b_data
  FROM b
  WHERE ? = b.a_id
...
state within the construct::
    ...
    CacheKey(key=(
      '0',
      <class 'saorm14.sql.selectable.Select'>,
      '_raw_columns',
      (
        (
          '1',
          <class 'saorm14.sql.elements.ColumnClause'>,
          'name',
          'q',
          'type',
          (
            <class 'saorm14.sql.sqltypes.NullType'>,
          ),
        ),
      ),
...
key::
    ...
    CacheKey(key=(
      ...
      <class 'saorm14.sql.lambdas.StatementLambdaElement'>,
    ),)
...
represent both of these segments as well as the ``column()`` object::
    ...
    CacheKey(key=(
      ...
      <class 'saorm14.sql.lambdas.LinkedLambdaElement'>,
      (
        '0',
        <class 'saorm14.sql.elements.ColumnClause'>,
        'name',
...
2. The package should have a module containing the dialect class,
   which is typically a subclass of :class:`saorm14.engine.default.DefaultDialect`.
