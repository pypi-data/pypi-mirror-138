...
imported from the ``saorm14.pool`` module, and handles the details
...
log level along with the ``saorm14.pool`` logger, or by setting
...
.. autoclass:: saorm14.pool.QueuePool
