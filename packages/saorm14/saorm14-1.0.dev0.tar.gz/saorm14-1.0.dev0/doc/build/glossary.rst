...
.. glossary::
    ...
    one to many
        A style of :func:`~saorm14.orm.relationship` which links
    ...
    bidirectional relationship
        ...
        distinct :func:`~saorm14.orm.relationship` objects can be
        ...
        the :func:`~saorm14.orm.relationship` function explicitly
        for one side and specifying the ``backref`` keyword to it so that
        the other :func:`~saorm14.orm.relationship` is created
    ...
    many to many
        A style of :func:`saorm14.orm.relationship` which links two tables together
        ...
        In SQLAlchemy, the :func:`saorm14.orm.relationship` function
    ...
    relationships
        ...
        :func:`~saorm14.orm.relationship`.   Once created, SQLAlchemy
    ...
    association relationship
        ...
        :func:`saorm14.orm.relationship` construct as in the case
