...
.. sourcecode:: pycon+sql
    ...
    <saorm14.engine.cursor.CursorResult object ...>
...
.. sourcecode:: pycon+sql
    ...
    [...] ('squidward',){stop}
    <saorm14.engine.cursor.CursorResult object at 0x...>
...
with the exception of a special SQLAlchemy internal state object::
    ...
    >>> sandy.__dict__
    {'_sa_instance_state': <saorm14.orm.state.InstanceState object at 0x...>}
...
* It **expunges** all objects from the :class:`_orm.Session`.
  ...
  refreshed::
    ...
    Traceback (most recent call last):
      ...
    saorm14.orm.exc.DetachedInstanceError: Instance <User at 0x...> is not bound to a Session; attribute refresh operation cannot proceed
