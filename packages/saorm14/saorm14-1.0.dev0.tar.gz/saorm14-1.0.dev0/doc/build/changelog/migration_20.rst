...
moved to the ``saorm14.orm`` package.  The :func:`_orm.declarative_base`
...
To::
    ...
    from saorm14.orm import declarative_base, declared_attr
...
The ``saorm14.orm.mapper()`` standalone function moves behind the scenes to
