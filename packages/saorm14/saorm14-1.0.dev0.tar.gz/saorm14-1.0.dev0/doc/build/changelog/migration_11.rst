...
of its own ``QueryableAttribute`` wrapper::
    ...
    >>> A.some_name
    <saorm14.orm.attributes.hybrid_propertyProxy object at 0x7fde03888230>
...
within logging, exception reporting, as well as ``repr()`` of the row itself::
    ...
    2016-02-17 13:23:03,027 INFO saorm14.engine.base.Engine select ?
    2016-02-17 13:23:03,027 INFO saorm14.engine.base.Engine
    ...
    2016-02-17 13:23:03,027 DEBUG saorm14.engine.base.Engine Col ('?',)
    2016-02-17 13:23:03,027 DEBUG saorm14.engine.base.Engine
...
copy the "length" parameter as the value ``"max"``::
    ...
    ...
    <class 'saorm14.sql.sqltypes.VARCHAR'> max
...
out as None, so that the type objects work in non-SQL Server contexts::
    ...
    ...     print(col['type'].__class__, col['type'].length)
    ...
    <class 'saorm14.sql.sqltypes.VARCHAR'> None
