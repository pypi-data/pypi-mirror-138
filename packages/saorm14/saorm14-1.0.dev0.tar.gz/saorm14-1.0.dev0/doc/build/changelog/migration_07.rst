...
for ORM "composites", those configured using :func:`~.saorm14.orm.composite`.
...
on_api.html#saorm14.sql.expression.Select.distinct>`_

`Query.distinct() <https://www.sqlalchemy.org/docs/07/orm/que
ry.html#saorm14.orm.query.Query.distinct>`_
...
::
    ...
    from saorm14.sql import table, column, select, func
...
`saorm14.sql.expression.over <https://www.sqlalchemy.org/d
ocs/07/core/expression_api.html#saorm14.sql.expression.ov
er>`_
...
/connections.html#saorm14.engine.base.Connection.executio
n_options>`_
...
ession.html#saorm14.orm.session.Session.connection>`_
`Session.execute <https://www.sqlalchemy.org/docs/07/orm/sess
ion.html#saorm14.orm.session.Session.execute>`_
