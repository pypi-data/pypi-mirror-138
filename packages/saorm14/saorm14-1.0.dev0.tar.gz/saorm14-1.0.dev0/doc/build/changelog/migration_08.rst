...
A walkthrough of some key capabilities follows::
    ...
    [<saorm14.orm.properties.RelationshipProperty object at 0x1015212d0>]

    >>> # they are also namespaces
    >>> b.column_attrs.id
    <saorm14.orm.properties.ColumnProperty object at 0x101525090>
    ...
    >>> b
    <saorm14.orm.attributes.InstrumentedAttribute object at 0x101521fd0>
    ...
    >>> b
    <saorm14.orm.state.InstanceState object at 0x10152bed0>
    ...
    >>> b.attrs.id
    <saorm14.orm.state.AttributeState object at 0x10152bf90>
    ...
    >>> # owning session
    >>> b.session
    <saorm14.orm.session.Session object at 0x101701150>
...
The ``saorm14.orm.interfaces.InstrumentationManager``
class is moved to
...
point it is injected back into ``saorm14.orm`` by
