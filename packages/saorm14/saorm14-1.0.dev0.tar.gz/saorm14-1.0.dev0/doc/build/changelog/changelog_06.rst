...
.. changelog::
    ...
    .. change::
      ...
      when the import of sqlalchemy or saorm14.orm
...
.. changelog::
    ...
    .. change::
      ...
      The Session class is now present in saorm14.orm.*.
...
.. changelog::
    ...
    .. change::
      ...
      The saorm14.orm.shard module now becomes an extension,
...
.. changelog::
    ...
    .. change::
      ...
      Now uses saorm14.orm.exc.DetachedInstanceError when an
    ...
    .. change::
      ...
      Made saorm14.sql.expressions.Executable part of public
...
.. changelog::
    ...
    .. change::
       ...
       * Query.query_from_parent() is removed.  Use the
         saorm14.orm.with_parent() function to produce a
       ...
       * the 'echo_uow' flag on Session is removed.  Use
         logging on the "saorm14.orm.unitofwork" name.
    ...
    .. change::
      ...
      for "saorm14.engine" is enabled overall.  Note that the
    ...
    .. change::
      ...
      a new API called "saorm14.engine.reflection.Inspector".
