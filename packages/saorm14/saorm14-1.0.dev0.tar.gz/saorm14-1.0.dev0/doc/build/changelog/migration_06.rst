...
::
    ...
    >>> column('foo') == 5
    <saorm14.sql.expression._BinaryExpression object at 0x1252490>
...
::
    ...
    saorm14.sql select: 0.360s
    saorm14.orm fetch: 2.500s

    0.6 / Pure Python

    saorm14.sql select: 0.600s
    saorm14.orm fetch: 3.000s

    0.5 / Pure Python

    saorm14.sql select: 0.790s
    saorm14.orm fetch: 4.030s
...
* the 'echo_uow' flag on Session is removed.  Use   logging
  on the "saorm14.orm.unitofwork" name.
