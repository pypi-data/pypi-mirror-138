...
.. changelog::
    ...
    .. change::
        ...
        Restored the import for :class:`.Function` to the ``saorm14.sql.expression``
...
.. changelog::
    ...
    .. change::
        ...
        into the names used by standard functions in :mod:`saorm14.sql.functions`,
...
.. changelog::
    ...
    .. change::
        ...
        of the ORM modules.  In particular ``saorm14.sql`` has been broken
        out into several more modules than before so that the very large size
        of ``saorm14.sql.expression`` is now pared down.   The effort
        has focused on a large reduction in import cycles.   Additionally,
        the system of API functions in ``saorm14.sql.expression`` and
        ``saorm14.orm`` has been reorganized to eliminate redundancy
    ...
    .. change::
        ...
        A :func:`~saorm14.sql.expression.label` construct will now render as its name alone
