...
from saorm14 import DefaultClause
...
from saorm14 import UnicodeText
from saorm14.dialects.mssql import base as mssql
from saorm14.dialects.mssql import ROWVERSION
from saorm14.dialects.mssql import TIMESTAMP
from saorm14.dialects.mssql.base import _MSDate
from saorm14.dialects.mssql.base import BIT
from saorm14.dialects.mssql.base import DATETIMEOFFSET
from saorm14.dialects.mssql.base import MS_2005_VERSION
from saorm14.dialects.mssql.base import MS_2008_VERSION
from saorm14.dialects.mssql.base import TIME
...
class TypeDDLTest(fixtures.TestBase):
    ...
    def test_dates(
        ...
        if driver == "base":
            from saorm14.dialects.mssql import base

            dialect = base.MSDialect()
        elif driver == "pyodbc":
            from saorm14.dialects.mssql import pyodbc

            dialect = pyodbc.dialect()
        elif driver == "pymssql":
            from saorm14.dialects.mssql import pymssql
