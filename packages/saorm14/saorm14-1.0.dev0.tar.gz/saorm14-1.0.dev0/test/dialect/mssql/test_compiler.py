...
from saorm14.dialects.mssql import base as mssql_base
from saorm14.dialects.mssql.base import try_cast
...
from saorm14.testing.assertions import eq_ignore_whitespace
...
class CompileTest(fixtures.TestBase, AssertsCompiledSQL):
    ...
    def test_strict_binds(self, expr, compiled, kw):
        ...
        from saorm14.dialects.mssql.base import MSSQLStrictCompiler
