...
from saorm14.dialects.mysql import insert
from saorm14.dialects.mysql import match
from saorm14.sql import column
from saorm14.sql import table
from saorm14.sql.expression import bindparam
from saorm14.sql.expression import literal_column
...
class ReservedWordFixture(AssertsCompiledSQL):
    ...
    def mysql_mariadb_reserved_words(self):
        ...
        from saorm14.dialects.mysql import reserved_words
