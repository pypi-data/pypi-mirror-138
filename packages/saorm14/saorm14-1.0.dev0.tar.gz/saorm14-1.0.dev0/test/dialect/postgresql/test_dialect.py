...
from saorm14.dialects.postgresql import base as postgresql
from saorm14.dialects.postgresql import HSTORE
from saorm14.dialects.postgresql import JSONB
from saorm14.dialects.postgresql import psycopg as psycopg_dialect
from saorm14.dialects.postgresql import psycopg2 as psycopg2_dialect
from saorm14.dialects.postgresql.psycopg2 import EXECUTEMANY_BATCH
from saorm14.dialects.postgresql.psycopg2 import EXECUTEMANY_PLAIN
from saorm14.dialects.postgresql.psycopg2 import EXECUTEMANY_VALUES
from saorm14.engine import cursor as _cursor
...
from saorm14.testing.assertions import eq_regex
from saorm14.testing.assertions import ne_

if True:
    from saorm14.dialects.postgresql.psycopg2 import (
...
class MiscBackendTest(
    ...
    def test_notice_logging(self):
        log = logging.getLogger("saorm14.dialects.postgresql")
...
"""
    ...
    def test_quoted_name_bindparam_ok(self):
        from saorm14.sql.elements import quoted_name
