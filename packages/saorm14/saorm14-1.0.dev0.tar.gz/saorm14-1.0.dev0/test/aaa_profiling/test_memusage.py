...
from saorm14.engine import result
from saorm14.engine.processors import to_decimal_processor_factory
...
from saorm14.orm import join as orm_join
...
from saorm14.testing.util import gc_collect
...
class MemUsageTest(EnsureZeroed):
    ...
    def test_type_compile(self):
        from saorm14.dialects.sqlite.base import dialect as SQLiteDialect
    ...
    def test_ad_hoc_types(self):
        ...
        from saorm14.dialects import mysql, postgresql, sqlite
...
class CycleTest(_fixtures.FixtureTest):
    ...
    def test_proxied_attribute(self):
        from saorm14.ext import hybrid
    ...
    def test_visit_binary_product(self):
        ...
        from saorm14 import and_, func
        from saorm14.sql.util import visit_binary_product
