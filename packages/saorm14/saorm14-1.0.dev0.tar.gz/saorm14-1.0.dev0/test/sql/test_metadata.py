...
from saorm14 import PrimaryKeyConstraint
...
from saorm14.schema import CreateIndex
from saorm14.schema import DefaultClause
from saorm14.schema import DropIndex
from saorm14.sql import naming
from saorm14.sql import operators
from saorm14.sql.elements import _NONE_NAME
from saorm14.sql.elements import literal_column
...
from saorm14.testing import ComparesTables
from saorm14.testing import emits_warning
...
class ConstraintTest(fixtures.TestBase):
    ...
    def test_auto_append_lowercase_table(self):
        from saorm14 import table, column
...
class ColumnDefinitionTest(AssertsCompiledSQL, fixtures.TestBase):
    ...
    def test_custom_create(self):
        from saorm14.ext.compiler import compiles, deregister
...
class DialectKWArgTest(fixtures.TestBase):
    ...
    def _fixture(self):
        ...
        with mock.patch("saorm14.dialects.registry.load", load):
            yield
    ...
    def test_participating_bad_kw(self):
        with self._fixture():
            assert_raises_message(
                ...
                "<class 'saorm14.sql.schema.Index'>",
                Index,
                "a",
                "b",
                "c",
    ...
    def test_participating_unknown_schema_item(self):
        with self._fixture():
            ...
            assert_raises_message(
                ...
                "Argument 'participating_q_p_x' is not accepted by dialect "
                "'participating' on behalf of "
                "<class 'saorm14.sql.schema.UniqueConstraint'>",
                UniqueConstraint,
                "a",
                "b",
                participating_q_p_x=8,
    ...
    def test_foreign_key_propagate_exceptions_delayed(self):
        with self._fixture():
            ...
            assert_raises_message(
                ...
                "<class 'saorm14.sql.schema.ForeignKeyConstraint'>",
                Table,
                "t",
                m,
                c1,
