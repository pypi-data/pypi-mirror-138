...
from saorm14.sql import ClauseElement
...
from saorm14.sql.elements import _clone
from saorm14.sql.expression import _from_objects
from saorm14.sql.visitors import ClauseVisitor
from saorm14.sql.visitors import cloned_traverse
from saorm14.sql.visitors import CloningVisitor
from saorm14.sql.visitors import ReplacingCloningVisitor
...
from saorm14.testing.schema import eq_clause_element
...
class TraversalTest(
    ...
    def test_clone_anon_label(self):
        from saorm14.sql.elements import Grouping
