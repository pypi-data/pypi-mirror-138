...
from saorm14.sql import Alias
from saorm14.sql import annotation
from saorm14.sql import base
from saorm14.sql import column
from saorm14.sql import elements
from saorm14.sql import LABEL_STYLE_DISAMBIGUATE_ONLY
...
from saorm14.testing import in_
...
class AnnotationsTest(fixtures.TestBase):
    ...
    def test_custom_construction_correct_anno_subclass(self):
        # [ticket:2918]
        from saorm14.schema import Column
        from saorm14.sql.elements import AnnotatedColumnElement
