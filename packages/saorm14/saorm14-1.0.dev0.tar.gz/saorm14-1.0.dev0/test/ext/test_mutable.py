...
from saorm14.ext.mutable import MutableComposite
from saorm14.ext.mutable import MutableDict
from saorm14.ext.mutable import MutableList
from saorm14.ext.mutable import MutableSet
...
from saorm14.orm.instrumentation import ClassManager
from saorm14.orm.mapper import Mapper
...
from saorm14.types import PickleType
from saorm14.types import TypeDecorator
from saorm14.types import VARCHAR
...
class MutableColumnCopyArrayTest(_MutableListTestBase, fixtures.MappedTest):
    ...
    @classmethod
    def define_tables(cls, metadata):
        from saorm14.sql.sqltypes import ARRAY
...
class _CompositeTestBase:
    ...
    def setup_test(self):
        from saorm14.ext import mutable
