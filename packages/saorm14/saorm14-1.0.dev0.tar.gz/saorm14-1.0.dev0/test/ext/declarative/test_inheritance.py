...
from saorm14.ext.declarative import AbstractConcreteBase
from saorm14.ext.declarative import ConcreteBase
...
class ConcreteInhTest(
    ...
    def test_abstract_concrete_base_didnt_configure(self):
        ...
        assert_raises_message(
            ...
            r"saorm14.orm.configure_mappers\(\) function after all "
