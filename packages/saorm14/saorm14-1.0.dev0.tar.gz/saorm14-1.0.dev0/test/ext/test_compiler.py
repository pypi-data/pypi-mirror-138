...
from saorm14.ext.compiler import deregister
from saorm14.orm import Session
from saorm14.schema import CreateColumn
...
from saorm14.sql.expression import Executable
...
class UserDefinedTest(fixtures.TestBase, AssertsCompiledSQL):
    ...
    def test_dialect_specific(self):
        ...
        from saorm14.dialects.sqlite import base
