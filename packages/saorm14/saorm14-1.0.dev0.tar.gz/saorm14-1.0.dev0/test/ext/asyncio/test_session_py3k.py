...
from saorm14.ext.asyncio import async_object_session
from saorm14.ext.asyncio import AsyncSession
...
from saorm14.testing.assertions import is_false
...
class AsyncProxyTest(AsyncFixture):
    ...
    def test_inspect_session_no_asyncio_imported(self):
        with mock.patch("saorm14.orm.state._async_provider", None):
