...
from saorm14 import create_mock_engine
...
from saorm14.pool import NullPool
from saorm14.pool import QueuePool
...
class EngineEventsTest(fixtures.TestBase):
    ...
    def test_cant_listen_to_option_engine(self):
        ...
        assert_raises_message(
            ...
            "<class 'saorm14.engine.base.OptionEngine'> class",
            event.listen,
            base.OptionEngine,
...
class HandleErrorTest(fixtures.TestBase):
    ...
    def test_cursor_close_resultset_failed_connectionless(self):
        ...
        with mock.patch(
            "saorm14.engine.cursor.BaseCursorResult.__init__",
...
class DialectDoesntSupportCachingTest(fixtures.TestBase):
    ...
    def sqlite_no_cache_dialect(self, testing_engine):
        from saorm14.dialects.sqlite.pysqlite import SQLiteDialect_pysqlite
        from saorm14.dialects.sqlite.base import SQLiteCompiler
        ...
        from saorm14.dialects import registry
