...
from saorm14.pool.base import _AsyncConnDialect
from saorm14.pool.base import _ConnDialect
from saorm14.testing import assert_raises
from saorm14.testing import assert_raises_context_ok
...
from saorm14.testing import is_not_none
...
class QueuePoolTest(PoolTestBase):
    ...
    def test_connrec_invalidated_within_checkout_no_race(self):
        ...
        with patch(
            "saorm14.pool._ConnectionRecord.checkout",
    ...
    def test_recycle(self):
        with patch("saorm14.pool.base.time.time") as mock:
