...
from saorm14.orm import with_loader_criteria
from saorm14.orm import with_polymorphic
from saorm14.sql import and_
from saorm14.sql import sqltypes
from saorm14.sql.selectable import Join as core_join
from saorm14.sql.selectable import LABEL_STYLE_DISAMBIGUATE_ONLY
...
from saorm14.testing.util import resolve_lambda
from saorm14.util.langhelpers import hybridproperty
...
class RawSelectTest(QueryTest, AssertsCompiledSQL):
    ...
    def test_update_from_entity(self):
        from saorm14.sql import update
    ...
    def test_delete_from_entity(self):
        from saorm14.sql import delete
    ...
    def test_insert_from_entity(self):
        from saorm14.sql import insert
