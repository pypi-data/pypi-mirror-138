...
from saorm14.orm.path_registry import PathRegistry
from saorm14.orm.path_registry import PathToken
from saorm14.orm.path_registry import RootRegistry
...
class AliasedClassTest(fixtures.MappedTest, AssertsCompiledSQL):
    ...
    def _assert_has_table(self, expr, table):
        from saorm14 import Column  # override testlib's override
