...
from saorm14.orm import base as orm_base
...
from saorm14.orm import events as orm_events
from saorm14.orm import has_inherited_table
...
class DeclaredAttrTest(DeclarativeTestBase, testing.AssertsCompiledSQL):
    ...
    def test_singleton_gc(self):
        ...
        from saorm14.orm.clsregistry import _key_is_empty
