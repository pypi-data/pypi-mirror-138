...
from saorm14.testing import assert_warns
...
from saorm14.util import OrderedDict as odict
...
class EagerTest(_fixtures.FixtureTest, testing.AssertsCompiledSQL):
    ...
    def test_we_adapt_for_compound_for_getter(self):
        ...
        with mock.patch(
            "saorm14.engine.result.ResultMetaData._getter", strict_getter
        ):
    ...
    def test_useget_cancels_eager_propagated_present(self):
        ...
        from saorm14.orm.interfaces import MapperOption
