...
from saorm14.orm import object_mapper
from saorm14.orm import polymorphic_union
from saorm14.orm import relationship
from saorm14.orm import Session
from saorm14.orm import synonym
from saorm14.orm.util import instance_str
...
from saorm14.testing.assertsql import AllOf
from saorm14.testing.assertsql import CompiledSQL
from saorm14.testing.assertsql import Conditional
from saorm14.testing.assertsql import Or
...
class OptimizedLoadTest(fixtures.MappedTest):
    ...
    def test_optimized_load_subclass_labels(self):
        ...
        with mock.patch(
            "saorm14.engine.result.ResultMetaData._key_fallback",
            _key_fallback,
        ):
