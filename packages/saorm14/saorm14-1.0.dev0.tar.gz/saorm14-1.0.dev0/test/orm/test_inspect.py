...
from saorm14.orm.attributes import NO_VALUE
from saorm14.orm.base import InspectionAttr
from saorm14.orm.util import identity_key
...
class TestORMInspection(_fixtures.FixtureTest):
    ...
    def test_extension_types(self):
        from saorm14.ext.associationproxy import (
            association_proxy,
            ASSOCIATION_PROXY,
        )
        from saorm14.ext.hybrid import (
            hybrid_property,
            hybrid_method,
            HYBRID_PROPERTY,
            HYBRID_METHOD,
        )
        from saorm14 import Table, MetaData, Integer, Column
        from saorm14.orm.interfaces import NOT_EXTENSION
    ...
    def _ordered_name_fixture(self, glbls, clsname, base, supercls):
        import random
        from saorm14 import Integer, Column
        import textwrap
...
""" % (
    ...
    def test_all_orm_descriptors_pep520_classical(self):
        ...
        from saorm14 import Table, MetaData, Column, Integer
