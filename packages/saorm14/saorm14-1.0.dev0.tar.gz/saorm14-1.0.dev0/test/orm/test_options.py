...
from saorm14.testing.assertions import emits_warning
...
class PickleTest(fixtures.MappedTest):
    ...
    def user_address_fixture(self, registry):
        from saorm14.testing.pickleable import User, Address
