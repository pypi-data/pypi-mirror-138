...
from saorm14.testing.assertsql import assert_engine
from saorm14.testing.assertsql import CompiledSQL
from saorm14.testing.fixtures import ComparableEntity
...
class ChunkingTest(fixtures.DeclarativeMappedTest):
    ...
    def test_odd_number_chunks(self):
        ...
        def go():
            with mock.patch(
                "saorm14.orm.strategies.SelectInLoader._chunksize", 47
            ):
