...
from saorm14.orm import make_transient
from saorm14.orm import make_transient_to_detached
from saorm14.orm import object_session
from saorm14.orm import relationship
from saorm14.orm import Session
from saorm14.orm import sessionmaker
from saorm14.orm import was_deleted
...
from saorm14.util.compat import inspect_getfullargspec
...
class SessionInterface(fixtures.MappedTest):
    ...
    def test_refresh_arg_signature(self):
        ...
        with mock.patch.object(s, "_validate_persistent"):
            ...
            with mock.patch(
                "saorm14.orm.session.loading.load_on_ident"
            ) as load_on_ident:
            ...
            from saorm14.orm.query import ForUpdateArg
