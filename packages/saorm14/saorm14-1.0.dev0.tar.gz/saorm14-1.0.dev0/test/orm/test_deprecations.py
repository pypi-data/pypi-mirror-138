...
from saorm14.orm import with_parent
from saorm14.orm import with_polymorphic
from saorm14.orm.collections import collection
from saorm14.orm.util import polymorphic_union
...
class DeprecatedMapperTest(
    ...
    def test_listen_on_mapper_mapper_event_fn(self, registry):
        ...
        with expect_deprecated(
            r"The `saorm14.orm.mapper\(\)` symbol is deprecated and "
            "will be removed"
        ):
    ...
    def test_we_couldnt_remove_mapper_yet(self):
        ...
        with assertions.expect_raises_message(
            sa_exc.InvalidRequestError,
            r"The 'saorm14.orm.mapper\(\)' function is removed as of "
            "SQLAlchemy 2.0.",
        ):
            mapper(MyClass, t1)
...
class InstrumentationTest(fixtures.ORMTest):
    ...
    def test_name_setup(self):
        ...
        from saorm14.orm.collections import _instrument_class
...
class InstancesTest(QueryTest, AssertsCompiledSQL):
    ...
    def test_contains_eager_multi_alias(self):
        ...
        # new way:
        # from saorm14.orm.strategy_options import Load
...
class BindSensitiveStringifyTest(fixtures.MappedTest):
    ...
    def _dialect_fixture(self):
        ...
        from saorm14.engine import base
