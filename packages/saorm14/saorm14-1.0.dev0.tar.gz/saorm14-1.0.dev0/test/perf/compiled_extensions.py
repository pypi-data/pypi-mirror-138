...
class ImmutableDict(Case):
    @staticmethod
    def python():
        from saorm14.util._py_collections import immutabledict

        return immutabledict

    @staticmethod
    def c():
        from saorm14.cimmutabledict import immutabledict
...
class Processor(Case):
    @staticmethod
    def python():
        from saorm14.engine import processors

        return processors

    @staticmethod
    def c():
        from saorm14 import cprocessors as mod
    ...
    @staticmethod
    def cython():
        from saorm14.cyextension import processors as mod
...
class DistillParam(Case):
    ...
    @staticmethod
    def python():
        from saorm14.engine import _py_util

        return _py_util

    @staticmethod
    def cython():
        from saorm14.cyextension import util as mod
...
class IdentitySet(Case):
    ...
    @staticmethod
    def python():
        from saorm14.util._py_collections import IdentitySet

        return IdentitySet

    @staticmethod
    def cython():
        from saorm14.cyextension import collections
...
class OrderedSet(IdentitySet):
    ...
    @staticmethod
    def python():
        from saorm14.util._py_collections import OrderedSet
...
class TupleGetter(Case):
    @staticmethod
    def python():
        from saorm14.engine._py_row import tuplegetter

        return tuplegetter

    @staticmethod
    def c():
        from saorm14 import cresultproxy

        return cresultproxy.tuplegetter

    @staticmethod
    def cython():
        from saorm14.cyextension import resultproxy
...
class BaseRow(Case):
    @staticmethod
    def python():
        from saorm14.engine._py_row import BaseRow

        return BaseRow

    @staticmethod
    def c():
        from saorm14.cresultproxy import BaseRow
    ...
    def init_objects(self):
        from saorm14.engine.result import SimpleResultMetaData
...
class CacheAnonMap(Case):
    @staticmethod
    def python():
        from saorm14.sql._py_util import cache_anon_map

        return cache_anon_map

    @staticmethod
    def cython():
        from saorm14.cyextension.util import cache_anon_map
    ...
    def init_objects(self):
        from saorm14 import column, bindparam
...
class PrefixAnonMap(Case):
    @staticmethod
    def python():
        from saorm14.sql._py_util import prefix_anon_map

        return prefix_anon_map

    @staticmethod
    def cython():
        from saorm14.cyextension.util import prefix_anon_map
    ...
    def init_objects(self):
        from saorm14.sql.elements import _anonymous_label
