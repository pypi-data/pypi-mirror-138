...
class DisconnectionError(SQLAlchemyError):
    ...
    the pool gives up and raises :class:`~saorm14.exc.InvalidRequestError`
...
class NoInspectionAvailable(InvalidRequestError):
    """A subject passed to :func:`saorm14.inspection.inspect` produced
...
class NoResultFound(InvalidRequestError):
    ...
    .. versionchanged:: 1.4  This exception is now part of the
       ``saorm14.exc`` module in Core, moved from the ORM.  The symbol
       remains importable from ``saorm14.orm.exc``.
...
class DontWrapMixin:
    ...
    E.g.::
        ...
        from saorm14.exc import DontWrapMixin
...
class StatementError(SQLAlchemyError):
    ...
    @_preloaded.preload_module("saorm14.sql.util")
    def _sql_message(self) -> str:
        if typing.TYPE_CHECKING:
