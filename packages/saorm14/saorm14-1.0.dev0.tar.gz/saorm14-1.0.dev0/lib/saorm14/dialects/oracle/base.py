...
specify sequences, use the saorm14.schema.Sequence object which is passed
...
* the NVARCHAR2 and NCLOB datatypes are no longer generated as DDL when
  the :class:`~saorm14.types.Unicode` is used - VARCHAR2 and CLOB are issued
  instead. This because these types don't seem to work correctly on Oracle 8
  even though they are available. The :class:`~saorm14.types.NVARCHAR` and
  :class:`~saorm14.dialects.oracle.NCLOB` types will always generate
  NVARCHAR2 and NCLOB.
