...
def insert(table):
    ...
    .. container:: inherited_member
        ...
        The :func:`saorm14.dialects.sqlite.insert` function creates
        a :class:`saorm14.dialects.sqlite.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`saorm14.dialects.sqlite.insert` function.
