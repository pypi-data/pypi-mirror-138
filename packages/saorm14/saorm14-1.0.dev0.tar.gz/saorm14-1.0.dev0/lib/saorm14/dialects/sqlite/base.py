...
:class:`~saorm14.types.DateTime` and related types provide date formatting
...
.. seealso::
    ...
    :ref:`saorm14.ext.compiler_toplevel`
...
* The ``PRAGMA foreign_keys = ON`` statement must be emitted on all
  ...
  :meth:`saorm14.schema.MetaData.create_all`.
...
class DATETIME(_DateTimeMixin, sqltypes.DateTime):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from saorm14.dialects.sqlite import DATETIME
...
class DATE(_DateTimeMixin, sqltypes.Date):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from saorm14.dialects.sqlite import DATE
...
class TIME(_DateTimeMixin, sqltypes.Time):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from saorm14.dialects.sqlite import TIME
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.dbapi is not None:
            ...
            # see https://www.saorm14.org/trac/ticket/2568
