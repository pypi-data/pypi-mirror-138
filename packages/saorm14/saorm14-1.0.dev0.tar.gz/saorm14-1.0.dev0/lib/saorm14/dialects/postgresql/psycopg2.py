...
via the ``saorm14.dialects.postgresql`` logger.  When this logger
is set to the ``logging.INFO`` level, notice messages will be logged::

    import logging

    logging.getLogger('saorm14.dialects.postgresql').setLevel(logging.INFO)
...
logger = logging.getLogger("saorm14.dialects.postgresql")
