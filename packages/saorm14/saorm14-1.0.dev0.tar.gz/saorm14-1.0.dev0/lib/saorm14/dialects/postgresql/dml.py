...
def insert(table):
    ...
    .. container:: inherited_member
        ...
        The :func:`saorm14.dialects.postgresql.insert` function creates
        a :class:`saorm14.dialects.postgresql.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`saorm14.dialects.postgresql.insert` function.
