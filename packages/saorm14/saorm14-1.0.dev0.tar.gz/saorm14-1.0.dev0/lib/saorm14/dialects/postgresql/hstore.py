...
class HSTORE(sqltypes.Indexable, sqltypes.Concatenable, sqltypes.TypeEngine):
    ...
    * Concatenation::
    ...
    now part of the :mod:`saorm14.ext.mutable`
    ...
    When the :mod:`saorm14.ext.mutable` extension is not used, the ORM
...
class hstore(sqlfunc.GenericFunction):
    ...
    E.g.::
        ...
        from saorm14.dialects.postgresql import array, hstore
