...
use the :func:`~saorm14.schema.Sequence` construct::
...
:func:`~saorm14.sql.expression.insert()` construct is executed using
...
:class:`_schema.Column` can be used to control its behavior::
    ...
    from saorm14 import Table, Column, MetaData, Integer, Computed
...
reflection process as follows::
    ...
    >>> from saorm14 import Table, MetaData, create_engine, text
    ...
    ...                       autoload_with=conn)
    ...
    <saorm14.engine.result.CursorResult object at 0x101612ed0>
...
:meth:`_schema.MetaData.reflect`::
    ...
    ...
    <saorm14.engine.result.CursorResult object at 0x1016126d0>
...
The :class:`_postgresql.TSVECTOR` type can provide for explicit CAST::
    ...
    from saorm14.dialects.postgresql import TSVECTOR
    from saorm14 import select, cast
...
of :class:`.PGInspector`, which offers additional methods::
    ...
    from saorm14 import create_engine, inspect
...
* ``NOT VALID``:  This option applies towards CHECK and FOREIGN KEY constraints
  ...
  When using a SQL migration tool such as `Alembic <https://alembic.saorm14.org>`_
...
* ``json_populate_record()``::
    ...
    >>> from saorm14 import select, func, literal_column
    >>> stmt = select(
...
* ``json_to_record()`` - this form uses a PostgreSQL specific form of derived
  ...
  columns specification::
    ...
    >>> from saorm14 import select, func, column, Integer, Text
    >>> stmt = select(
...
* ``unnest()`` - in order to generate a PostgreSQL ARRAY literal, the
  ...
  that's of type :class:`_types.ARRAY`::
    ...
    >>> from saorm14 import table, column, ARRAY, Integer
    >>> from saorm14 import select, func
...
:func:`_sql.tuple_` construct::
    ...
    >>> from saorm14 import table, column, func, tuple_
...
itself::
    ...
    >>> from saorm14 import table, column, func, select
    ...
    def __init__(self, *enums, **kw):
        ...
        if native_enum is False:
            util.warn(
                ...
                "saorm14.dialects.postgresql.ENUM datatype; this type "
                "always refers to ENUM.   Use saorm14.types.Enum for "
                "non-native enum."
            )
