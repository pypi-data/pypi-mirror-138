...
the ``first_connect`` and ``connect`` events::
    ...
    from saorm14 import create_engine, event
...
them ignored on a MySQL / MariaDB backend, use a custom compile rule::
    ...
    from saorm14.schema import ForeignKeyConstraint
...
:class:`~saorm14.ForeignKeyConstraint` at reflection time::
...
parameter and pass a textual clause that also includes the ON UPDATE clause::
    ...
    from saorm14 import Table, MetaData, Column, Integer, String, TIMESTAMP
...
``nullable=False``.   The following example illustrates::
    ...
    from saorm14 import MetaData, Integer, Table, Column, text
    from saorm14.dialects.mysql import TIMESTAMP
...
class MySQLDDLCompiler(compiler.DDLCompiler):
    def get_column_specification(self, column, **kw):
        ...
        # see: https://docs.saorm14.org/en/latest/dialects/mysql.html#mysql_timestamp_null  # noqa
