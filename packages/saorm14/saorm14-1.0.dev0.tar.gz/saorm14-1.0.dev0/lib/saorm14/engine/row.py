...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from saorm14.cyextension.resultproxy import BaseRow
    from saorm14.cyextension.resultproxy import KEY_INTEGER_ONLY
    from saorm14.cyextension.resultproxy import KEY_OBJECTS_ONLY
