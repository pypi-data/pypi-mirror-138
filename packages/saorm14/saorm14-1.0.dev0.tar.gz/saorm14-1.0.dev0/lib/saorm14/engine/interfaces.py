...
class Dialect:
    ...
    """A dictionary of TypeEngine classes from saorm14.types mapped
...
class ExecutionContext:
    ...
    compiled
      if passed to constructor, saorm14.engine.base.Compiled object
      being executed,
    ...
    def get_result_cursor_strategy(self, result):
        ...
        A simplified version of the default implementation is::
            ...
            from saorm14.engine.result import DefaultCursorFetchStrategy
        ...
        cursor that might be closed, an implementation might be::
            ...
            from saorm14.engine.result import (
...
class ExceptionContext:
    ...
    """The :class:`saorm14.exc.StatementError` which wraps the original,
