...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    _sqla_logger_namespace = "saorm14.engine.Connection"

    # used by saorm14.engine.util.TransactionalContext
    ...
    def execution_options(self, **opt):
        ...
        :param logging_token: Available on: :class:`_engine.Connection`,
          ...
          ``logging.getLogger("saorm14.engine")`` logger. This allows a
    ...
    def invalidate(self, exception=None):
        ...
        :class:`~saorm14.exc.InvalidRequestError`.
...
class Engine(
    ...
    """
    Connects a :class:`~saorm14.pool.Pool` and
    :class:`~saorm14.engine.interfaces.Dialect` together to provide a
    ...
    :func:`~saorm14.create_engine` function.
    ...
    _sqla_logger_namespace = "saorm14.engine.Engine"
    _is_future = False
    ...
    def execution_options(self, **opt):
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        to change the current schema on a database connection::
            ...
            from saorm14.engine import Engine
    ...
    @property
    def name(self):
        """String name of the :class:`~saorm14.engine.interfaces.Dialect`
    ...
    @property
    def driver(self):
        """Driver name of the :class:`~saorm14.engine.interfaces.Dialect`
        in use by this :class:`Engine`."""
