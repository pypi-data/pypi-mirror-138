...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    :class:`~saorm14.engine.interfaces.Dialect`, providing a
    ...
    or a :class:`_engine.Connection`::
        ...
        from saorm14 import inspect, create_engine
        engine = create_engine('...')
        insp = inspect(engine)

    Where above, the :class:`~saorm14.engine.interfaces.Dialect` associated
    ...
    def __init__(self, bind):
        ...
        :param bind: a :class:`~saorm14.engine.Connection`,
          which is typically an instance of
          :class:`~saorm14.engine.Engine` or
          :class:`~saorm14.engine.Connection`.
    ...
    def from_engine(cls, bind):
        ...
        :param bind: a :class:`~saorm14.engine.Connection`
         or :class:`~saorm14.engine.Engine`.

        This method differs from direct a direct constructor call of
        :class:`_reflection.Inspector` in that the
        :class:`~saorm14.engine.interfaces.Dialect` is given a chance to
    ...
    def get_columns(self, table_name, schema=None, **kw):
        ...
        * ``type`` - the type of this column; an instance of
          :class:`~saorm14.types.TypeEngine`
    ...
    def reflect_table(
        ...
        table reflection.  Direct usage is like::
            ...
            from saorm14 import create_engine, MetaData, Table
        ...
        :param table: a :class:`~saorm14.schema.Table` instance.
