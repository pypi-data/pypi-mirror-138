        ...
        if reg is None:
            ...
            if not isinstance(reg, registry):
                raise exc.InvalidRequestError(
                    ...
                    "or registry is not a saorm14.orm.registry() object"
                )
            else:
    ...
    if reg is not None:
        if not isinstance(reg, registry):
            raise exc.InvalidRequestError(
                ...
                "not an instance of saorm14.orm.registry()"
            )
    else:
...
def declarative_base(
    ...
    appropriate :class:`~saorm14.schema.Table` objects and makes
    ...
    .. versionchanged:: 1.4  The :func:`_orm.declarative_base`
       ...
       ``saorm14.orm`` package from the ``declarative.ext`` package.


    :param metadata:
      An optional :class:`~saorm14.schema.MetaData` instance.  All
      :class:`~saorm14.schema.Table` objects implicitly declared by
      subclasses of the base will share this MetaData.  A MetaData instance
      will be created if none is provided.  The
      :class:`~saorm14.schema.MetaData` instance will be available via the
...
class registry:
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
      ...
      provided by the ``saorm14.orm.mapper()`` classical mapping function,
