...
def polymorphic_union(
    ...
    :param aliasname: name of the :func:`~saorm14.sql.expression.alias()`
     construct generated.
...
class AliasedClass:
    ...
    The ORM equivalent of a :func:`~saorm14.sql.expression.alias`
    construct, this object mimics the mapped class using a
    ``__getattr__`` scheme and maintains a reference to a
    real :class:`~saorm14.sql.expression.Alias` object.
    ...
    def _get_from_serialized(self, key, mapped_class, aliased_insp):
        ...
        # saorm14.ext.serializer extension
...
def randomize_unitofwork():
    ...
    """
    from saorm14.orm import unitofwork, session, mapper, dependency
    from saorm14.util import topological
    from saorm14.testing.util import RandomSet
