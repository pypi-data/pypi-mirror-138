...
# these can be replaced by saorm14.ext.instrumentation
...
def object_mapper(instance):
    ...
    Raises :class:`saorm14.orm.exc.UnmappedInstanceError`
    ...
    :class:`saorm14.exc.NoInspectionAvailable` if the instance is
...
def class_mapper(class_, configure=True):
    ...
    Using the inspection system will raise
    :class:`saorm14.exc.NoInspectionAvailable` if the class is not mapped.
