...
or global basis using the :mod:`saorm14.ext.instrumentation`
module, which provides the means to build and specify
alternate instrumentation forms.

.. versionchanged: 0.8
   The instrumentation extension system was moved out of the
   ORM and into the external :mod:`saorm14.ext.instrumentation`
   package.  When that package is imported, it installs
   itself within saorm14.orm so that its more comprehensive
...
# this attribute is replaced by saorm14.ext.instrumentation
# when imported.
_instrumentation_factory = InstrumentationFactory()

# these attributes are replaced by saorm14.ext.instrumentation
