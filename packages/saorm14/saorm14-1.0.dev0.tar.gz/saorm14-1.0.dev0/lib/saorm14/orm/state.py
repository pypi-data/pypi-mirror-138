...
# optionally late-provided by saorm14.ext.asyncio.session
...
class InstanceState(interfaces.InspectionAttrInfo):
    ...
    @property
    @util.preload_module("saorm14.orm.session")
    def _attached(self):
        return (
    ...
    def async_session(self):
        ...
        This attribute is only non-None when the :mod:`saorm14.ext.asyncio`
