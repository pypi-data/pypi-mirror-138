...
class Query(
    ...
    def label(self, name):
        ...
        Analogous to :meth:`saorm14.sql.expression.SelectBase.label`.
    ...
    def scalar_subquery(self):
        ...
        Analogous to
        :meth:`saorm14.sql.expression.SelectBase.scalar_subquery`.
    ...
    def enable_eagerloads(self: SelfQuery, value) -> SelfQuery:
        ...
        eager joins regardless of :func:`~saorm14.orm.joinedload`,
        :func:`~saorm14.orm.subqueryload` options
    ...
    def execution_options(self: SelfQuery, **kwargs) -> SelfQuery:
        ...
        automatically if the :meth:`~saorm14.orm.query.Query.yield_per()`
    ...
    def union_all(self, *q):
        ...
        Works the same way as :meth:`~saorm14.orm.query.Query.union`. See
    ...
    def join(
        ...
        **Joins to a Target with an ON Clause**
        ...
        aliases set up using the :func:`~saorm14.orm.aliased` function::
    ...
    def one_or_none(self):
        ...
        no rows.  Raises ``saorm14.orm.exc.MultipleResultsFound``
    ...
    def one(self):
        ...
        Raises ``saorm14.orm.exc.NoResultFound`` if the query selects
        no rows.  Raises ``saorm14.orm.exc.MultipleResultsFound``
        if multiple object identities are returned, or if multiple
        rows are returned for a query that returns only scalar values
        as opposed to full identity-mapped entities.
    ...
    def count(self):
        ...
        other aggregate functions, use :attr:`~saorm14.sql.expression.func`
...
class FromStatement(GroupedElement, SelectBase, Executable):
    ...
    def _compiler_dispatch(self, compiler, **kw):
        ...
        This is roughly similar to using the saorm14.ext.compiler
        ``@compiles`` extension.
