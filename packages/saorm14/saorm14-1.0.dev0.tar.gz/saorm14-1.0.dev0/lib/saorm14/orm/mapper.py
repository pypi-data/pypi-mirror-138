...
Defines the :class:`~saorm14.orm.mapper.Mapper` class, the central
configurational unit which associates a class with a database table.

This is a semi-private module; the main configurational API of the ORM is
available in :class:`~saorm14.orm.`.
...
class Mapper(
    ...
    def __init__(
        ...
        :param version_id_col: A :class:`_schema.Column`
           ...
           version id, a
           :class:`~saorm14.orm.exc.StaleDataError` exception is
           thrown.
    ...
    def _configure_class_instrumentation(self):
        ...
        if manager is None or not manager.registry:
            raise sa_exc.InvalidRequestError(
                ...
                " Please use the saorm14.orm.registry.map_imperatively() "
    ...
    @util.preload_module("saorm14.orm.descriptor_props")
    ...
    @util.preload_module("saorm14.orm.relationships")
    @HasMemoized.memoized_attribute
    ...
    def identity_key_from_instance(self, instance):
        ...
        :class:`~saorm14.orm.exc.ObjectDeletedError` is raised.
    ...
    @util.preload_module("saorm14.orm.strategy_options")
...
@util.preload_module("saorm14.orm.decl_api")
