...
class _SessionClassMethods:
    ...
    @classmethod
    @util.preload_module("saorm14.orm.util")
...
class Session(_SessionClassMethods):
    ...
    def prepare(self):
        ...
        :exc:`~saorm14.exc.InvalidRequestError`.

        Only root transactions of two phase sessions can be prepared. If the
        current transaction is not such, an
        :exc:`~saorm14.exc.InvalidRequestError` is raised.
    ...
    def get_bind(
        ...
        6. No bind can be found, :exc:`~saorm14.exc.UnboundExecutionError`
           is raised.
    ...
    def get(
        ...
        If not, :class:`~saorm14.orm.exc.ObjectDeletedError` is raised.
