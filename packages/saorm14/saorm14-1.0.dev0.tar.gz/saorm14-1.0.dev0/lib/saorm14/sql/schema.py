...
All entities are subclasses of :class:`~saorm14.schema.SchemaItem`, and as
defined in this module they are intended to be agnostic of any vendor-specific
constructs.

A collection of entities are grouped into a unit called
:class:`~saorm14.schema.MetaData`. MetaData serves as a logical grouping of
schema elements, and can also be associated with an actual database connection
such that operations involving the contained elements can contact the database
as needed.

Two of the elements here also build upon their "syntactic" counterparts, which
are defined in :class:`~saorm14.sql.expression.`, specifically
:class:`~saorm14.schema.Table` and :class:`~saorm14.schema.Column`.
...
class Column(DialectKWArgs, SchemaItem, ColumnClause[_T]):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param name: The name of this column as represented in the database.
          ...
          usage within the :mod:`~saorm14.ext.declarative` extension.

        :param type\_: The column's type, indicated using an instance which
          subclasses :class:`~saorm14.types.TypeEngine`.  If no arguments
        ...
        :param onupdate: A scalar, Python callable, or
            :class:`~saorm14.sql.expression.ClauseElement` representing a
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            or :func:`~saorm14.sql.expression.text` construct representing
            ...
            A :func:`~saorm14.sql.expression.text` expression will be
            ...
            valid SQLAlchemy expressions or constructs::
                ...
                from saorm14 import Table, Column, MetaData, ARRAY, Text
