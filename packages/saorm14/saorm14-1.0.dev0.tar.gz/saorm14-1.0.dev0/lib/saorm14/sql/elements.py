...
def literal(value, type_=None):
    ...
    subclass,
    such as a :class:`~saorm14.schema.Column` object.  Use this function
    ...
    :param type\_: an optional :class:`~saorm14.types.TypeEngine` which
...
def literal_column(text, type_=None):
    ...
    :param type\_: an optional :class:`~saorm14.types.TypeEngine`
      object which will
...
class CompilerElement(Visitable):
    ...
    @util.preload_module("saorm14.engine.default")
    @util.preload_module("saorm14.engine.url")
...
class ColumnElement(
    ...
    of :class:`_expression.ColumnElement`::
        ...
        >>> column('a') + column('b')
        <saorm14.sql.expression.BinaryExpression object at 0x101029dd0>
...
class TextClause(
    ...
    @util.preload_module("saorm14.sql.selectable")
    def columns(self, *cols, **types):
        ...
        of a "selectable"::
            ...
            from saorm14.sql import column, text
...
class Cast(WrapsColumnExpression, ColumnElement[_T]):
    ...
    as in::
        ...
        from saorm14 import cast, Numeric
...
class FunctionFilter(ColumnElement):
    ...
    def over(self, partition_by=None, order_by=None, range_=None, rows=None):
        ...
        is shorthand for::
            ...
            from saorm14 import over, funcfilter
...
class quoted_name(util.MemoizedSlots, str):
    ...
    .. versionchanged:: 1.2 The :class:`.quoted_name` construct is now
       importable from ``saorm14.sql``, in addition to the previous
       location of ``saorm14.sql.elements``.
