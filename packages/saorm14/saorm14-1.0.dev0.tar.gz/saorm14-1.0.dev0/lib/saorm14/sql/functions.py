...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    def scalar_table_valued(self, name, type_=None):
        ...
        E.g.::
            ...
            >>> from saorm14 import func, select
    ...
    def columns(self):
        ...
        placed in the FROM clause of a statement::
            ...
            >>> from saorm14 import column, select, func
    ...
    def alias(self, name=None):
        ...
        e.g.::
            ...
            >>> from saorm14 import func, select, column
...
class _FunctionGenerator:
    ...
    :class:`~saorm14.types.Unicode` as the type:
...
class GenericFunction(Function):
    ...
    on or off for the name, use the :class:`.saorm14.sql.quoted_name`
    construct::
