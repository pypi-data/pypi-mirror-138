...
class CreateColumn(_DDLCompiles):
    ...
    compiler extension documented in :ref:`saorm14.ext.compiler_toplevel`
    ...
    as follows::
        ...
        from saorm14 import Table, Metadata, Column, Integer, String
        from saorm14 import schema
...
class SchemaDropper(DDLBase):
    ...
    def visit_table(
        ...
        # set up as server side defaults (see https://docs.saorm14.org/en/
