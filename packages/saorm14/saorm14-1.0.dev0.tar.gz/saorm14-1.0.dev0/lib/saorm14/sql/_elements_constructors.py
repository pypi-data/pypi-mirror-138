...
def outparam(key, type_=None):
    ...
    :class:`~saorm14.engine.CursorResult` object via its ``out_parameters``
...
def case(*whens, value=None, else_=None) -> "Case[Any]":
    ...
    as in::
        ...
        from saorm14 import case, literal_column
...
def distinct(expr):
    ...
    as in::
        ...
        from saorm14 import distinct, func
...
def funcfilter(func, *criterion) -> "FunctionFilter":
    ...
    E.g.::
        ...
        from saorm14 import funcfilter
...
def nulls_first(column):
    ...
    should be handled when they are encountered during ordering::
        ...
        from saorm14 import desc, nulls_first
...
def nulls_last(column):
    ...
    should be handled when they are encountered during ordering::
        ...
        from saorm14 import desc, nulls_last
...
def tuple_(*clauses: roles.ExpressionElementRole, types=None) -> "Tuple":
    ...
    .. warning::
        ...
        :class:`~saorm14.exc.DBAPIError` when such an expression is
        invoked.
