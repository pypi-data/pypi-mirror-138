    ...
    def __init__(
        ...
        :param collation: Optional, a column-level collation for
          ...
          E.g.::
            ...
            >>> from saorm14 import cast, select, String
...
class Enum(Emulated, String, TypeEngine[Union[str, enum.Enum]], SchemaType):
    ...
    @util.preload_module("saorm14.sql.schema")
    def _set_table(self, column, table):
...
class Interval(Emulated, _AbstractInterval, TypeDecorator):
    ...
    :attr:`~saorm14.sql.expression.func`).
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    .. note::  :class:`_types.JSON`
       ...
       * PostgreSQL - see :class:`saorm14.dialects.postgresql.JSON` and
         :class:`saorm14.dialects.postgresql.JSONB` for backend-specific
         notes

       * MySQL - see
         :class:`saorm14.dialects.mysql.JSON` for backend-specific notes

       * SQLite as of version 3.9 - see
         :class:`saorm14.dialects.sqlite.JSON` for backend-specific notes

       * Microsoft SQL Server 2016 and later - see
         :class:`saorm14.dialects.mssql.JSON` for backend-specific notes
    ...
    * Data casters for specific JSON element types, subsequent to an index
    ...
    :class:`saorm14.dialects.postgresql.JSON` and
    :class:`saorm14.dialects.postgresql.JSONB` which both offer additional
    ...
    * :meth:`.JSON.Comparator.as_integer` - return the element as an integer
    ...
    .. note::
        ...
        this looked like::
           ...
           from saorm14 import cast, type_coerce
           from saorm14 import String, JSON
           cast(
    ...
    **Detecting Changes in JSON columns when using the ORM**
    ...
    :mod:`saorm14.ext.mutable` extension must be used.  This extension will
    ...
    **Customizing the JSON Serializer**
    ...
    .. seealso::
        ...
        :class:`saorm14.dialects.postgresql.JSON`

        :class:`saorm14.dialects.postgresql.JSONB`

        :class:`saorm14.dialects.mysql.JSON`

        :class:`saorm14.dialects.sqlite.JSON`
...
class ARRAY(
    ...
    .. note::  This type serves as the basis for all ARRAY operations.
       ...
       :class:`saorm14.dialects.postgresql.ARRAY` type directly when using
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    .. seealso::
        ...
        :class:`saorm14.dialects.postgresql.ARRAY`
    ...
    class Comparator(Indexable.Comparator[_T], Concatenable.Comparator[_T]):
        ...
        @util.preload_module("saorm14.sql.elements")
