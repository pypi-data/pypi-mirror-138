...
of for example the ``saorm14.sql.util`` and the ``saorm14.sql.compiler``
...
try:
    from saorm14.cyextension.util import cache_anon_map as anon_map  # noqa
except ImportError:
...
class HasTraverseInternals:
    ...
    @util.preload_module("saorm14.sql.traversals")
    ...
    def _generate_compiler_dispatch(cls):
        ...
        * internal traversal collections ``_children_traversal``,
        ...
        if "_compiler_dispatch" in cls.__dict__:
            ...
            # saorm14.ext.compiles overrides it.
...
class InternalTraversal(_HasTraversalDispatch):
    ...
    * :meth:`.HasCacheKey._gen_cache_key`
    ...
    The operator is a function from the :mod:`saorm14.sql.operators`
    module.
