...
class TypeEngine(Traversible, Generic[_T]):
    ...
    class Comparator(
        ...
        @util.preload_module("saorm14.sql.default_comparator")
        def operate(
    ...
    def _generic_type_affinity(self):
        ...
        for t in self.__class__.__mro__:
            if (
                t.__module__
                in (
                    "saorm14.sql.sqltypes",
                    "saorm14.sql.type_api",
                )
    ...
    def as_generic(self, allow_nulltype=False):
        ...
        >>> from saorm14.dialects.mysql import INTEGER
        >>> INTEGER(display_width=4).as_generic()
        Integer()

        >>> from saorm14.dialects.mysql import NVARCHAR
