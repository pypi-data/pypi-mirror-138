...
class Operators(Generic[_OP_RETURN]):
    ...
    :meth:`~saorm14.sql.operators.Operators.operate` and
    :meth:`~saorm14.sql.operators.Operators.reverse_operate`, as well as
    :meth:`~saorm14.sql.operators.Operators.__and__`,
    :meth:`~saorm14.sql.operators.Operators.__or__`,
    :meth:`~saorm14.sql.operators.Operators.__invert__`.
...
class custom_op(OperatorType, Generic[_T]):
    ...
    to represent the "factorial" operation::
        ...
        from saorm14.sql import UnaryExpression
...
class ColumnOperators(Operators[_OP_RETURN]):
    ...
    :mod:`saorm14.expression.operators`.   For example
    the ``__eq__`` function::
