...
:class:`~saorm14.sql.expression.ClauseElement` subclasses and one or
more callables defining its compilation::

    from saorm14.ext.compiler import compiles
    from saorm14.sql.expression import ColumnClause
...
Above, ``MyColumn`` extends :class:`~saorm14.sql.expression.ColumnClause`,
...
invoked for the dialect in use::
    ...
    from saorm14.schema import DDLElement
...
:class:`~saorm14.engine.interfaces.Compiled` object in use. This object
...
:class:`~saorm14.sql.compiler.SQLCompiler` and
:class:`~saorm14.sql.compiler.DDLCompiler` both include a ``process()``
method which can be used for compilation of embedded attributes::

    from saorm14.sql.expression import Executable, ClauseElement
...
an endless loop.   Such as, to add "prefix" to all insert statements::
    ...
    from saorm14.sql.expression import Insert
...
* :class:`~saorm14.sql.expression.ClauseElement` - This is the root
  expression class. Any SQL expression can be derived from this base, and is
  probably the best choice for longer constructs such as specialized INSERT
  statements.

* :class:`~saorm14.sql.expression.ColumnElement` - The root of all
  "column-like" elements. Anything that you'd place in the "columns" clause of
  a SELECT statement (as well as order by and group by) can derive from this -
  the object will automatically have Python "comparison" behavior.

  :class:`~saorm14.sql.expression.ColumnElement` classes want to have a
...
* :class:`~saorm14.sql.functions.FunctionElement` - This is a hybrid of a
...
* :class:`~saorm14.schema.DDLElement` - The root of all DDL expressions,
...
* :class:`~saorm14.sql.expression.Executable` - This is a mixin which
...
datatype of the object::
    ...
    CacheKey(
        ...
        'name', 'some_name',
        'type', (<class 'saorm14.sql.sqltypes.String'>,
...
accommodates two arguments::
    ...
    from saorm14.sql import expression, case
    from saorm14.ext.compiler import compiles
    from saorm14.types import Numeric
...
Example usage::
    ...
    from saorm14 import select, union_all
