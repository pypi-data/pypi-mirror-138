...
The :mod:`saorm14.ext.instrumentation` package provides for alternate
...
resolution, once the :mod:`saorm14.ext.instrumentation` module
...
saorm14.ext.instrumentation.INSTRUMENTATION_MANAGER.
