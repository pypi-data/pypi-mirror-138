...
Any SQLAlchemy query structure, either based on saorm14.sql.*
or saorm14.orm.* can be used.  The mappers, Tables, Columns, Session
...
Usage is nearly the same as that of the standard Python pickle module::
    ...
    from saorm14.ext.serializer import loads, dumps
