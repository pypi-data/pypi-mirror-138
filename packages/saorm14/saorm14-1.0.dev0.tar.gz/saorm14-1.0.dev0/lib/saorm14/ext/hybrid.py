...
The :mod:`~saorm14.ext.hybrid` extension provides a special form of
...
as the class itself::
    ...
    from saorm14.orm import Session, aliased
    from saorm14.ext.hybrid import hybrid_property, hybrid_method
...
:mod:`~saorm14.ext.hybrid` decorators define the
...
mapping which relates a ``User`` to a ``SavingsAccount``::
    ...
    from saorm14 import Column, Integer, ForeignKey, Numeric, String
...
named ``word_insensitive``::
    ...
    from saorm14.ext.hybrid import Comparator, hybrid_property
    from saorm14 import func, Column, Integer, String
...
hierarchical tree pattern::
    ...
    from saorm14 import Column, Integer, ForeignKey
    from saorm14.orm import relationship
    from saorm14.ext.declarative import declarative_base
    Base = declarative_base()
...
the ``Node.parent`` attribute and filtered based on the given criterion::
    ...
    from saorm14.ext.hybrid import Comparator
...
class hybrid_method(interfaces.InspectionAttrInfo):
    ...
    def __init__(self, func, expr=None):
        ...
        Usage is typically via decorator::
            ...
            from saorm14.ext.hybrid import hybrid_method
