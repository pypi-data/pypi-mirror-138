...
r"""Define an extension to the :mod:`saorm14.ext.declarative` system
which automatically generates mapped classes and relationships from a database
schema, typically though not necessarily one which is reflected.

.. versionadded:: 0.9.1 Added :mod:`saorm14.ext.automap`.
...
asking it to reflect the schema and produce mappings::
    ...
    from saorm14.ext.automap import automap_base
...
explicit table declaration::
    ...
    from saorm14 import create_engine, MetaData, Table, Column, ForeignKey
    from saorm14.ext.automap import automap_base
    engine = create_engine("sqlite:///mydatabase.db")
...
The :mod:`.saorm14.ext.automap` extension allows classes to be defined
...
:mod:`.saorm14.ext.automap` is tasked with producing mapped classes and
...
options along to all one-to-many relationships::
    ...
    from saorm14.ext.automap import generate_relationship
...
:mod:`.saorm14.ext.automap` will generate many-to-many relationships, e.g.
...
:mod:`.saorm14.ext.automap` will not generate any relationships between
...
defines table metadata::
    ...
    from saorm14.ext.automap import automap_base
    from saorm14 import Column, Integer, String, ForeignKey
