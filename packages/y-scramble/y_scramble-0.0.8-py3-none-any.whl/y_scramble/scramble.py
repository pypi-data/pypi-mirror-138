...
class Scrambler:
    ...
    def __validate_train_test_split(self, X, y, scorer, validation_data=None, progress_bar=False):
    ...
    def __validate_cross_validation(self, X, y, scorer, aggregation="mean", cv_kfolds=7, progress_bar=False):
