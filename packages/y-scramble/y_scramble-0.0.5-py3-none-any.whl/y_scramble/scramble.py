...
class Scrambler:
    ...
    def validate(self, X, y, method="train_test_split", scoring="accuracy", cross_val_score_aggregator="mean", pvalue_threshold=0.05, cv_kfolds=7, as_df=False, validation_data=None):
        ...
        if method == "train_test_split":
            ...
            base_model_score, scrambled_model_scores = self.__validate_train_test_split(X, y, model_scorer, aggregation=cross_val_score_aggregator, cv_kfolds=cv_kfolds, validation_data=validation_data)
