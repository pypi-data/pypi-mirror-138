...
class DescribeClustersPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeClustersResponseTypeDef]:
        """
...
class DescribeDefaultParametersPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeDefaultParametersResponseTypeDef]:
        """
...
class DescribeParameterGroupsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeParameterGroupsResponseTypeDef]:
        """
...
class DescribeParametersPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        Source: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeParametersResponseTypeDef]:
        """
...
class DescribeSubnetGroupsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeSubnetGroupsResponseTypeDef]:
        """
