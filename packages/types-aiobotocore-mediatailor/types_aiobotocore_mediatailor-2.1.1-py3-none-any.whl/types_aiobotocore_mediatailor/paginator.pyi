...
class GetChannelSchedulePaginator(AioPaginator):
    ...
    ) -> AsyncIterable[GetChannelScheduleResponseTypeDef]:
        """
...
class ListAlertsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListAlertsResponseTypeDef]:
        """
...
class ListPlaybackConfigurationsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPlaybackConfigurationsResponseTypeDef]:
        """
...
class ListPrefetchSchedulesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        StreamId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPrefetchSchedulesResponseTypeDef]:
        """
...
class ListSourceLocationsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListSourceLocationsResponseTypeDef]:
        """
...
class ListVodSourcesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListVodSourcesResponseTypeDef]:
        """
