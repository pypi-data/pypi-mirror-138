...
class Sequential():
    ...
    def live_stats(self,live_stats, figure, F1, F2):
        ...
        if live_stats == 1:
            ...
            if len(self.train_inputs[0,:]) <= 2 and len(self.train_targets[0,:]) == 1:
                if len(self.train_inputs[:,0]) > 1000:
    ...
    def fit(self, cost_fn, epochs = 1000, lr = 0.1, momentum = None, verbose = 1, live_stats = 0, F1=0, F2=1):
        for n in [-1,0,1,2]:
            if live_stats == n:
                break
        ...
        if verbose == 1:
            for epoch in tqdm(range(epochs)):
                ...
                if live_stats != 0:
                    if epoch % update == 0:
                        self.live_stats(live_stats, figure, F1, F2)
