...
try:
    logo2 = ""
    if conf_sign and cgc.logo != "":
        logo1 = PyEmbeddedImage(cgc.logo)
    elif conf_sign and cgc.logo == "":
        logo1 = ""
    else:
...
if conf_sign:
    ...
    try:
        if os.path.exists(version_file):
            version_dict = read_version_file(version_file)
            version = version_dict['version']
            commitid = version_dict['commitid']
        else:
            version = ""
            commitid = ""
    except Exception:
...
if conf_sign:
    ...
    about_tool = '''\
                ...
                <tr>
                <td align="center"><font face="微软雅黑" color=\"grey\" size=2>commit id: ''' + commitid + '''</font></td>
                </tr>
                <tr>
