...
class DescribeActivitiesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeActivitiesResponseTypeDef]:
        """
...
class DescribeCommentsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        AuthenticationToken: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeCommentsResponseTypeDef]:
        """
...
class DescribeDocumentVersionsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        Fields: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeDocumentVersionsResponseTypeDef]:
        """
...
class DescribeFolderContentsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        Include: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeFolderContentsResponseTypeDef]:
        """
...
class DescribeGroupsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        OrganizationId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeGroupsResponseTypeDef]:
        """
...
class DescribeNotificationSubscriptionsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeNotificationSubscriptionsResponseTypeDef]:
        """
...
class DescribeResourcePermissionsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PrincipalId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeResourcePermissionsResponseTypeDef]:
        """
...
class DescribeRootFoldersPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeRootFoldersResponseTypeDef]:
        """
...
class DescribeUsersPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        Fields: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeUsersResponseTypeDef]:
        """
