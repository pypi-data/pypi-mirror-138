...
class BaseIndexer(object):
    ...
    def reindex_all(self, batch_size=150, use_queue=False):
    ...
    def reindex_update_one(self, objectID, wait_task=False):
    ...
    def reindex_update_all(self, batch_size=150, use_queue=False):
        qs = self.get_index_all_queryset()
