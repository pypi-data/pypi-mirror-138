...
MODEL_ENUM_DEFAULT_NAMES = (*DEFAULT_NAMES, 'extensible',)
...
class ModelEnumOptions(Options):
    ...
    def __init__(self, meta, app_label=None):
        ...
        # производится в автоматическом режиме просле прогона миграций. При такой реализации, удаление зничений из БД
    ...
    def contribute_to_class(self, cls, name):
        """
        Перепределенный метод для указания кастомного набора опций
        """
