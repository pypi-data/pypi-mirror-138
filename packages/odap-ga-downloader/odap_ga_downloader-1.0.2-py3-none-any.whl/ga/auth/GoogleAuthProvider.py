    ...
    def from_json(path: str):
        ...
        with open(path, "r") as service_key:
            ...
            return GoogleAuthProvider(
                ...
                private_key=service_key_json.get("private_key"),
                private_key_id=service_key_json.get("private_key_id"),
                client_id=service_key_json.get("client_id"),
                client_email=service_key_json.get("client_email"),
            )
