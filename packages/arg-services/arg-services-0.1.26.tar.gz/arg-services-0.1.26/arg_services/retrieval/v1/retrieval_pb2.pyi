...
class RetrieveResponse(google.protobuf.message.Message):
    ...
    @property
    def fac_ranking(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MappedCase]: ...
    def __init__(self,
        *,
        ...
        fac_ranking : typing.Optional[typing.Iterable[global___MappedCase]] = ...,
        ) -> None: ...
...
class MappedCase(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ID_FIELD_NUMBER: builtins.int
    SIMILARITY_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"id",b"id",u"node_mappings",b"node_mappings",u"similarity",b"similarity"]) -> None: ...
global___MappedCase = MappedCase
