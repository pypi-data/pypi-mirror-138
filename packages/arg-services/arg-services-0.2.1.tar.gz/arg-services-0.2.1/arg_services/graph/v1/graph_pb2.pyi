...
class Graph(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["analysts",b"analysts","created",b"created","edges",b"edges","major_claim",b"major_claim","metadata",b"metadata","nodes",b"nodes","participants",b"participants","resources",b"resources","updated",b"updated","version",b"version"]) -> None: ...
...
class SchemeNode(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["descriptors",b"descriptors"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["argumentation_scheme",b"argumentation_scheme","descriptors",b"descriptors","type",b"type"]) -> None: ...
