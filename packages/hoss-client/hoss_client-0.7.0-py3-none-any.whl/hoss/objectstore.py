...
class ObjectStore(CoreAPI):
    ...
    def reset_client(self, namespace: str) -> None:
        """This method removes the boto3 client stored in this instance. This is useful when trying to use the
