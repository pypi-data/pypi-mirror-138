...
def complex_request(request):
    ...
    try:
        resulturl = reverse('APPNAME:txnsearch_result')+ "?" + urlencode({'task_id': result.id,
                                                                         'referrer': referrer})
...
def complex_result(request):
    ...
    thisurl = reverse('APPNAME:complex_result')+ "?" + urlencode({'task_id': task_id,
                                                                  'referrer': referrer})
