...
class itkVkHalfHermitianToRealInverseFFTImageFilterICD2(itk.itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICD2ID2):
    ...
    SetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICD2_SetOutputRegion)
    GetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICD2_GetOutputRegion)
...
class itkVkHalfHermitianToRealInverseFFTImageFilterICD3(itk.itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICD3ID3):
    ...
    SetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICD3_SetOutputRegion)
    GetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICD3_GetOutputRegion)
...
class itkVkHalfHermitianToRealInverseFFTImageFilterICF2(itk.itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF2IF2):
    ...
    SetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICF2_SetOutputRegion)
    GetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICF2_GetOutputRegion)
...
class itkVkHalfHermitianToRealInverseFFTImageFilterICF3(itk.itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF3IF3):
    ...
    SetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICF3_SetOutputRegion)
    GetOutputRegion = _swig_new_instance_method(_itkVkHalfHermitianToRealInverseFFTImageFilterPython.itkVkHalfHermitianToRealInverseFFTImageFilterICF3_GetOutputRegion)
...
def vk_half_hermitian_to_real_inverse_fft_image_filter(*args: itkt.ImageLike,  device_id: int=..., output_region: itkt.ImageRegion=..., actual_x_dimension_is_odd_input=..., actual_x_dimension_is_odd: bool=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for VkHalfHermitianToRealInverseFFTImageFilter"""
    import itk

    kwarg_typehints = { 'device_id':device_id,'output_region':output_region,'actual_x_dimension_is_odd_input':actual_x_dimension_is_odd_input,'actual_x_dimension_is_odd':actual_x_dimension_is_odd }
