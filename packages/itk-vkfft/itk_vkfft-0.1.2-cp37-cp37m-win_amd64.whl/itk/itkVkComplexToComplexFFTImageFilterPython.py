...
def vk_complex_to_complex_fft_image_filter(*args: itkt.ImageLike,  device_id: int=..., transform_direction=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for VkComplexToComplexFFTImageFilter"""
    import itk

    kwarg_typehints = { 'device_id':device_id,'transform_direction':transform_direction }
