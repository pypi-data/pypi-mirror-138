    ...
    def calculate_statistics(self):
      ...
      for index, job in enumerate(self._jobs):
          ...
          for retrial in retrials:
              # print(retrial)
              # if job.name == "a28v_19500101_fc0_553_SIM":
              #   print(" ** {} {}".format(job.name, retrial))
              ...
              if Job.is_a_completed_retrial(retrial):
                  ...
                  # if job_stat._name == "a28v_19500101_fc0_553_SIM":
                  #   print("{} {}".format(job_stat._name, job_stat.completed_run_time))
              else:
