...
class DescribeDestinationsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeDestinationsResponseTypeDef]:
        """
...
class DescribeExportTasksPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeExportTasksResponseTypeDef]:
        """
...
class DescribeLogGroupsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeLogGroupsResponseTypeDef]:
        """
...
class DescribeLogStreamsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        descending: bool = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeLogStreamsResponseTypeDef]:
        """
...
class DescribeMetricFiltersPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        metricNamespace: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeMetricFiltersResponseTypeDef]:
        """
...
class DescribeQueriesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeQueriesResponseTypeDef]:
        """
...
class DescribeResourcePoliciesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeResourcePoliciesResponseTypeDef]:
        """
...
class DescribeSubscriptionFiltersPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        filterNamePrefix: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeSubscriptionFiltersResponseTypeDef]:
        """
...
class FilterLogEventsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        interleaved: bool = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[FilterLogEventsResponseTypeDef]:
        """
