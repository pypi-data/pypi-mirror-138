...
class MQ():
    ...
    def sync_startup(self): return asyncio.get_running_loop().run_until_complete(self.startup())
    def sync_job_start(self,*args,**kwargs): return asyncio.get_running_loop().run_until_complete(self.job_start(*args,**kwargs))
    def sync_job_update_eta(self,*args,**kwargs): return asyncio.get_running_loop().run_until_complete(self.job_update_eta(*args,**kwargs))
    ...
    def sync_job_result(self,*args,**kwargs): return asyncio.get_running_loop().run_until_complete(self.job_result(*args,**kwargs))
