...
class Schematisation(object):
    ...
    def slug(self, slug):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `slug`, length must be less than or equal to `256`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and slug is not None
    ...
    def created_by(self, created_by):
        ...
        if (
            ...
            and not re.search(r"^[\w.@+-]+$", created_by)
        ):  # noqa: E501
            self.__handle_validation_error(
                r"Invalid value for `created_by`, must be a follow pattern or equal to `/^[\w.@+-]+$/`"
            )  # noqa: E501
