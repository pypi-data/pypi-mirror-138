...
class NumericalSettings(object):
    ...
    def cfl_strictness_factor_1d(self, cfl_strictness_factor_1d):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and cfl_strictness_factor_1d is not None
            and cfl_strictness_factor_1d < 1e-14
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `cfl_strictness_factor_1d`, must be a value greater than or equal to `1E-14`"
            )  # noqa: E501
    ...
    def cfl_strictness_factor_2d(self, cfl_strictness_factor_2d):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and cfl_strictness_factor_2d is not None
            and cfl_strictness_factor_2d < 1e-14
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `cfl_strictness_factor_2d`, must be a value greater than or equal to `1E-14`"
            )  # noqa: E501
    ...
    def convergence_eps(self, convergence_eps):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and convergence_eps is None
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `convergence_eps`, must not be `None`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and convergence_eps is not None
            and convergence_eps > 0.0001
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `convergence_eps`, must be a value less than or equal to `0.0001`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and convergence_eps is not None
            and convergence_eps < 1e-7
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `convergence_eps`, must be a value greater than or equal to `1E-7`"
            )  # noqa: E501
    ...
    def convergence_cg(self, convergence_cg):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and convergence_cg is not None
            and convergence_cg > 1e-7
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `convergence_cg`, must be a value less than or equal to `1E-7`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and convergence_cg is not None
            and convergence_cg < 1e-12
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `convergence_cg`, must be a value greater than or equal to `1E-12`"
            )  # noqa: E501
    ...
    def flow_direction_threshold(self, flow_direction_threshold):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and flow_direction_threshold is not None
            and flow_direction_threshold > 0.01
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `flow_direction_threshold`, must be a value less than or equal to `0.01`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and flow_direction_threshold is not None
            and flow_direction_threshold < 1e-13
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `flow_direction_threshold`, must be a value greater than or equal to `1E-13`"
            )  # noqa: E501
    ...
    def general_numerical_threshold(self, general_numerical_threshold):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and general_numerical_threshold is not None
            and general_numerical_threshold > 1e-7
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `general_numerical_threshold`, must be a value less than or equal to `1E-7`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and general_numerical_threshold is not None
            and general_numerical_threshold < 1e-13
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `general_numerical_threshold`, must be a value greater than or equal to `1E-13`"
            )  # noqa: E501
    ...
    def max_non_linear_newton_iterations(self, max_non_linear_newton_iterations):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and max_non_linear_newton_iterations is not None
            and max_non_linear_newton_iterations < 1
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `max_non_linear_newton_iterations`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def max_degree_gauss_seidel(self, max_degree_gauss_seidel):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and max_degree_gauss_seidel is not None
            and max_degree_gauss_seidel < 1
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `max_degree_gauss_seidel`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def min_friction_velocity(self, min_friction_velocity):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and min_friction_velocity is not None
            and min_friction_velocity > 1
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `min_friction_velocity`, must be a value less than or equal to `1`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and min_friction_velocity is not None
            and min_friction_velocity < 0
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `min_friction_velocity`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def min_surface_area(self, min_surface_area):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and min_surface_area is not None
            and min_surface_area > 1e-7
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `min_surface_area`, must be a value less than or equal to `1E-7`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and min_surface_area is not None
            and min_surface_area < 1e-13
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `min_surface_area`, must be a value greater than or equal to `1E-13`"
            )  # noqa: E501
    ...
    def preissmann_slot(self, preissmann_slot):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and preissmann_slot is not None
            and preissmann_slot < 0
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `preissmann_slot`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def limiter_slope_thin_water_layer(self, limiter_slope_thin_water_layer):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and limiter_slope_thin_water_layer is not None
            and limiter_slope_thin_water_layer < 0
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `limiter_slope_thin_water_layer`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def use_of_cg(self, use_of_cg):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `use_of_cg`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def flooding_threshold(self, flooding_threshold):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and flooding_threshold is not None
            and flooding_threshold > 0.05
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `flooding_threshold`, must be a value less than or equal to `0.05`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and flooding_threshold is not None
            and flooding_threshold < 0
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `flooding_threshold`, must be a value greater than or equal to `0`"
            )  # noqa: E501
