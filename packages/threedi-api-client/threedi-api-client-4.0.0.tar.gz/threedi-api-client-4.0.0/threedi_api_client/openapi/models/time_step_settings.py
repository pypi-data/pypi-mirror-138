...
class TimeStepSettings(object):
    ...
    def time_step(self, time_step):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `time_step`, must be a value greater than or equal to `1E-14`"
            )  # noqa: E501
    ...
    def min_time_step(self, min_time_step):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and min_time_step is not None
            and min_time_step < 1e-14
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `min_time_step`, must be a value greater than or equal to `1E-14`"
            )  # noqa: E501
    ...
    def max_time_step(self, max_time_step):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and max_time_step is not None
            and max_time_step < 1e-14
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `max_time_step`, must be a value greater than or equal to `1E-14`"
            )  # noqa: E501
    ...
    def output_time_step(self, output_time_step):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and output_time_step is not None
            and output_time_step < 1e-14
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `output_time_step`, must be a value greater than or equal to `1E-14`"
            )  # noqa: E501
