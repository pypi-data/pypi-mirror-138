...
class SqliteFileUpload(object):
    ...
    def status(self, status):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `status`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def md5sum(self, md5sum):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and md5sum is not None
            and len(md5sum) > 256
        ):
            self.__handle_validation_error(
                "Invalid value for `md5sum`, length must be less than or equal to `256`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and md5sum is not None
            ...
            self.__handle_validation_error(
                "Invalid value for `md5sum`, length must be greater than or equal to `1`"
            )  # noqa: E501
