...
class FileMeta(object):
    ...
    def values_reference(self, values_reference):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and values_reference is not None
            and len(values_reference) < 1
        ):
            self.__handle_validation_error(
                "Invalid value for `values_reference`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def units(self, units):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `units`, length must be less than or equal to `64`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and units is not None
            ...
            self.__handle_validation_error(
                "Invalid value for `units`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def duration(self, duration):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `duration`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def error(self, error):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `error`, length must be less than or equal to `512`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and error is not None
            ...
            self.__handle_validation_error(
                "Invalid value for `error`, length must be greater than or equal to `1`"
            )  # noqa: E501
