...
class Download(object):
    ...
    """
    openapi_types = {"get_url": "str", "etag": "str", "size": "int"}

    attribute_map = {"get_url": "get_url", "etag": "etag", "size": "size"}
    ...
    def etag(self, etag):
        ...
        if (
            ...
            self.__handle_validation_error(
                "Invalid value for `etag`, length must be greater than or equal to `1`"
            )  # noqa: E501
