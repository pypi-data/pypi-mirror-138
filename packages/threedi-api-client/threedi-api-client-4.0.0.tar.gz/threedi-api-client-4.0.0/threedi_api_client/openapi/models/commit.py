...
class Commit(object):
    ...
    def commit_message(self, commit_message):
        ...
        if (
            ...
            and len(commit_message) < 1
        ):
            self.__handle_validation_error(
                "Invalid value for `commit_message`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def force_as(self, force_as):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and force_as not in allowed_values
        ):  # noqa: E501
            self.__handle_validation_error(
                "Invalid value for `force_as` ({0}), must be one of {1}".format(  # noqa: E501
                    force_as, allowed_values
                )
            )
    ...
    def schematisation_name(self, schematisation_name):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and schematisation_name is not None
            and len(schematisation_name) > 256
        ):
            self.__handle_validation_error(
                "Invalid value for `schematisation_name`, length must be less than or equal to `256`"
            )  # noqa: E501
        if (
            self.local_vars_configuration.client_side_validation
            and schematisation_name is not None
            and len(schematisation_name) < 1
        ):
            self.__handle_validation_error(
                "Invalid value for `schematisation_name`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def commit_user(self, commit_user):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and commit_user is not None
            and not re.search(r"^[\w.@+-]+$", commit_user)
        ):  # noqa: E501
            self.__handle_validation_error(
                r"Invalid value for `commit_user`, must be a follow pattern or equal to `/^[\w.@+-]+$/`"
            )  # noqa: E501
