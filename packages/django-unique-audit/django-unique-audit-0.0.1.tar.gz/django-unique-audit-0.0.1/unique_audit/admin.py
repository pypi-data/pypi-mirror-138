...
from .admin_helpers import UniqueAuditModelAdmin
...
# CRUD events
class CRUDEventAdmin(UniqueAuditModelAdmin):
    list_display = ['get_event_type_display', 'get_content_type', 'object_id', 'object_repr_link', 'datetime']
    ...
    readonly_fields = ['event_type', 'object_id', 'get_content_type',
                       'object_repr', 'object_json_repr_prettified', 'user_pk_as_string',
                       'datetime', 'changed_fields_prettified']
...
# Login events
class LoginEventAdmin(UniqueAuditModelAdmin):
    list_display = ['datetime', 'get_login_type_display', 'user_pk_as_string', 'remote_ip']
    date_hierarchy = 'datetime'
    list_filter = LOGIN_EVENT_LIST_FILTER
    search_fields = LOGIN_EVENT_SEARCH_FIELDS
    readonly_fields = ['login_type', 'user_pk_as_string', 'remote_ip', 'datetime', ]
...
# Request events
class RequestEventAdmin(UniqueAuditModelAdmin):
    ...
    readonly_fields = ['url', 'method', 'query_string', 'user_pk_as_string', 'remote_ip', 'datetime', ]
