...
# from unique_audit.middleware.unique_audit import get_current_user
from unique_audit.settings import REMOTE_ADDR_HEADER, UNREGISTERED_URLS, REGISTERED_URLS, WATCH_REQUEST_EVENTS, \
    LOGGING_BACKEND
...
if WATCH_REQUEST_EVENTS:
    request_started.connect(request_started_handler, dispatch_uid='unique_audit_signals_request_started')
