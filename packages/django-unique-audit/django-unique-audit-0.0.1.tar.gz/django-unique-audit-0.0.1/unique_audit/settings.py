...
from unique_audit.models import CRUDEvent, LoginEvent, RequestEvent
...
LOGGING_BACKEND = getattr(settings, 'DJANGO_EASY_AUDIT_LOGGING_BACKEND', 'unique_audit.backends.ModelBackend')
