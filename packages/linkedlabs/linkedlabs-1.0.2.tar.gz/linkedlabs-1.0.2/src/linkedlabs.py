...
def get_similarities(df):
    ...
    print("your similarity scores are stored in 'best_similarity_score' column and it is most similar with row number stored in 'best_similar_with_index_number' column")
    return fin_df