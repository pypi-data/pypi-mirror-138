...
#
# Changes:
#   - ExamplesPerSecondEstimatorHook - based on class from
#       tensorflow_estimator/python/estimator/tpu/tpu_estimator.py but rewritten
#       to include logging of other metrics
#   - TensorBoardWithHParamsV2
#     - set_model taken from keras.callbacks.TensorBoard, changed directories
#       for _train_dir and _val_dir and added saving HParams
#     - _log_epoch_metrics taken from keras.callbacks.TensorBoard, removed
#       prefixes when saving summaries
#
###############################################################################
...
class ExamplesPerSecondEstimatorHook(tf.compat.v1.train.StepCounterHook):
    """Calculate and report global_step/sec, examples/sec and other metrics during runtime."""
