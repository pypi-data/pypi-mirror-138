...
def load_longformer_data(model,resolved_archive_file):
    ...
    if state_dict is None:
        ...
        transformer_dicts = {
           ...
           'prediction_dense.weight':'lm_head.dense.weight',
           'prediction_dense.bias':'lm_head.dense.bias',
           'prediction_layer_norm.weight':'lm_head.layer_norm.weight',
           'prediction_layer_norm.bias':'lm_head.layer_norm.bias',
           'prediction_layer_norm.gamma':'lm_head.layer_norm.gamma',
           'prediction_layer_norm.beta':'lm_head.layer_norm.beta',
           'prediction_decoder.weight':'lm_head.decoder.weight',
           'prediction_decoder.bias':'lm_head.bias',
           'decoder_bias':'lm_head.bias',
        }
        #由自己的权重名称去找原先的权重名称
