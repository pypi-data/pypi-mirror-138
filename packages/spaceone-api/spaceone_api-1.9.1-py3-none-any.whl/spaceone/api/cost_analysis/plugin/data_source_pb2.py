...
_INITREQUEST = _descriptor.Descriptor(
  name='InitRequest',
  full_name='spaceone.api.cost_analysis.plugin.InitRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='options', full_name='spaceone.api.cost_analysis.plugin.InitRequest.options', index=0,
...
_PLUGINVERIFYREQUEST = _descriptor.Descriptor(
  ...
  full_name='spaceone.api.cost_analysis.plugin.PluginVerifyRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='options', full_name='spaceone.api.cost_analysis.plugin.PluginVerifyRequest.options', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='secret_data', full_name='spaceone.api.cost_analysis.plugin.PluginVerifyRequest.secret_data', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='schema', full_name='spaceone.api.cost_analysis.plugin.PluginVerifyRequest.schema', index=2,
...
_PLUGININFO = _descriptor.Descriptor(
  name='PluginInfo',
  full_name='spaceone.api.cost_analysis.plugin.PluginInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='metadata', full_name='spaceone.api.cost_analysis.plugin.PluginInfo.metadata', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATASOURCE = _descriptor.ServiceDescriptor(
  name='DataSource',
  full_name='spaceone.api.cost_analysis.plugin.DataSource',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='init',
    full_name='spaceone.api.cost_analysis.plugin.DataSource.init',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='verify',
    full_name='spaceone.api.cost_analysis.plugin.DataSource.verify',
    index=1,
    containing_service=None,
