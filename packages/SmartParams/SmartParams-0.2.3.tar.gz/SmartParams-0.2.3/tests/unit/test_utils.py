...
class TestGetNested(UnitCase):
    ...
    def test_nested__set_mode_false(self) -> None:
        name = 'arg3.missing'
    ...
    def test_nested__is_not_dictionary(self) -> None:
        name = 'arg3.arg31.a31'

        self.assertRaises(ValueError, get_nested, dictionary=self.dict, name=name)

    def test_nested__set_mode(self) -> None:
    ...
    def test_nested__set_mode_not_is_not_dictionary(self) -> None:
        name = 'arg3.arg31.a31'
