...
class ICD10:
    def __init__(self, service_date: datetime.date):
        self.icd10_hash: Dict[str, Dict[str, str]] = dict()
        self.service_date: datetime.date = service_date
    ...
    @staticmethod
    def _fetch_code_info(code: str, service_date: datetime.date) -> Dict[str, str]:
...
class ICD10Collection:
    def __init__(self, service_date: datetime.date, icd_list_of_codes_and_ranges: str):
