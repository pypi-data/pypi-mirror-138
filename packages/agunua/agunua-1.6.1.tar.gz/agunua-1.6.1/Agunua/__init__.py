...
VERSION = "1.6.1"  # WARNING: if you modify it here, also change setup.py https://packaging.python.org/guides/single-sourcing-package-version/#single-sourcing-the-version
GEMINI_PORT = 1965
BUFSIZE = 4096
