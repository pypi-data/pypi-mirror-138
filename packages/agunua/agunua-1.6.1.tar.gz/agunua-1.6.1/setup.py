...
setuptools.setup(
    name="agunua", 
    version="1.6.1", # WARNING: if you modify it here, also change Agunua/__init__.py https://packaging.python.org/guides/single-sourcing-package-version/#single-sourcing-the-version
