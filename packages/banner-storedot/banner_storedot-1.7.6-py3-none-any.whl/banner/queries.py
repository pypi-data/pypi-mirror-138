...
class Queries(object):
    ...
    def neware_query(
        ...
        cache: Storage = None, ttl: int = None, raw: bool = False, dqdv: bool = False, condition: str = 'TRUE', 
    ...
    def neware_cache_query(
        ...
        channels: Union[list, Number], tests: Union[list, Number], condition: str = 'TRUE',
    ...
    def __neware_tests_query(
        ...
        tests: str = '', cells: str = '', condition: str = 'TRUE',
