...
def check_min_label_classes(train_df: pd.DataFrame, label_column_name: str, is_multiclass: bool = True):
    ...
    if is_multiclass:
        ...
        vectorizer = get_vectorizer(train_df, None, label_column_name)
        num_unique_label_classes = len(vectorizer.get_feature_names())
