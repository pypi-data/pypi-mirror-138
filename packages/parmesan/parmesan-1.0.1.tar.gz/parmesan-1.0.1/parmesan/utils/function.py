...
class FunctionCollection:
    ...
    def register(self, func):
        ...
        # was registered. The below is not seen by Sphinx. In IPyhton you can
        ...
        if len(funcs) > 1:
            raise TypeError(
                ...
                "called with {} arguments ({}):\n\n{}{}".format(
                    ...
                    "\n".join(
                        ".".join((f.__module__, f.__name__)) for f in funcs
                    ),
    ...
    def __repr__(self):
        return "Collection of {} functions".format(
            len(self.registered_functions)
        )


@contextmanager
def out_warnings(category=Warning):
    """
    ...
    Args:
        category ((tuple of) Warning, optional): the
