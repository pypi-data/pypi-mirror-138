...
from hestia_earth.models.pooreNemecek2018.n2OToAirAquaculturePondsDirect import MODEL, TERM_ID, run, _should_run
...
def test_should_run(mock_total_excreta_n, mock_total_excreta_tan, mock_is_model_enabled, *args):
    cycle = {}
