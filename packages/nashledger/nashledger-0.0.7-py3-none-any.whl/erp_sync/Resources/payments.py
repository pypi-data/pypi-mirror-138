    ...
    def serialize(self, payload=None, operation=None):
        ...
        if operation == super().NEW or operation == super().UPDATE:
            ...
            if super().get_client_type() == super().QBO:
                ...
                # if 'line' in additional_properties.keys():
                #     payment.update({
                #         "Line": additional_properties.get("line", {})
                #     })
                    
                #     additional_properties.pop("line")
            ...
            # If client type is SAP
                ...
                if 'CardCode' in additional_properties.keys():
                    header.update({
                        "CardCode": additional_properties.get("CardCode", "")
                    })
                    
                    additional_properties.pop("CardCode")
                
                if 'InvoiceDocEntry' in additional_properties.keys():
                    header.update({
                        "InvoiceDocEntry": additional_properties.get("InvoiceDocEntry", "")
                    })
                    
                    additional_properties.pop("InvoiceDocEntry")
