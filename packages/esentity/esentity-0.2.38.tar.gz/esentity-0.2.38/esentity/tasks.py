...
def process_tg_message(domain, bot_id, message):
    ...
    if _data:
        ...
        if 'new_chat_title' in msg or 'left_chat_member' in msg or 'new_chat_member' in msg:
            telegram_api(_jobs['token'], 'deleteMessage', json={'chat_id': msg['chat']['id'], 'message_id': mid})
    else:
