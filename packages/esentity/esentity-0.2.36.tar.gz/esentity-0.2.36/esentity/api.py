...
from esentity.models import Page, Actor, Activity, TdsCampaign, TdsDomain, TdsHit, CasinoCommit, TelegramBot, TelegramChat
from esentity.models import AuthModel, SignupModel, SignupModelInvite, UserModel, ManagerModel, CasinoModel, CasinoProxyModel, DomainModel, CampaignModel, ActivityFeedbackModel, ActivitySubscribeModel, ActivityTicketModel , TelegramBotModel, TelegramChatModel
    ...
    if res.get('ok'):
        ...
        if 'photo' in res['result']:
            ...
            if res_photo.get('ok'):
                ...
                if r.status_code == 200:
                    _res['photo'] = base64.b64encode(r.content).decode()
        return _res                
    return {}
