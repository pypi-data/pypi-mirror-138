...
// .tensorflow.CoordinatedTask source_task = 5;
inline bool RegisterWorkerRequest::has_source_task() const {
  return this != internal_default_instance() && source_task_ != nullptr;
}
inline void RegisterWorkerRequest::clear_source_task() {
  if (GetArenaNoVirtual() == nullptr && source_task_ != nullptr) {
    delete source_task_;
  }
  source_task_ = nullptr;
}
inline const ::tensorflow::CoordinatedTask& RegisterWorkerRequest::source_task() const {
  const ::tensorflow::CoordinatedTask* p = source_task_;
  // @@protoc_insertion_point(field_get:tensorflow.RegisterWorkerRequest.source_task)
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::CoordinatedTask*>(
      &::tensorflow::_CoordinatedTask_default_instance_);
}
inline ::tensorflow::CoordinatedTask* RegisterWorkerRequest::release_source_task() {
  // @@protoc_insertion_point(field_release:tensorflow.RegisterWorkerRequest.source_task)
  
  ::tensorflow::CoordinatedTask* temp = source_task_;
  source_task_ = nullptr;
  return temp;
}
inline ::tensorflow::CoordinatedTask* RegisterWorkerRequest::mutable_source_task() {
  
  if (source_task_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::CoordinatedTask>(GetArenaNoVirtual());
    source_task_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.RegisterWorkerRequest.source_task)
  return source_task_;
}
inline void RegisterWorkerRequest::set_allocated_source_task(::tensorflow::CoordinatedTask* source_task) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete source_task_;
  }
  ...
  source_task_ = source_task;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.RegisterWorkerRequest.source_task)
}
