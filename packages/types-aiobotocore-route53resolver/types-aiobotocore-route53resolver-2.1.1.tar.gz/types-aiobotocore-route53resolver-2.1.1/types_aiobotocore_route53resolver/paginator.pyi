...
class ListFirewallConfigsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListFirewallConfigsResponseTypeDef]:
        """
...
class ListFirewallDomainListsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListFirewallDomainListsResponseTypeDef]:
        """
...
class ListFirewallDomainsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListFirewallDomainsResponseTypeDef]:
        """
...
class ListFirewallRuleGroupAssociationsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListFirewallRuleGroupAssociationsResponseTypeDef]:
        """
...
class ListFirewallRuleGroupsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListFirewallRuleGroupsResponseTypeDef]:
        """
...
class ListFirewallRulesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        Action: ActionType = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListFirewallRulesResponseTypeDef]:
        """
...
class ListResolverConfigsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListResolverConfigsResponseTypeDef]:
        """
...
class ListResolverDnssecConfigsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListResolverDnssecConfigsResponseTypeDef]:
        """
...
class ListResolverEndpointIpAddressesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListResolverEndpointIpAddressesResponseTypeDef]:
        """
...
class ListResolverEndpointsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        Filters: Sequence["FilterTypeDef"] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListResolverEndpointsResponseTypeDef]:
        """
...
class ListResolverQueryLogConfigAssociationsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListResolverQueryLogConfigAssociationsResponseTypeDef]:
        """
...
class ListResolverQueryLogConfigsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        SortOrder: SortOrderType = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListResolverQueryLogConfigsResponseTypeDef]:
        """
...
class ListResolverRuleAssociationsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        Filters: Sequence["FilterTypeDef"] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListResolverRuleAssociationsResponseTypeDef]:
        """
...
class ListResolverRulesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        Filters: Sequence["FilterTypeDef"] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListResolverRulesResponseTypeDef]:
        """
