...
class CompanyProjectSettings(object):
    ...
    def __init__(self, task_time_closure=None, task_page_size=None, task_paralel_time_tracking=False, task_minimum_consumption=False, task_minimum_time_consumption=None, task_minimum_product_consumption=None, _configuration=None):  # noqa: E501
        ...
        self._task_minimum_product_consumption = None
        ...
        if task_minimum_product_consumption is not None:
            self.task_minimum_product_consumption = task_minimum_product_consumption
    ...
    @property
    def task_minimum_product_consumption(self):
        """Gets the task_minimum_product_consumption of this CompanyProjectSettings.  # noqa: E501

        Products until a depends on task will be shown, will propagate only if task_minimum_consumption is True  # noqa: E501

        :return: The task_minimum_product_consumption of this CompanyProjectSettings.  # noqa: E501
        :rtype: int
        """
        return self._task_minimum_product_consumption

    @task_minimum_product_consumption.setter
    def task_minimum_product_consumption(self, task_minimum_product_consumption):
        """Sets the task_minimum_product_consumption of this CompanyProjectSettings.

        Products until a depends on task will be shown, will propagate only if task_minimum_consumption is True  # noqa: E501

        :param task_minimum_product_consumption: The task_minimum_product_consumption of this CompanyProjectSettings.  # noqa: E501
        :type: int
        """

        self._task_minimum_product_consumption = task_minimum_product_consumption
