...
class Partner(object):
    ...
    def __init__(self, id=None, name=None, vat_id=None, reg_com=None, sale_discount=None, purchase_discount=None, sale_due_days=None, purchase_due_days=None, is_company=None, country=None, region=None, city=None, address=None, supplier=None, email=None, phone=None, data_access=None, connected_company=None, agent=None, bank=None, iban=None, external_id=None, balance_data=None, markup=None, category=None, pays_vat=None, bapp_company_id=None, related_partner=None, _configuration=None):  # noqa: E501
