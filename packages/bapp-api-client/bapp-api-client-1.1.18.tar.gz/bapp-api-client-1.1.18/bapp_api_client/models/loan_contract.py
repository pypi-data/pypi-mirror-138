...
class LoanContract(object):
    ...
    def __init__(self, id=None, number=None, currency=None, bank_account=None, cash_balance=None, date_start=None, date_end=None, date_completed=None, draft=None, reimbursed=None, lenders=None, total=None, paid=None, active=None, pdf_file=None, _configuration=None):  # noqa: E501
