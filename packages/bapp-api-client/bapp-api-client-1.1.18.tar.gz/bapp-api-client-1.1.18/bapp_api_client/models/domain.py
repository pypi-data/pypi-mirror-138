...
class Domain(object):
    ...
    def __init__(self, id=None, created_at=None, modified_at=None, type=None, hostname=None, custom_hostname=None, template_name=None, enabled=None, settings=None, _configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["custom", "helpdesk", "emenu", "shop"]  # noqa: E501
    ...
    def template_name(self):
        """Gets the template_name of this Domain.  # noqa: E501


        :return: The template_name of this Domain.  # noqa: E501
        :rtype: str
        """
    ...
    def template_name(self, template_name):
        """Sets the template_name of this Domain.


        :param template_name: The template_name of this Domain.  # noqa: E501
        :type: str
        """
        ...
        if (self._configuration.client_side_validation and
                template_name is not None and len(template_name) > 200):
            raise ValueError("Invalid value for `template_name`, length must be less than or equal to `200`")  # noqa: E501
        if (self._configuration.client_side_validation and
