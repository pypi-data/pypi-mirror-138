...
class GlobalChem(object):
    ...
    def get_interstellar_space(self):

        interstellar_space = InterstellarSpace()

        interstellar_space_smiles = interstellar_space.get_per_smiles()
        interstellar_space_smarts = interstellar_space.get_per_smarts()

        return interstellar_space_smiles, interstellar_space_smarts
