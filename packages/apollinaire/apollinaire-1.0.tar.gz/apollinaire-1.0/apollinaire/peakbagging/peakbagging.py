...
def peakbagging (a2z_file, freq, psd, back=None, wdw=None, dnu=None,
                 ...
                 coeff_discard=None, use_sinc=False, asym_profile='nigam-kosovichev',
  ...
  :param coeff_discard: coeff used to compute the number of values to discard
    ...
    by coeff_discard. Optional, default ``None``. Deprecated. 
  ...
  if coeff_discard is not None :
    discard = nsteps_mcmc // coeff_discard
  ...
  if strategy=='global' :
    ...
    centiles = wrap_explore_distribution (df_in, freq, psd, back, 
                               ...
                               discard=discard, use_sinc=use_sinc, asym_profile=asym_profile,
