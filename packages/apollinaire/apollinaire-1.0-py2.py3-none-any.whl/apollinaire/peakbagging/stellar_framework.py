...
def stellar_framework (freq, psd, r=1, m=1, teff=5770, nwalkers=64, dnu=None, back=None, wdw=None,
                       ...
                       filename_back='background.png', back_mcmc=True, back_mle=True,
                       ...
                       coeff_discard_back=None, coeff_discard_pattern=None, coeff_discard_pkb=None,
                       discard_back=200, discard_pattern=200, discard_pkb=200,
                       thin_back=1, thin_pattern=1, quickfit=False, num=500, num_numax=500,
                       ...
                       save_background_vector=True, dpi=300) :
  ...
  if coeff_discard_back :
    discard_back = nsteps_mcmc_back // coeff_discard_back
    warnings.warn ('The coeff_discard_back argument is deprecated and will be removed for the v1.0 release. Use discard_back instead',
                  DeprecationWarning, stacklevel=2)
  if coeff_discard_pattern :
    discard_pattern = nsteps_mcmc_pattern // coeff_discard_pattern
    warnings.warn ('The coeff_discard_pattern argument is deprecated and will be removed for the v1.0 release. Use discard_pattern instead',
                  DeprecationWarning, stacklevel=2)
  if coeff_discard_pkb :
    discard_pkb = nsteps_mcmc_peakbagging // coeff_discard_pkb
    warnings.warn ('The coeff_discard_pkb argument is deprecated and will be removed for the v1.0 release. Use discard_pkb instead',
                  DeprecationWarning, stacklevel=2)
  ...
  if back is None :
    ...
    if back_mcmc :
      fitted_back, param_back, sigma_back = explore_distribution_background (freq, psd, dnu=dnu, 
                                       ...
                                       filemcmc=filemcmc_back, discard=discard_back, thin=thin_back, 
