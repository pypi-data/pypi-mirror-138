...
def __get_is_singleton(self):
    """check if the defined set is a singleton
    """
    return self._is_singleton

def __set_is_singleton(self, value):
    """Force the value of self._is_singleton
    """
    self._is_singleton = value

is_singleton = property(__get_is_singleton, __set_is_singleton)
...
COMMON_INTERFACE = {
    ...
    'only': only,
    'is_empty': is_empty,
    '__get_is_singleton': __get_is_singleton,
    '__set_is_singleton': __set_is_singleton,
