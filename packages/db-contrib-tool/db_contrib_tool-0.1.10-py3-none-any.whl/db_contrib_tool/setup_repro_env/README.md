...
```bash
# Download the latest last-lts & last-continuous binaries. Need to run from the mongo repo.
db-contrib-tool setup-repro-env 

# Download a specific version. Need to run from the mongo repo.
db-contrib-tool setup-repro-env [v5.2, githash123abc, evgversion123abc]
