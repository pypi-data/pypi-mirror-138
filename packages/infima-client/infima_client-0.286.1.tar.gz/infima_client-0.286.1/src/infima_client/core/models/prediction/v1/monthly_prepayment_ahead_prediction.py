...
T = TypeVar("T", bound="PredictionV1MonthlyPrepaymentAheadPrediction")


@define(auto_attribs=True)
class PredictionV1MonthlyPrepaymentAheadPrediction:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        prediction_v1_monthly_prepayment_ahead_prediction = cls(
            as_of=as_of,
            cpr=cpr,
        ...
        prediction_v1_monthly_prepayment_ahead_prediction.additional_properties = d
        return prediction_v1_monthly_prepayment_ahead_prediction
