...
T = TypeVar("T", bound="CohortV1SaveActualPrepaymentsResponse")


@define(auto_attribs=True)
class CohortV1SaveActualPrepaymentsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cohort_v1_save_actual_prepayments_response = cls(
            num_prepayments_saved=num_prepayments_saved,
        )

        cohort_v1_save_actual_prepayments_response.additional_properties = d
        return cohort_v1_save_actual_prepayments_response
