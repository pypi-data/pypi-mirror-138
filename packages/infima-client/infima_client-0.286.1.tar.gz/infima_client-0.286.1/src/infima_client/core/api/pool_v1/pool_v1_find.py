...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/pool/find".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PoolV1FindResponse]]:
    if response.status_code == 200:
        response_200 = PoolV1FindResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PoolV1FindResponse]]:
    return Response(
