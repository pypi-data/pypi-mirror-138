...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/cohort/get_covered_cohort".format(client.base_url)
...
) -> Optional[Union[CohortV1GetCoveredCohortsResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1GetCoveredCohortsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1GetCoveredCohortsResponse, GoogleRpcStatus]]:
    return Response(
