...
def _get_kwargs(
    *,
    client: Client,
    json_body: CohortV1GetMemberPoolsRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/cohort/get_member_pools".format(client.base_url)
...
) -> Optional[Union[CohortV1GetMemberPoolsResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1GetMemberPoolsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1GetMemberPoolsResponse, GoogleRpcStatus]]:
    return Response(
