...
def _get_kwargs(
    *,
    client: Client,
    json_body: PricingV0GetAvailableAsOfsRequest,
) -> Dict[str, Any]:
    url = "{}/api/v0/pricing/get_available_as_ofs".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PricingV0GetAvailableAsOfsResponse]]:
    if response.status_code == 200:
        response_200 = PricingV0GetAvailableAsOfsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PricingV0GetAvailableAsOfsResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Available as-of dates of pricing for a symbol.
