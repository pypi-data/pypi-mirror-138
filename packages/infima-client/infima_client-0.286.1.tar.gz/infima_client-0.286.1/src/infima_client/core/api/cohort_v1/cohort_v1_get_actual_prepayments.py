...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/cohort/get_actual_prepayments".format(client.base_url)
...
) -> Optional[Union[CohortV1GetActualPrepaymentsResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1GetActualPrepaymentsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1GetActualPrepaymentsResponse, GoogleRpcStatus]]:
    return Response(
