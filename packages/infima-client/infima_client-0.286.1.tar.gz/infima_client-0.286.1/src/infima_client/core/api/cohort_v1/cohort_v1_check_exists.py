...
def _get_kwargs(
    *,
    client: Client,
    json_body: CohortV1CheckExistsRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/cohort/check_exists".format(client.base_url)
...
) -> Optional[Union[CohortV1CheckExistsResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1CheckExistsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1CheckExistsResponse, GoogleRpcStatus]]:
    return Response(
