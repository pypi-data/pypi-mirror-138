...
def _get_kwargs(
    *,
    client: Client,
    json_body: PricingV0GetRequest,
) -> Dict[str, Any]:
    url = "{}/api/v0/pricing/get".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PricingV0GetResponse]]:
    if response.status_code == 200:
        response_200 = PricingV0GetResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PricingV0GetResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Fetch pricing predictions as of a date.
