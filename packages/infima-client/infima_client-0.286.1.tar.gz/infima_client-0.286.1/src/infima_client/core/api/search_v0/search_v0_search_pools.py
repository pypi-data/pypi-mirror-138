...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v0/search/search_pools".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, SearchV0SearchPoolsResponse]]:
    if response.status_code == 200:
        response_200 = SearchV0SearchPoolsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, SearchV0SearchPoolsResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Search for pools within a cohort universe.
