...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/pool/get_current_factor_date".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PoolV1GetCurrentFactorDateResponse]]:
    if response.status_code == 200:
        response_200 = PoolV1GetCurrentFactorDateResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PoolV1GetCurrentFactorDateResponse]]:
    return Response(
