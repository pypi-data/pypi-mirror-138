...
def _get_kwargs(
    *,
    client: Client,
    json_body: PoolV1GetSummaryRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/pool/get_summary".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PoolV1GetSummaryResponse]]:
    if response.status_code == 200:
        response_200 = PoolV1GetSummaryResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PoolV1GetSummaryResponse]]:
    return Response(
