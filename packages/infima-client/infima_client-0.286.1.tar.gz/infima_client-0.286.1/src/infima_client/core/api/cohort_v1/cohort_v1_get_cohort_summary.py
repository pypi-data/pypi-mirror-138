...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/cohort/get_cohort_summary".format(client.base_url)
...
) -> Optional[Union[CohortV1GetCohortSummaryResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1GetCohortSummaryResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1GetCohortSummaryResponse, GoogleRpcStatus]]:
    return Response(
