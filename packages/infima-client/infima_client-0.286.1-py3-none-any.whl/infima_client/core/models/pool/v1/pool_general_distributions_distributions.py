...
T = TypeVar("T", bound="PoolV1PoolGeneralDistributionsDistributions")


@define(auto_attribs=True)
class PoolV1PoolGeneralDistributionsDistributions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        pool_v1_pool_general_distributions_distributions = cls()
        ...
        pool_v1_pool_general_distributions_distributions.additional_properties = (
            additional_properties
        )
        return pool_v1_pool_general_distributions_distributions
