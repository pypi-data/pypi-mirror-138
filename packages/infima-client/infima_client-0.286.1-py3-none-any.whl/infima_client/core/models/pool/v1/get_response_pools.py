...
T = TypeVar("T", bound="PoolV1GetResponsePools")


@define(auto_attribs=True)
class PoolV1GetResponsePools:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        pool_v1_get_response_pools = cls()
        ...
        pool_v1_get_response_pools.additional_properties = additional_properties
        return pool_v1_get_response_pools
