...
T = TypeVar("T", bound="PoolV1GetCurrentFactorDateResponse")


@define(auto_attribs=True)
class PoolV1GetCurrentFactorDateResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pool_v1_get_current_factor_date_response = cls(
            factor_date=factor_date,
        )

        pool_v1_get_current_factor_date_response.additional_properties = d
        return pool_v1_get_current_factor_date_response
