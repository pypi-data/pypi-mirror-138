...
T = TypeVar("T", bound="PoolV1PoolServicerDistributionServicers")


@define(auto_attribs=True)
class PoolV1PoolServicerDistributionServicers:
    """Array of servicers allocations."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        pool_v1_pool_servicer_distribution_servicers = cls()
        ...
        pool_v1_pool_servicer_distribution_servicers.additional_properties = (
            additional_properties
        )
        return pool_v1_pool_servicer_distribution_servicers
