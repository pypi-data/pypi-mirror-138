...
T = TypeVar("T", bound="MarketV0GetStoryViewRequest")


@define(auto_attribs=True)
class MarketV0GetStoryViewRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        market_v0_get_story_view_request = cls(
            ticker=ticker,
        )

        market_v0_get_story_view_request.additional_properties = d
        return market_v0_get_story_view_request
