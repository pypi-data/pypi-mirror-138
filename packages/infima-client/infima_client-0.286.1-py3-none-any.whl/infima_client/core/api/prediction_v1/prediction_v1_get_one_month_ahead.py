...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/prediction/get_one_month_ahead".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PredictionV1GetOneMonthAheadResponse]]:
    if response.status_code == 200:
        response_200 = PredictionV1GetOneMonthAheadResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PredictionV1GetOneMonthAheadResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Fetch historical pool and cohort one months ahead prepayment predictions.
