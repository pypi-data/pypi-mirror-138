...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/prediction/get_n_months_ahead".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PredictionV1GetNMonthsAheadResponse]]:
    if response.status_code == 200:
        response_200 = PredictionV1GetNMonthsAheadResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PredictionV1GetNMonthsAheadResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Fetch historical pool and cohort N number of months ahead prepayment predictions.
