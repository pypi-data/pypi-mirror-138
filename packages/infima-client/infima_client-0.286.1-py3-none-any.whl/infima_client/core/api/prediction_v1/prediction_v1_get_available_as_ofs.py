...
def _get_kwargs(
    *,
    client: Client,
    json_body: PredictionV1GetAvailableAsOfsRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/prediction/get_available_as_ofs".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PredictionV1GetAvailableAsOfsResponse]]:
    if response.status_code == 200:
        response_200 = PredictionV1GetAvailableAsOfsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PredictionV1GetAvailableAsOfsResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Available as-of dates of predictions for a symbol.
