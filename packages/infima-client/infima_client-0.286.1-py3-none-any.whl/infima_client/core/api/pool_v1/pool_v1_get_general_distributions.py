...
def _get_kwargs(
    *,
    client: Client,
    json_body: PoolV1GetGeneralDistributionsRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/pool/get_general_distributions".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PoolV1GetGeneralDistributionsResponse]]:
    if response.status_code == 200:
        response_200 = PoolV1GetGeneralDistributionsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PoolV1GetGeneralDistributionsResponse]]:
    return Response(
