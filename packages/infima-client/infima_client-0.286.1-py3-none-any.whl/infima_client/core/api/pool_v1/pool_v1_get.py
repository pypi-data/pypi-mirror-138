...
def _get_kwargs(
    *,
    client: Client,
    json_body: PoolV1GetRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/pool/get".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PoolV1GetResponse]]:
    if response.status_code == 200:
        response_200 = PoolV1GetResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PoolV1GetResponse]]:
    return Response(
