...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/cohort/get_pool_memberships".format(client.base_url)
...
) -> Optional[Union[CohortV1GetPoolMembershipsResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1GetPoolMembershipsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1GetPoolMembershipsResponse, GoogleRpcStatus]]:
    return Response(
