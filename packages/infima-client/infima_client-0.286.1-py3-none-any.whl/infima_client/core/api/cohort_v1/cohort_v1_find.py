...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/cohort/find".format(client.base_url)
...
) -> Optional[Union[CohortV1FindResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1FindResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1FindResponse, GoogleRpcStatus]]:
    return Response(
