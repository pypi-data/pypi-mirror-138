...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/cohort/get_member_lists".format(client.base_url)
...
) -> Optional[Union[CohortV1GetMemberListsResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1GetMemberListsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1GetMemberListsResponse, GoogleRpcStatus]]:
    return Response(
