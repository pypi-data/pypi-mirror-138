...
def _get_kwargs(
    *,
    client: Client,
    json_body: CohortV1CheckCoverageRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/cohort/check_coverage".format(client.base_url)
...
) -> Optional[Union[CohortV1CheckCoverageResponse, GoogleRpcStatus]]:
    if response.status_code == 200:
        response_200 = CohortV1CheckCoverageResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[CohortV1CheckCoverageResponse, GoogleRpcStatus]]:
    return Response(
