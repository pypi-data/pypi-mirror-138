...
T = TypeVar("T", bound="SearchV0SearchPoolsResponsePools")


@define(auto_attribs=True)
class SearchV0SearchPoolsResponsePools:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        search_v0_search_pools_response_pools = cls()
        ...
        search_v0_search_pools_response_pools.additional_properties = (
            additional_properties
        )
        return search_v0_search_pools_response_pools
