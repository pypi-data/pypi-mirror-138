...
def _get_kwargs(
    *,
    client: Client,
    json_body: MarketV0GetStoryViewRequest,
) -> Dict[str, Any]:
    url = "{}/api/v0/market/get_story_view".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, MarketV0GetStoryViewResponse]]:
    if response.status_code == 200:
        response_200 = MarketV0GetStoryViewResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, MarketV0GetStoryViewResponse]]:
    return Response(
