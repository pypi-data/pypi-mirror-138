...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/pool/get_actual_prepayments".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PoolV1GetActualPrepaymentsResponse]]:
    if response.status_code == 200:
        response_200 = PoolV1GetActualPrepaymentsResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PoolV1GetActualPrepaymentsResponse]]:
    return Response(
