...
def _get_kwargs(
    *,
    client: Client,
    json_body: PoolV1CheckCoverageRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/pool/check_coverage".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, PoolV1CheckCoverageResponse]]:
    if response.status_code == 200:
        response_200 = PoolV1CheckCoverageResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, PoolV1CheckCoverageResponse]]:
    return Response(
