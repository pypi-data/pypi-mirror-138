...
def _get_kwargs(
    *,
    client: Client,
    json_body: SearchV0GetQueryRequest,
) -> Dict[str, Any]:
    url = "{}/api/v0/search/get_query".format(client.base_url)
...
) -> Optional[Union[GoogleRpcStatus, SearchV0GetQueryResponse]]:
    if response.status_code == 200:
        response_200 = SearchV0GetQueryResponse.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[GoogleRpcStatus, SearchV0GetQueryResponse]]:
    return Response(
