...
T = TypeVar("T", bound="PredictionV1GetAvailableAsOfsResponse")


@define(auto_attribs=True)
class PredictionV1GetAvailableAsOfsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        prediction_v1_get_available_as_ofs_response = cls(
            as_ofs=as_ofs,
        )

        prediction_v1_get_available_as_ofs_response.additional_properties = d
        return prediction_v1_get_available_as_ofs_response
