...
T = TypeVar("T", bound="PredictionV1MonthlyPrepaymentAsOfPrediction")


@define(auto_attribs=True)
class PredictionV1MonthlyPrepaymentAsOfPrediction:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        prediction_v1_monthly_prepayment_as_of_prediction = cls(
            cpr=cpr,
        ...
        prediction_v1_monthly_prepayment_as_of_prediction.additional_properties = d
        return prediction_v1_monthly_prepayment_as_of_prediction
