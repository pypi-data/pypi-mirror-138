...
T = TypeVar("T", bound="CohortV1Association")


@define(auto_attribs=True)
class CohortV1Association:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cohort_v1_association = cls(
            cohort=cohort,
            cusip=cusip,
        )

        cohort_v1_association.additional_properties = d
        return cohort_v1_association
