"""Miscellaneous goodies for psycopg2CrateCrate
...
#
# psycopg2CrateCrate is free software: you can redistribute it and/or modify it
...
#
# psycopg2CrateCrate is distributed in the hope that it will be useful, but WITHOUT
...
class NamedTupleCursor(_cursor):
    ...
    attributes.
        ...
        >>> nt_cur = conn.cursor(cursor_factory=psycopg2CrateCrate.extras.NamedTupleCursor)
        >>> rec = nt_cur.fetchone()
        >>> rec
...
class StopReplication(Exception):
    ...
    `~psycopg2CrateCrate.Error` as occurrence of this exception does not indicate an
    error.
    """
    pass
...
def wait_select(conn):
    ...
    `~psycopg2CrateCrate.extensions.set_wait_callback()`. This function uses
...
def register_hstore(conn_or_curs, globally=False, unicode=False,
    ...
    *oid* parameter, which can be found using a query such as :sql:`SELECT
    ...
    Raise `~psycopg2CrateCrate.ProgrammingError` if the type is not found.
    """
    if oid is None:
