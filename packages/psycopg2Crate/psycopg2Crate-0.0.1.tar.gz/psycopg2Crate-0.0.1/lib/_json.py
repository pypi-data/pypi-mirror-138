...
on psycopg2CrateCrate.extension, so I can't create the default JSON typecasters in
...
class Json:
    """
    An `~psycopg2CrateCrate.extensions.ISQLQuote` wrapper to adapt a Python object to
    :sql:`json` data type.
...
def register_json(conn_or_curs=None, globally=False, loads=None,
    ...
    are provided.  Raise `~psycopg2CrateCrate.ProgrammingError` if the type is not found.
