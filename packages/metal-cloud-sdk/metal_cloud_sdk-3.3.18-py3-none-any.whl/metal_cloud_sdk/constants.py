...
class Constants(object):
	...
	* Metal Cloud, API v2.7.8
	...
	DATACENTER_CONFIG_SWITCH_PROVISIONER_EVPNVXLANL2="EVPNVXLANL2Provisioner"
	...
	EVPNVXLANL2_ALLOCATE_DEFAULT_LAN_VLAN="allocateDefaultLANVLAN"
	EVPNVXLANL2_ALLOCATE_DEFAULT_SAN_VLAN="allocateDefaultSANVLAN"
	EVPNVXLANL2_ALLOCATE_DEFAULT_WAN_VLAN="allocateDefaultWANVLAN"
	EVPNVXLANL2_LAN_RANGE="LANVLANRange"
	EVPNVXLANL2_PREVENT_CLEANUP_FOR_VLANS="preventCleanupForVLANs"
	EVPNVXLANL2_PREVENT_CLEANUP_FOR_VLANS_FROM_EXTERNAL_CONNECTION_UPLINKS="preventCleanupForVLANsFromExternalConnectionUplinks"
	EVPNVXLANL2_PREVENT_USAGE_OF_VLANS="preventUsageOfVLANs"
	EVPNVXLANL2_QUARANTINE_VLAN_ID="quarantineVLANID"
	EVPNVXLANL2_SAN_RANGE="SANVLANRange"
	EVPNVXLANL2_WAN_RANGE="WANVLANRange"
	...
	INSTANCE_ARRAY_CUSTOM_NETWORK_CONFIGURATION_STATUS_ACTIVE="active"
	INSTANCE_ARRAY_CUSTOM_NETWORK_CONFIGURATION_STATUS_PENDING="pending"
	...
	NETWORK_PROFILE_VLAN_PORT_MODE_ACCESS="access"
	NETWORK_PROFILE_VLAN_PORT_MODE_NATIVE="native"
	NETWORK_PROFILE_VLAN_PORT_MODE_TRUNK="trunk"
	...
	NETWORK_TYPE_QUARANTINE="quarantine"
	...
	OS_ASSET_BUILD_COMPONENT="build_component"
	OS_ASSET_BUILD_SOURCE_IMAGE="build_source_image"
	...
	STORAGE_DRIVER_POWERSTORE="powerstore_storage"
	...
	SWITCH_DEVICE_PROVISIONER_EVPNVXLANL2="evpnvxlanl2"
	...
	VOLUME_TEMPLATE_OS_READY_METHOD_WAIT_FOR_POWER_OFF="wait_for_power_off"
	VOLUME_TEMPLATE_OS_READY_METHOD_WAIT_FOR_SIGNAL_FROM_OS="wait_for_signal_from_os"
	VOLUME_TEMPLATE_OS_READY_METHOD_WAIT_FOR_SIGNAL_FROM_OS_AND_WAIT_FOR_POWER_OFF="wait_for_signal_from_os_and_wait_for_power_off"
	...
	dictConstants = {
		...
		DATACENTER_CONFIG_SWITCH_PROVISIONER_EVPNVXLANL2:{
				'title':'Datacenter config EVPN VXLAN L2 switch provisioner',
				'description':'',
				'value_json':'"EVPNVXLANL2Provisioner"',
				'visibility':'private',
			},
		...
		EVPNVXLANL2_ALLOCATE_DEFAULT_LAN_VLAN:{
				'title':'EVPN VXLAN L2 provisioner allocate default LAN VLAN',
				'description':'',
				'value_json':'"allocateDefaultLANVLAN"',
				'visibility':'public',
			},
		EVPNVXLANL2_ALLOCATE_DEFAULT_SAN_VLAN:{
				'title':'EVPN VXLAN L2 provisioner allocate default SAN VLAN',
				'description':'',
				'value_json':'"allocateDefaultSANVLAN"',
				'visibility':'public',
			},
		EVPNVXLANL2_ALLOCATE_DEFAULT_WAN_VLAN:{
				'title':'EVPN VXLAN L2 provisioner allocate default WAN VLAN',
				'description':'',
				'value_json':'"allocateDefaultWANVLAN"',
				'visibility':'public',
			},
		EVPNVXLANL2_LAN_RANGE:{
				'title':'EVPN VXLAN L2 provisioner LAN range',
				'description':'Datacenter config constant used in EVPN VXLAN L2 provisioning that contains two numbers separated by \'-\'.',
				'value_json':'"LANVLANRange"',
				'visibility':'private',
			},
		EVPNVXLANL2_PREVENT_CLEANUP_FOR_VLANS:{
				'title':'EVPN VXLAN L2 provisioner prevent cleanup for VLANs',
				'description':'',
				'value_json':'"preventCleanupForVLANs"',
				'visibility':'public',
			},
		EVPNVXLANL2_PREVENT_CLEANUP_FOR_VLANS_FROM_EXTERNAL_CONNECTION_UPLINKS:{
				'title':'EVPN VXLAN L2 provisioner prevent cleanup for VLANs from external connection uplinks',
				'description':'',
				'value_json':'"preventCleanupForVLANsFromExternalConnectionUplinks"',
				'visibility':'public',
			},
		EVPNVXLANL2_PREVENT_USAGE_OF_VLANS:{
				'title':'EVPN VXLAN L2 provisioner prevent usage of VLANs',
				'description':'',
				'value_json':'"preventUsageOfVLANs"',
				'visibility':'public',
			},
		EVPNVXLANL2_QUARANTINE_VLAN_ID:{
				'title':'EVPN VXLAN L2 provisioner VLAN quarantine ID',
				'description':'Datacenter config constant used in EVPN VXLAN L2 provisioning.',
				'value_json':'"quarantineVLANID"',
				'visibility':'private',
			},
		EVPNVXLANL2_SAN_RANGE:{
				'title':'EVPN VXLAN L2 provisioner SAN range',
				'description':'Datacenter config constant used in EVPN VXLAN L2 provisioning that contains two numbers separated by \'-\'.',
				'value_json':'"SANVLANRange"',
				'visibility':'private',
			},
		EVPNVXLANL2_WAN_RANGE:{
				'title':'EVPN VXLAN L2 provisioner WAN range',
				'description':'Datacenter config constant used in EVPN VXLAN L2 provisioning that contains two numbers separated by \'-\'.',
		...
		INSTANCE_ARRAY_CUSTOM_NETWORK_CONFIGURATION_STATUS_ACTIVE:{
				'title':'Instance Array custom network configuration status active',
				'description':'',
				'value_json':'"active"',
				'visibility':'public',
			},
		INSTANCE_ARRAY_CUSTOM_NETWORK_CONFIGURATION_STATUS_PENDING:{
				'title':'Instance Array custom network configuration status pending',
				'description':'',
				'value_json':'"pending"',
				'visibility':'public',
			},
		...
		NETWORK_PROFILE_VLAN_PORT_MODE_ACCESS:{
				'title':'Network profile VLAN port mode access',
				'description':'',
				'value_json':'"access"',
				'visibility':'public',
			},
		NETWORK_PROFILE_VLAN_PORT_MODE_NATIVE:{
				'title':'Network profile VLAN port mode native',
				'description':'',
				'value_json':'"native"',
				'visibility':'public',
			},
		NETWORK_PROFILE_VLAN_PORT_MODE_TRUNK:{
				'title':'Network profile VLAN port mode trunk',
				'description':'',
				'value_json':'"trunk"',
				'visibility':'public',
			},
		...
		NETWORK_TYPE_QUARANTINE:{
				'title':'Quarantine network',
				'description':'',
		...
		OS_ASSET_BUILD_COMPONENT:{
				'title':'OS Asset build component',
				'description':'',
				'value_json':'"build_component"',
				'visibility':'public',
			},
		OS_ASSET_BUILD_SOURCE_IMAGE:{
				'title':'OSAsset usage build source image.',
				'description':'',
				'value_json':'"build_source_image"',
				'visibility':'public',
			},
		...
		PERMISSION_ADMIN_MAINTENANCE_READ:{
				'title':'Admin maintenance read permission.',
				'description':'',
				'value_json':'"admin_maintenance_read"',
				'visibility':'private',
			},
		...
		PERMISSION_GLOBAL_CONFIGURATIONS_READ:{
				'title':'Permission for accessing and manipulating global configurations.',
				'description':'',
				'value_json':'"global_configurations_read"',
				'visibility':'private',
			},
		PERMISSION_GLOBAL_CONFIGURATIONS_WRITE:{
				'title':'Permission for accessing and manipulating global configurations.',
				'description':'',
				'value_json':'"global_configurations_write"',
				'visibility':'private',
			},
		...
		PERMISSION_JOB_QUEUE_READ:{
				'title':'Job queue tasks read',
				'description':'',
				'value_json':'"job_queue_read"',
				'visibility':'private',
			},
		PERMISSION_JOB_QUEUE_WRITE:{
				'title':'Job queue tasks write',
				'description':'',
				'value_json':'"job_queue_write"',
				'visibility':'private',
			},
		...
		PERMISSION_NETWORK_PROFILES_READ:{
				'title':'Permission for accessing and manipulating network profiles.',
				'description':'',
				'value_json':'"network_profiles_read"',
				'visibility':'private',
			},
		PERMISSION_NETWORK_PROFILES_WRITE:{
				'title':'Permission for accessing and manipulating network profiles.',
				'description':'',
				'value_json':'"network_profiles_write"',
				'visibility':'private',
			},
		...
		STORAGE_DRIVER_POWERSTORE:{
				'title':'PowerStore storage driver',
				'description':'',
				'value_json':'"powerstore_storage"',
				'visibility':'private',
			},
		...
		SWITCH_DEVICE_PROVISIONER_EVPNVXLANL2:{
				'title':'Switch device EVPN VXLAN L2 provisioner',
				'description':'',
				'value_json':'"evpnvxlanl2"',
				'visibility':'private',
			},
		...
		VOLUME_TEMPLATE_OS_READY_METHOD_WAIT_FOR_POWER_OFF:{
				'title':'Volume template OS ready method wait for power off',
				'description':'',
				'value_json':'"wait_for_power_off"',
				'visibility':'public',
			},
		...
		VOLUME_TEMPLATE_OS_READY_METHOD_WAIT_FOR_SIGNAL_FROM_OS_AND_WAIT_FOR_POWER_OFF:{
				'title':'Volume template OS ready method wait for signal from OS and wait for poweroff',
				'description':'',
				'value_json':'"wait_for_signal_from_os_and_wait_for_power_off"',
				'visibility':'public',
			},
