...
class Events(object):
	...
	"""
	Network profile removed from instanceArray network.
	Severity: info.
	
	Removed the network profile set to the given network and instanceArray.
	"""
	NETWORK_PROFILE_INSTANCE_ARRAY_NETWORK_CLEAR=455


	"""
	Network profile attached to instanceArray network.
	Severity: info.
	
	Set the network profile for a network attached to the InstanceArray.
	"""
	NETWORK_PROFILE_INSTANCE_ARRAY_NETWORK_SET=454
	...
	"""
	List storage pool ports.
	Severity: info.
	
	.
	"""
	STORAGE_POOL_PORTS_READ=456
