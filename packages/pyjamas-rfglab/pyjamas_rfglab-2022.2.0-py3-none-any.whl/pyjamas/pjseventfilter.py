...
class PJSEventFilter(QtCore.QObject):
                ...
                if event.type() == QtCore.QEvent.MouseButtonRelease:
                    ...
                    if self.balloon_timer.isActive():
                        ...
                        if not init_poly:
                            ...
                            init_ls = rimutils.mask_from_polylines(self.pjs.imagedata.shape, [rutils.RUtils.qpolygonf2list(init_poly)], brushsz=1)

                            thepoints = skis.morphological_geodesic_active_contour(invim, num_iter=300,
                                                                                   init_level_set=init_ls, smoothing=1,
                                                                                   balloon=self.balloon_force)
    ...
    def balloon_timer_function(self):
        ...
        self.pjs.statusbar.showMessage(f"Balloon force {self.balloon_force:.2f}.")
