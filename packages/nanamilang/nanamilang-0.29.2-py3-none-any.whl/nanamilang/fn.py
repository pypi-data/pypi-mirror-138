...
class Fn:
    ...
    def handle(self, args: tuple) -> datatypes.Base:
        ...
        # Running 'deepcopy()' on a function body prevents function body unexpected mutation
        current_eval_function_body_token_or_form = deepcopy(self._function_body_token_or_form)
        ...
        return self._recursive_evaluate_function(current_eval_env, current_eval_function_body_token_or_form)
