"""NanamiLang Py3Module Data Type Class"""
...
class Py3Inst(Base):
    ...
    def cast(self, to: Keyword) -> Base:
        ...
        # As it was initially created to make it possible to implement
        # NanamiLang HTTP module, we only support: String, IntegerNumber
        ...
        if to.reference() == 'to-string':
            return String(self.reference().decode('utf-8')
...
class Py3Object(Base):
    ...
    def get(self,
            symbol: Keyword, default=None) -> 'Py3Object' or Nil:
        """NanamiLang Py3Object, returns Py3Object by its name"""
        ...
        symbol_attr = getattr(self.reference(), name, None)

        return Py3Object(symbol_attr) if symbol_attr else default
