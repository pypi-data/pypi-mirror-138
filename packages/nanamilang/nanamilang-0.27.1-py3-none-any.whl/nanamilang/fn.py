...
class Fn:
    ...
    def __init__(self,
        ...
        self._function_body_token_or_form = function_body_tof
    ...
    def handle(self, args: tuple) -> datatypes.Base:
        ...
        current_eval_env = copy(self._environment)  # <- prevent function closure modifying
        # Recently I found a bug with strange first threading macro behaviour inside of functions
        current_eval_function_or_body_token_or_form = deepcopy(self._function_body_token_or_form)
        ...
        return self._recursive_evaluate_function(current_eval_env, current_eval_function_or_body_token_or_form)
