    ...
    def validate(label: str, arguments: tuple, rules: list):
        ...
        for rule in rules:
            ...
            if rule_key == Spec.ArityAtLeastOne:
                ...
                # TODO: allow vary arguments, thus vary type chains
                #       1. get arguments length
                #       2, choose suitable type chains according to arguments length
                #       3. if there are not suitable type chains, raise an AssertionError
                #       4. iterate though suitable type chains
