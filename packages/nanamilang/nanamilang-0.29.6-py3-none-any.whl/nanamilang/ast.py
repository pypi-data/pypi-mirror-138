    ...
    def wrapped(_fn):
        ...
        def function(*args, **kwargs):
            try:
                ...
                # TODO: actually, this does not work correctly.
                #       For some reason, token position is quite wrong
                if not position:
                    tree: list = args[1]
        ...
        def recursive(local_env: dict,
            ...
            if identifier_token_or_form.identifier():
                ...
                if isinstance(final, datatypes.Function):
                    self._call_stack.append({'name': final.origin(), 'kind': 'fn', 'args': args})
                ...
                if isinstance(final, datatypes.Keyword):
                    self._call_stack.append({'name': 'get', 'kind': 'fn', 'args': args + [final]})
