...
class DescribeComputeEnvironmentsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeComputeEnvironmentsResponseTypeDef]:
        """
...
class DescribeJobDefinitionsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        status: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeJobDefinitionsResponseTypeDef]:
        """
...
class DescribeJobQueuesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeJobQueuesResponseTypeDef]:
        """
...
class ListSchedulingPoliciesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListSchedulingPoliciesResponseTypeDef]:
        """
