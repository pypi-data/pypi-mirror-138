...
class ListMultipartUploadsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListMultipartUploadsOutputTypeDef]:
        """
...
class ListObjectVersionsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        ExpectedBucketOwner: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListObjectVersionsOutputTypeDef]:
        """
...
class ListObjectsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        ExpectedBucketOwner: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListObjectsOutputTypeDef]:
        """
...
class ListObjectsV2Paginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        ExpectedBucketOwner: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListObjectsV2OutputTypeDef]:
        """
...
class ListPartsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        ExpectedBucketOwner: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPartsOutputTypeDef]:
        """
