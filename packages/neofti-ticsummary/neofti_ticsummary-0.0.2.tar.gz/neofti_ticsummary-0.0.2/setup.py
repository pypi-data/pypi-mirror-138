...
setuptools.setup(
    ...
    version="0.0.2", # Номер версии проекта, решайте сами
    ...
    packages=setuptools.find_packages('TICSummary'),  # Эта функция может помочь вам найти все файлы в пакете, вы можете указать вручную
    classifiers=[  
