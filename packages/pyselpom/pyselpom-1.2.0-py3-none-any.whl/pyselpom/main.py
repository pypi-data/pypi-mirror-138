...
class BasePage:
    ...
    def __init__(self, driver: ChromeDriver, url: str = None, implicit_timeout: int = 0):
    ...
    def is_visible(self, by: By, locator: str, timeout: int = 5):
        ...
        wait = WebDriverWait(self.driver, timeout)
        return wait.until(EC.visibility_of_element_located((by, locator)), message=self._message(by, locator))

    def is_not_visible(self, by: By, locator: str, timeout: int = 5):
        ...
        wait = WebDriverWait(self.driver, timeout)
        return wait.until(EC.invisibility_of_element_located((by, locator)), message=self._message(by, locator))

    def is_clickable(self, by: By, locator: str, timeout: int = 5):
        ...
        wait = WebDriverWait(self.driver, timeout)
        return wait.until(EC.element_to_be_clickable((by, locator)), message=self._message(by, locator))
    ...
    def should_be_authorized_user(self):
        """
        assert self.is_element_present(...), 'User icon is not present, maybe unauthorised.'
        """
