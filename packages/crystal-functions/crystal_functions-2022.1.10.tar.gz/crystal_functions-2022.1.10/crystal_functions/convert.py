...
def cry_gui2pmg(gui_file,dimension=3):
    ...
    if data[0].split()[0] == '3':
        ...
        for i in range(6+n_symmops*4,6+n_symmops*4+n_atoms):
            ...
            atom_positions.append([float(x) for x in atom_line[1:]])  # These are cart
...
#struc = cry_gui2pmg('/Users/brunocamino/Desktop/Imperial/cmsg_icl/solid-solutions/data/LTS_CONFCNT_ONLY.gui')
