...
class ListEndpointsByPlatformApplicationPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListEndpointsByPlatformApplicationResponseTypeDef]:
        """
...
class ListOriginationNumbersPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListOriginationNumbersResultTypeDef]:
        """
...
class ListPhoneNumbersOptedOutPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPhoneNumbersOptedOutResponseTypeDef]:
        """
...
class ListPlatformApplicationsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPlatformApplicationsResponseTypeDef]:
        """
...
class ListSMSSandboxPhoneNumbersPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListSMSSandboxPhoneNumbersResultTypeDef]:
        """
...
class ListSubscriptionsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListSubscriptionsResponseTypeDef]:
        """
...
class ListSubscriptionsByTopicPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListSubscriptionsByTopicResponseTypeDef]:
        """
...
class ListTopicsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListTopicsResponseTypeDef]:
        """
