...
client = GatewayClient("imngonii@gmail.com", "Nickm@ng13")
...
client.send_bulk_email(body="Hi. Hello everyone. We are testing corporates!", setting_id="2819bdaa-6035-4e45-9d93-ce5d3724ec52", recipients=["imngonii@gmail.com", "ngoni.mangudya@intelliafrica.solutions"], subject="Testing")