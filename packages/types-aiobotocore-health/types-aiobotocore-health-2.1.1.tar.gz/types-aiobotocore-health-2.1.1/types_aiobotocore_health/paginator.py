...
class DescribeAffectedAccountsForOrganizationPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeAffectedAccountsForOrganizationResponseTypeDef]:
        """
...
class DescribeAffectedEntitiesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeAffectedEntitiesResponseTypeDef]:
        """
...
class DescribeAffectedEntitiesForOrganizationPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        locale: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeAffectedEntitiesForOrganizationResponseTypeDef]:
        """
...
class DescribeEventAggregatesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeEventAggregatesResponseTypeDef]:
        """
...
class DescribeEventTypesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        locale: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeEventTypesResponseTypeDef]:
        """
...
class DescribeEventsForOrganizationPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        locale: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeEventsForOrganizationResponseTypeDef]:
        """
