...
MarkerMAG get_cp_num -p op_prefix -t 12 -force -r1 R1.fasta -r2 R2.fasta -linkages linkages_by_genome.txt -marker 16S.fasta -mag mag_folder -x fa -vxtractor vxtractor.pl -silva_order_refs SILVA_138.1_one_seq_per_order.fasta -hmm_bac vxtractor/HMMs/SSU/bacteria -hmm_arc vxtractor/HMMs/SSU/archaea

# needed_files:
-vxtractor path/to/vxtractor/vxtractor.pl 
-silva_order_refs path/to/SILVA_138.1_one_seq_per_order.fasta 
-hmm_bac path/to/vxtractor/HMMs/SSU/bacteria 
-hmm_arc path/to/vxtractor/HMMs/SSU/archaea
...
def get_16s_copy_num(args):
    ...
    if (combined_prefixed_mags is None) or (combined_prefixed_mags_gff is None):
        ...
        combined_input_gnms_no_ending_16s   = '%s/input_MAGs_combined_no_ending_16s.fa' % mag_folder_in_get_cn_wd
