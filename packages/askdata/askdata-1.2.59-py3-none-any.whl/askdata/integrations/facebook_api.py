...
#see parameters available for date_preset here https://developers.facebook.com/docs/marketing-api/insights/parameters/



"""
MANDATORY INPUT: my_app_id, my_app_secret, my_access_token

OPTIONAL:

- date_preset: report days range.  
               Optional, by default "last_7d".
               See https://developers.facebook.com/docs/marketing-api/insights/parameters/ for date_preset available.
...
def get_fb_ads(my_app_id, my_app_secret, my_access_token, 
    ...
    print("date_preset is '{}'".format(date_preset))
