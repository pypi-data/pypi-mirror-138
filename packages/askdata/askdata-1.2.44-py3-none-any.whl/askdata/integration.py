...
def read_fb_ads(my_app_id, my_app_secret, my_access_token, date_preset = "today"):
    
    from askdata.integrations import facebook_api
    
    fb_ads = facebook_api.get_fb_ads(my_app_id, my_app_secret, my_access_token, date_preset)
