...
class adbClass():
    def __init__(self, port, versionlimit=2021111101, skipboxid=False):
        ...
        self.skipApk=False  # skipApk 暂未使用
        if (skipboxid):
            self.skipboxid = port
        self.ver = 0
    ...
    def checkapk(self, name="com.utsmta.app"):
        if (self.skipApk and name=="com.utsmta.app"):return True
    ...
    def getBoxid(self, timeout=2):
        if self.skipApk:   # 没有产测APK直接获取Boxid,暂未使用
    ...
    def getver(self):
        if self.skipApk:return 9999999999
