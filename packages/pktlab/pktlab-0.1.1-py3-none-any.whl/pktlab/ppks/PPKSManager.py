...
class PPKSManager:
    ...
    def _check_valid_opt_gen_input(
        ...
        # (pathlen, cert_desp, monitor_digests, filter_digests, priority)
        cert_type_dict = {
            pconst.PKTLAB_CERTTYPE_STR_SUBPRIV: ( 0, 0, -1, -1, -1),
            pconst.PKTLAB_CERTTYPE_STR_SUBCMD:  (-1, 0, -1, -1, -1),
            pconst.PKTLAB_CERTTYPE_STR_PUBPRIV: ( 0, 0, -1, -1, -1),
            pconst.PKTLAB_CERTTYPE_STR_PUBCMD:  (-1, 0, -1, -1,  0),
            pconst.PKTLAB_CERTTYPE_STR_EXPPRIV: ( 0, 0,  0,  0,  0),
            pconst.PKTLAB_CERTTYPE_STR_BROKER:  (-1, 0, -1, -1, -1),
            pconst.PKTLAB_CERTTYPE_STR_DELPRIV: ( 0, 0,  0,  0,  0)}
        field_name_ls = [
            "pathlen", "cert_desp",
            "monitor_digests", "filter_digests", "priority"]
        input_ls = [
            pathlen, cert_desp,
            monitor_digests, filter_digests, priority]
