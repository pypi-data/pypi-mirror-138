...
class AuditModel(models.Model):
    ...
    updated_by = VirtualForeignKey("创建者", getattr(settings, "AUDIT_USER_MODEL", "AUTH_USER_MODEL"))  # 创建者
    created_by = VirtualForeignKey("修改者", getattr(settings, "AUDIT_USER_MODEL", "AUTH_USER_MODEL"))  # 修改者
    updated_at = UpdatedAtField()  # 修改时间
    created_at = CreatedAtField()  # 创建时间
