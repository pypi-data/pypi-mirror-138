...
from .fields import (
    ...
    UpdatedAtField,
    CreatedAtField,
    StatusField, DefaultCodeField, AuditStatusField, VirtualForeignKey,
)
...
class BaseCreatorModel(models.Model):
    ...
    created_by = VirtualForeignKey("创建人", getattr(settings, "AUDIT_USER_MODEL", "AUTH_USER_MODEL"), related_name="+")  # 创建者
    updated_by = VirtualForeignKey("修改人", getattr(settings, "AUDIT_USER_MODEL", "AUTH_USER_MODEL"), related_name="+")  # 修改者
    updated_at = UpdatedAtField()  # 修改时间
    created_at = CreatedAtField()  # 创建时间
