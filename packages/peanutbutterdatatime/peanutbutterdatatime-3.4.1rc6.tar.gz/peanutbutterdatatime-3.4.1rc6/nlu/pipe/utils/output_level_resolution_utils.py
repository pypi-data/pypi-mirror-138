...
class OutputLevelUtils():
    ...
    def resolve_input_dependent_component_to_output_level(pipe, component):
        ...
        if NLP_FEATURES.DOCUMENT in component.spark_input_column_names:
            return NLP_FEATURES.DOCUMENT
        if NLP_FEATURES.SENTENCE in component.spark_input_column_names:
            return NLP_FEATURES.SENTENCE
    ...
    @staticmethod
    def resolve_component_to_output_level(pipe, component: NluComponent):
        '''
        ...
        '''
        # TODO integrate the new process below and replace old one with it
        # if 'INPUT_DEPENDENT' not in component.output_level:
        #     # Non input dependent components dont need further resolution of output level
        #     return component.output_level
        # else :
        #     # For input dependent components, we must resolve it by checking what its inputs are
