...
def dcinit(name, env):
    ...
    print("\n")
    print("If you are new to Discord bot development, read these before starting up:")
    print("If you are using Replit, upload files and folders on your Repl.")
    print("\nOR\n")
    print("If you are using Github and Heroku, make sure you have discord.py and Heroku CLI installed.")
    print("\nOR\n")
    print("If you are using Git and Heroku, make sure you have discord.py, Git, and Heroku CLI installed.")
    print("\n")
    print("FOR HEROKU USERS:")
