...
# ----------------------------------
def init_engineering():
    """ 
    [ 初始化工程 ] 
    
    """

    CONST.SYS.PATH_INI_FILE.touch(mode=0o777)
...
def create_project(name: str):
    ...
    project_name = ''.join([PROJECT_NAMING_BASE_PREFIX, name])
    project_path = CONST.SYS.PATH_ROOT.joinpath(project_name)
