...
setup(
	...
	py_modules=["commonn.lib.readexcel","commonn.lib.writeexcel","commonn.lib.api","commonn.lib.newReport","commonn.lib.parsley","commonn.lib.sendmail","commonn.lib.utility"],
)
