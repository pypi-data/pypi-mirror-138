...
class DescribePullRequestEventsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribePullRequestEventsOutputTypeDef]:
        """
...
class GetCommentsForComparedCommitPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        beforeCommitId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[GetCommentsForComparedCommitOutputTypeDef]:
        """
...
class GetCommentsForPullRequestPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        afterCommitId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[GetCommentsForPullRequestOutputTypeDef]:
        """
...
class GetDifferencesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        afterPath: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[GetDifferencesOutputTypeDef]:
        """
...
class ListBranchesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListBranchesOutputTypeDef]:
        """
...
class ListPullRequestsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPullRequestsOutputTypeDef]:
        """
