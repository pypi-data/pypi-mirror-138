...
from model import MarketData_pb2 as MarketData_pb2
from model import MDQuery_pb2 as MDQuery_pb2
from model import InsightErrorContext_pb2 as InsightErrorContext_pb2
...
class HsInsight(object):
    ...
    #OnMarketData的修饰函数,无修饰则用默认OnMarketData
    ...
    #OnPlaybackPayload的修饰函数,无修饰则用默认OnPlaybackPayload
    ...
    # OnPlaybackStatus 的修饰函数,无修饰则用默认 OnPlaybackStatus
    ...
    # OnPlaybackResponse 的修饰函数,无修饰则用默认 OnPlaybackResponse
    ...
    # OnPlaybackControlResponse 的修饰函数,无修饰则用默认 OnPlaybackControlResponse
    ...
    # OnServiceMessage 的修饰函数,无修饰则用默认 OnServiceMessage
    def hs_on_service_message(self,func):
        self.callback.OnServiceMessage = func
    ...
    # OnSubscribeResponse 的修饰函数,无修饰则用默认 OnSubscribeResponse
    ...
    # OnQueryResponse 的修饰函数,无修饰则用默认 OnQueryResponse
    ...
    # OnGeneralError 的修饰函数,无修饰则用默认 OnGeneralError
    def hs_on_general_error(self,func):
        self.callback.OnGeneralError = func
    ...
    # OnLoginSuccess 的修饰函数,无修饰则用默认 OnLoginSuccess
    def hs_on_login_success(self,func):
        self.callback.OnLoginSuccess = func
    ...
    # OnLoginFailed 的修饰函数,无修饰则用默认 OnLoginFailed
    def hs_on_login_failed(self,func):
        self.callback.OnLoginFailed = func
    ...
    # OnNoConnections 的修饰函数,无修饰则用默认 OnNoConnections
    def hs_on_no_connections(self,func):
        self.callback.OnNoConnections = func
    ...
    # OnReconnect 的修饰函数,无修饰则用默认 OnReconnect
    def hs_on_reconnect(self,func):
        self.callback.OnReconnect = func
...
def demo1(username,passwd):
    ...
    def hs_on_market_data_back(marketdata:MarketData_pb2.MarketData):
        try:
    ...
    def OnPlaybackPayload(playload:MDPlayback.PlaybackPayload):
