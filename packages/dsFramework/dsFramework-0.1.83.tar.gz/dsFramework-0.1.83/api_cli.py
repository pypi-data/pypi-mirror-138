...
def create_folders(project_name):
    ...
    create_main_folders('documentation', 'main')
...
def create_project(project_name):
    ...
    copy_documentation_files(directories['documentation'])
...
def copy_documentation_files(target_dir):
    ...
    for (dirpath, dirname, filenames) in os.walk(source_dir):
        doc_files = [os.path.join(dirpath, file) for file in filenames if file != 'dsf_doxyfile']
