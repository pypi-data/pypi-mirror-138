...
class ListForecastExportJobsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        Filters: Sequence["FilterTypeDef"] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListForecastExportJobsResponseTypeDef]:
        """
...
class ListForecastsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        Filters: Sequence["FilterTypeDef"] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListForecastsResponseTypeDef]:
        """
...
class ListPredictorBacktestExportJobsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        Filters: Sequence["FilterTypeDef"] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPredictorBacktestExportJobsResponseTypeDef]:
        """
...
class ListPredictorsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        Filters: Sequence["FilterTypeDef"] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListPredictorsResponseTypeDef]:
        """
