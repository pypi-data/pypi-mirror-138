...
def process_heartbeat(client, **kwargs):
    try:
        ...
        if service_version.startswith("4.0"):
            ...
            #use cpd403 for cpd4.0.x version for now
...
def import_diff(module_file_path):
    ...
    if "sklearn023" in module_file_path:
        return
...
def choose_sklearn_version(software_spec):
...
class Party(WMLResource):
    ...
    SUPPORTED_PLATFORMS_MAP = {
        ...
        'cpd403': "/cpd403/ibmfl",
        'cpd406': "/cpd406/ibmfl",
        'sklearn023': "/sklearn023/ibmfl",
        'sklearn102': "/sklearn102/ibmfl"
    }
    ...
    def __init__(self, client=None, **kwargs):
        ...
        module_name = 'ibmfl'
        module_spec = importlib.util.spec_from_file_location(
            module_name, ibmfl_base_module_location + '/sklearn023/ibmfl/__init__.py')
        module = importlib.util.module_from_spec(module_spec)
        sys.modules[module_name] = module
        module_spec.loader.exec_module(module)
    ...
    def run(self, aggregator_id, asynchronous=True, verify=True):
        ...
        **Example**
        ...
        try:
            ...
            if ready:
                if "cpd406" in self.module_location:
                    ...
                    platform_env = choose_sklearn_version(software_spec)
