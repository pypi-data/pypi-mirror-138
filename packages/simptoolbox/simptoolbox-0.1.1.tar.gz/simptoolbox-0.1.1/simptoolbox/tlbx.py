...
class toolbox():
    ...
    def __new__(cls, *args, **kargs):
        ...
        if tbkey in cls.toolboxes:
            ...
            cls.toolboxes[tbkey] = super(toolbox, cls).__new__(cls)
            return cls.toolboxes[tbkey]

    def __init__(self, *args, **kargs):
        # Logs for reporting errors / usage
        self.log = simplog(kargs.get('log_name',__name__))
        self.allow_overwrite = kargs.get('allow_overwrite', False)

        self.tools = {}     # Stores tools
    ...
    def get(self, *args, **kargs):
        self.log.debug(f'Retrieved {args[0]}')
        return self.tools.get(*args, **kargs)
