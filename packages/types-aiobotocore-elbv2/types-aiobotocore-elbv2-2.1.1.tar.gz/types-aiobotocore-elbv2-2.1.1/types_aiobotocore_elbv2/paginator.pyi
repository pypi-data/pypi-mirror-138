...
class DescribeListenerCertificatesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeListenerCertificatesOutputTypeDef]:
        """
...
class DescribeListenersPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeListenersOutputTypeDef]:
        """
...
class DescribeLoadBalancersPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        Names: Sequence[str] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeLoadBalancersOutputTypeDef]:
        """
...
class DescribeRulesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeRulesOutputTypeDef]:
        """
...
class DescribeSSLPoliciesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeSSLPoliciesOutputTypeDef]:
        """
...
class DescribeTargetGroupsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        Names: Sequence[str] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeTargetGroupsOutputTypeDef]:
        """
