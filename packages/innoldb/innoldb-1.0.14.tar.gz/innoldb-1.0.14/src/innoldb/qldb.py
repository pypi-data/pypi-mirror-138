...
class QLDB():
    ...
    def __init__(self, table, ledger=settings.LEDGER):
        """Creates an instance of `innoldb.qldb.QLDB`. This class representation some basic configuration properties of the **QLDB** ledger.
...
class Document(QLDB):
    """A `innoldb.qldb.Document` object, representing an entry in an QLDB Ledger Table. Creates an instance of `innoldb.qldb.Document`. This object can be initialized in several states, depending on the parameters passed into the constructor.
