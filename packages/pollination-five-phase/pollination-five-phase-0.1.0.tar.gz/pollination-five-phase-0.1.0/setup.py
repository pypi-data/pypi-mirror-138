...
setuptools.setup(
    name='pollination-five-phase',                                     # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    url='https://github.com/pollination/five-phase',                   # will be translated to home
    project_urls={
        'icon': 'https://raw.githubusercontent.com/ladybug-tools/artwork/master/icons_components/honeybee/png/5phaserecipe.png',
        'docker': 'https://hub.docker.com/r/ladybugtools/honeybee-radiance'
    },
    description='Five phase recipe for Pollination.',                  # will be used as package description
    ...
    keywords='honeybee, radiance, ladybug-tools, daylight, five-phase',# will be used as keywords
