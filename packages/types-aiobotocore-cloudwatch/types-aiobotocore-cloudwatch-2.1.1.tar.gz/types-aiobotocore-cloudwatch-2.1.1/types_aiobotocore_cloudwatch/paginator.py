...
class DescribeAlarmHistoryPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeAlarmHistoryOutputTypeDef]:
        """
...
class DescribeAlarmsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        ActionPrefix: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeAlarmsOutputTypeDef]:
        """
...
class GetMetricDataPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[GetMetricDataOutputTypeDef]:
        """
...
class ListDashboardsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListDashboardsOutputTypeDef]:
        """
...
class ListMetricsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListMetricsOutputTypeDef]:
        """
