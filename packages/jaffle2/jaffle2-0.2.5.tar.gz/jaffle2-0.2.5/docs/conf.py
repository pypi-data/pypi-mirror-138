...
version_py = os.path.join(here, os.pardir, 'jaffle2', '_version.py')
...
latex_documents = [
    (master_doc, 'Jaffle2.tex', 'Jaffle2 Documentation',
...
man_pages = [
    (master_doc, 'jaffle2', 'Jaffle2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Jaffle2', 'Jaffle2 Documentation',
     author, 'Jaffle2', 'One line description of project.',
     'Miscellaneous'),
]
