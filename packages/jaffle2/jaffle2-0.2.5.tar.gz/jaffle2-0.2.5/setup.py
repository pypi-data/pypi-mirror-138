...
long_description = '''
Jaffle2 supercedes the original version of Jaffle which is archived and no longer maintained.

Jaffle2 is an automation tool for Python software development, which does:
...
Jaffle (archived) GitHub Respository
====================================
...
The original Jaffle documentation
...
setup(
    name='jaffle2',
    version=__version__,
    description='Version 2 of the original Jaffle. Python app and process orchestration tool for development environment',
    long_description=long_description,
    author='Jaffle Development Team, Albert Ferguson',
    author_email='albertferguson118@gmail.com',
    url='https://github.com/albert118/jaffle',
    classifiers=[
