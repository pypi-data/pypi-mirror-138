...
def _delvewheel_init_patch_0_0_18():
    import os
    import sys
    libs_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, 'pillow_heif.libs'))
    if sys.version_info[:2] >= (3, 8):
        ...
        with open(os.path.join(libs_dir, '.load-order-pillow_heif-0.1.6')) as file:
