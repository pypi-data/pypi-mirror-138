...
setup_kwargs = {
    'name': 'j-owens-soccerdata',
    'version': '0.0.2.dev1644950218',
    'description': 'A collection of wrappers over soccer data from various websites / APIs. Modified to not fail on parsing unplaying games.',
