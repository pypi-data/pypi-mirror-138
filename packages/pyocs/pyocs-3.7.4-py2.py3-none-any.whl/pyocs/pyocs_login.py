    ...
    def get_account_from_json_file():
        ...
        try:
            ...
            if "userCn" not in account_dict:
                #存储中文名字
                account_dict["userCn"] = str(input("请输入你的中文名字："))
                with open(_account_json_file, 'w') as mfile:
                    mfile.write(str(json.dumps(account_dict, indent=4)))
            ...
            if ~encrypt:
                ...
                account_dict_encrypt["userCn"] = account_dict["userCn"]
