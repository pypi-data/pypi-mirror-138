...
class DataCollector:
    ...
    def __init__(self, host, user, outDir, password=None, ssh_key=None, connect=True, tqdmMgr=None, novios=False):
        self.hmcClient  = HmcClient(host, user, outDir, password=password, ssh_key=ssh_key, connect=connect)
        self.host        = host
        self.outDir     = outDir
