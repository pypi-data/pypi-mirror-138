...
from CTADIRAC.Interfaces.API.Prod5bMCPipeAlphaSSTsFullMoonNSBJob import Prod5bMCPipeAlphaSSTsFullMoonNSBJob
...
def submit_transformation(job, trans_name):
  ...
  trans.setLongDescription("Prod5 simulation pipeline Alpha SST-only full moon NSB")  # mandatory
...
def run_simulation(args):
  ...
  if mode == 'WMS':
    ...
    trans_name = 'Prod5b_SSTOnly_Alpha_Full_Moon_%s_%s_%s_%s%s' %\
