...
$(document).ready(function () {
    ...
    const form_play_local = document.getElementById("form_play_local");
    const local_host_sound_route = "http://localhost:5050/sound/"
    const local_host_sound_route_upload = "http://localhost:5050/sound_local"
    ...
    file_upload.addEventListener("change", function () {
        ...
        // playlist_title.style.border = ".1em solid var(--border-color)";

        console.log(this.files);
        const files = this.files;    // inbound who knows
    ...
    $("button").click(function () {
        ...
        req.done(function (data) {
            ...
            if (data.result === 'deactivate_audio') {
                ...
                //There is no stop method — to implement a stop function,
                //you'd have to pause the media then set the currentTime property value to 0.
            ...
            if (data.result === 'activate_audio') {
                ...
                audio_visual.src = "";   // remove from mem
                audio_visual.pause();
                audio_visual.currentTime = 0;
                audio_visual.load();
                audio_visual.src = local_host_sound_route + current_station;
                audio_visual.play();
                if (!spectrum_analyser){
                    visualise_audio(null);
                    spectrum_analyser = true;
