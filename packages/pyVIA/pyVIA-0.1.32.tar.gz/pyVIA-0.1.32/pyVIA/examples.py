...
def main_Human(ncomps=80, knn=30, v0_random_seed=7, run_palantir_func=False):
    ...
    draw_sc_evolution_trajectory_dijkstra(v0, v1, embedding=tsnem)
    plt.show()
...
def main_Toy_comparisons(ncomps=10, knn=30, random_seed=42, dataset='Toy3', root_user='M1',
    ...
    draw_sc_evolution_trajectory_dijkstra(via_coarse=v0, via_fine=v1, embedding=embedding, idx=idx)
...
def main_faced(cell_line='mcf7', cluster_graph_pruning_std=1.):
    ...
    draw_sc_evolution_trajectory_dijkstra(v0, v1, embedding=embedding)
