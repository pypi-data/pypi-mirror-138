...
setup(
    ...
    name="dotility",  # Required

    # Version?
    version="0.0.1a0",  # Required

    # What does your project do?
    description="Link config files and scripts in a blink",  # Optional
    ...
    #data_files=[("man/man1", ["docs/relieve.1"])],  # Optional

    # Any executable scripts?
    # For example, the following would provide a command
    # called 'relieve' which executes the function 'main' from
    # file 'main' from package 'relieve', when invoked:
    entry_points={  # Optional
        "console_scripts": [
            # "dotility=dotility.main:main",
        ]
    },
