...
def validate(
    model, val_index_map, validation_loader, device, system_meter, conf_thres, nms_iou_threshold, print_freq=100
):
    ...
    for epoch in range(number_of_epochs):
        ...
        if epoch % eval_freq == 0 or final_epoch:
            eval_bounding_boxes = validate(ema.ema, val_index_map, validation_loader,
                                           device, valid_sys_meter, conf_thres, nms_iou_threshold)
