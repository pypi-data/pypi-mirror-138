...
def _parse_argument_settings(automl_settings: Dict[str, Any]) -> Tuple[Dict[str, Any], List[str]]:
    ...
    parser.add_argument(utils._make_arg(ODTrainingLiterals.VALIDATION_IOU_THRESHOLD), type=float,
                        help="IOU threshold to use when computing validation metrics",
                        default=training_settings_defaults[ODTrainingLiterals.VALIDATION_IOU_THRESHOLD])
