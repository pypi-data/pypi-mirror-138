...
def merge_nc_files(nc_paths, by):
    """
...
def merge_nc_remove(source_paths, by):
    dest_path = merge_nc_files(source_paths, by)
    ...
    while True:
        ...
        try:
            if isinstance(public_url, str):
                url1 = b2_public_key_pattern.format(base_url=public_url, bucket=bucket, obj_key=source_path)
