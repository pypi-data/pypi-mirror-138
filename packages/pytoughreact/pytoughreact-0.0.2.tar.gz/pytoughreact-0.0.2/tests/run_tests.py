...
from pytoughreact import mulgrid, t2react, t2reactgrid, PrimarySpecies, WaterComp, Water, MineralComp, \
    pHDependenceType2, Dissolution, Precipitation, Mineral, ReactGas, MineralZone, PermPoroZone, PermPoro, t2chemical, \
    t2solute, t2bio, t2grid, Component, Gas, Water_Bio, Biomass, Process, BIODG, t2result

from pytoughreact.pytough.t2reactgrids import rocktype, t2zone
