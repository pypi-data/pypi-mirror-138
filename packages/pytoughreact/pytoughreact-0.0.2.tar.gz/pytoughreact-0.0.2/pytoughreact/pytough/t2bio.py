...
from pytoughreact.pytough.mulgrids import unfix_blockname, fix_blockname, padstring
from pytoughreact.pytough.t2components import BaseComponent, Biomass, Water_Bio, Gas
...
class t2bio(object):
    ...
    def write(self, filename='', meshfilename='', runlocation='',
        ...
        if runlocation:
            ...
            os.chdir(runlocation)
        if filename: self.filename = filename
        if self.filename == '': self.filename = 't2bio.dat'
    ...
    def transfer_rocktypes_from(self, source, mapping):
        ...
        t2bio object, using the specified block mapping."""
        from copy import deepcopy
    ...
    def transfer_generators_from(self, source, sourcegeo, geo,
        ...
        """Transfers generators from another t2bio object, using the
    ...
    def transfer_from(self, source, sourcegeo, geo,
        ...
        initial conditions from another t2bio object (without
    ...
    def effective_incons(self, incons=None):
        ...
        default initial conditions and INCON and INDOM data blocks in the t2bio object.
    ...
    def json(self, geo, mesh_filename, atmos_volume=1.e25, incons=None,
        ...
        """Returns a Waiwera JSON dictionary representing the t2bio object
