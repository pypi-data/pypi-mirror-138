...
from pytoughreact.pytough.mulgrids import fix_blockname, valid_blockname
from pytoughreact.pytough.fixed_format_file import fortran_float, fortran_int
import io
import sys
...
class toughreact_tecplot(object):
    ...
    def setup_table(self, blocks):
        ...
        object."""
        import pytoughreact.pytough.mulgrids as mg
        import pytoughreact.pytough.t2grids as t2g
