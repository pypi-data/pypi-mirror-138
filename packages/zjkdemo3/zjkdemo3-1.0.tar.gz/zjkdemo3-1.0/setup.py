...
exec(open(os.path.join(here, 'zjkdemo3/d3rlpy', '_version.py')).read())
...
if __name__ == "__main__":
    ...
    # setup Cython build
    ext = Extension('zjkdemo3/d3rlpy.dataset',
                    sources=['zjkdemo3/d3rlpy/dataset.pyx'],
                    include_dirs=[get_include(), 'zjkdemo3/d3rlpy/cpp/include'],
                    language='c++',
