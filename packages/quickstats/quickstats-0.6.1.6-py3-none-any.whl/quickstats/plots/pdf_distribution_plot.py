...
class PdfDistributionPlot(AbstractPlot):
    ...
    def __init__(self, collective_data, blind_range:Optional[List[float]]=None,
                 ...
                 styles:Optional[Union[Dict, str]]='pdf_dist',
                 analysis_label_options:Optional[Union[Dict, str]]=None,
                 figure_index:Optional[int]=None,
                 config:Optional[Dict]=None):
        super().__init__(styles=styles, figure_index=figure_index,
    ...
    def draw(self, xlabel:str="", ylabel:str="",
        ...
        if comparison_options:
            ax, ax_ratio = self.draw_frame(ratio_frames, prop_cycle=self.prop_cycle, logx=logx, logy=logy)
        else:
            ax = self.draw_frame(prop_cycle=self.prop_cycle, logx=logx, logy=logy)            
