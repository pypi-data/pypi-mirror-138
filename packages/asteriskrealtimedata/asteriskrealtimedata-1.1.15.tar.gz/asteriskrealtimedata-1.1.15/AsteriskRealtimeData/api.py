...
from AsteriskRealtimeData.infrastructure.api.last_status_controller import (
...
from AsteriskRealtimeData.infrastructure.api.queue_member_controller_v1 import (
    QueueMemberControllerV1,
)
...
class Api:
    ...
    class LastStatus:
        @staticmethod
        def create(last_status: LastStatusVo) -> LastStatusVo:
            return LastStatusController().create(last_status)

        @staticmethod
        def update(last_status: LastStatusUpdateVo) -> LastStatusVo:
            return LastStatusController().update(last_status)

        @staticmethod
        def get_all() -> List[LastStatusVo]:
            return LastStatusController().get_all()

        @staticmethod
        def get_by_peer(peer: str) -> LastStatusVo:
            return LastStatusController().get_by_peer(peer)

        @staticmethod
        def get_by_search_criteria(
            search_criteria: LastStatusSearchCriteriaVo,
        ) -> LastStatusVo:
            return LastStatusController().get_by_search_criteria(search_criteria)

        @staticmethod
        def delete_by_peer(peer: str) -> None:
            LastStatusController().delete_by_peer(peer)
    ...
    class QueueMemberV1:
        @staticmethod
        def create(queue_member: QueueMemberVoV1) -> QueueMemberVoV1:
            return QueueMemberControllerV1().create(queue_member)

        @staticmethod
        def update(queue_member_update_vo: QueueMemberUpdateVoV1) -> QueueMemberVoV1:
            return QueueMemberControllerV1().update(queue_member_update_vo)

        @staticmethod
        def get_all() -> List[QueueMemberVoV1]:
            return QueueMemberControllerV1().get_all()

        @staticmethod
        def get_by_peer(peer: str) -> QueueMemberVoV1:
            return QueueMemberControllerV1().get_by_peer(peer)

        @staticmethod
        def get_by_search_criteria(
            search_criteria: QueueMemberSearchCriteriaVoV1,
        ) -> QueueMemberVoV1:
            return QueueMemberControllerV1().get_by_search_criteria(search_criteria)

        @staticmethod
        def delete_by_peer(peer: str) -> None:
            QueueMemberControllerV1().delete_by_peer(peer)
