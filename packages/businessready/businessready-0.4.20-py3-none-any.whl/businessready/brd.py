...
def NXOS_learn_platform(hostname, username, password, ip):
    ...
    # Create Testbed
        ...
        # Learn Interace to JSON
            ...
            try:
                learn_platform = device.learn("platform").info
            except:
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = NXOS_learn_interface_template.render(to_parse_platform=learn_platform,filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
