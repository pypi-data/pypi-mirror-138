...
def IOS_learned_stp(hostname, username, password, ip):
    ...
    # Create Testbed
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = IOS_learned_stp_template.render(to_parse_routing=learned_stp['global'],filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
    ...
    # -------------------------
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = IOS_learned_stp_template.render(to_parse_routing=learned_stp['rapid_pvst'],filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
