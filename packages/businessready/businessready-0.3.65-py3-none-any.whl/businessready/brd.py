...
def IOS_show_environment_all(hostname, username, password, ip):
    ...
    # Create Testbed
        ...
        # Show CDP Neighbors to JSON
            ...
            try:
                show_environment_all = device.parse("show enviroment all")
            except:
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = IOS_show_environment_all_template.render(to_parse_environment=parsed_show_environment['switch'],filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
