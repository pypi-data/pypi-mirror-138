...
def IOS_show_cdp_neighbors_detail(hostname, username, password, ip):
    ...
    # -------------------------
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = IOS_show_cdp_neighbors_detail_totals_template.render(to_parse_cdp_neighbors=show_cdp_neighbors_detail['total_entries_displayed'],filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
