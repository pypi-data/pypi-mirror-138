    ...
    # Create Testbed
        ...
        # Learn VLAN to JSON
            try:
                ...
                print("Device Has No VLANs to Learn")
                learned_vlan = "Device Has No VLANs to Learn"
            
        # Pass to template 

        if learned_vlan != "Device Has No VLANs to Learn":
