...
class ModelParser:
    def __init__(self):
        ...
        self._model_types_converter = {
            ImportModelTypeEnum.JSON_TF2: self.convert_json_model,
            ImportModelTypeEnum.H5_TF2: self.convert_h5_model,
            ImportModelTypeEnum.ONNX: self.convert_onnx_model,
            ImportModelTypeEnum.PB_TF2: self.convert_pb_model,
        }
    ...
    def generate_model_graph(self, model_path: Path, model_type: ImportModelTypeEnum,
        ...
        model_to_keras_converter: Optional[Callable[[str], Dict]] = self._model_types_converter.get(model_type)
