...
# spaces are allowed due to SDK package tests
# TODO - remove spaces from allowed IO once the SDK package tests are fixed
ALLOWED_IO_NAME_REGEX = r"[\w\s]+"
NAME = "name"
...
def randomize_suffix(suffix_len):
    return "".join(
...
class FunctionCall(pydantic.BaseModel):
    ...
    def create_name(cls, name, values):
        ...
        suffix = randomize_suffix(_SUFFIX_LEN)
    ...
    @staticmethod
    def _parse_io_slicing(io_str: str) -> Tuple[str, slice]:
