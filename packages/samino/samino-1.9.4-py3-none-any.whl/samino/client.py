...
class Client:
    def __init__(self, deviceId: str = None, proxies: dict = None, debug: bool = False, renewedDeviceId: bool = False):
        self.debug = debug
        self.proxies = proxies
        self.uid = None
        headers.deviceId = deviceId
        headers.new = renewedDeviceId
    ...
    def sid_login(self, sid: str):
        ...
        headers.sid = sid
        req = requests.get(api(f"/g/s/account"), headers=headers.Headers().headers, proxies=self.proxies)
