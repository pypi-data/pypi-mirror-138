...
class BaseStack(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(self.__class__, self, [scope, organization, prefix, options])
    ...
    def bootstrap_workspace(
        ...
        :param name: -
        '''
        return typing.cast(cdktf_cdktf_provider_tfe.Workspace, jsii.invoke(self, "bootstrapWorkspace", [name]))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="remoteBackendOptions")
    def remote_backend_options(self) -> "RemoteBackendOptions":
        return typing.cast("RemoteBackendOptions", jsii.get(self, "remoteBackendOptions"))
