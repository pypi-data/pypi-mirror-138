...
_HLOMODULEPROTO_PROFILESOURCE = _descriptor.EnumDescriptor(
  name='ProfileSource',
  full_name='xla.HloModuleProto.ProfileSource',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EMBEDDED', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_HLOMODULEPROTO_PROFILESOURCE)

_HLOMODULEPROTO_COMPILATIONEVENT = _descriptor.EnumDescriptor(
  name='CompilationEvent',
  full_name='xla.HloModuleProto.CompilationEvent',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIRST_COMPILATION', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECOMPILATION', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_HLOMODULEPROTO_COMPILATIONEVENT)
...
_HLOMODULEPROTO = _descriptor.Descriptor(
  ...
  enum_types=[
    ...
    _HLOMODULEPROTO_PROFILESOURCE,
    _HLOMODULEPROTO_COMPILATIONEVENT,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_HLOMODULEPROTO_PROFILEINFO.fields_by_name['profile_source'].enum_type = _HLOMODULEPROTO_PROFILESOURCE
_HLOMODULEPROTO_PROFILEINFO.fields_by_name['compilation_event'].enum_type = _HLOMODULEPROTO_COMPILATIONEVENT
...
_HLOMODULEPROTO_PROFILESOURCE.containing_type = _HLOMODULEPROTO
_HLOMODULEPROTO_COMPILATIONEVENT.containing_type = _HLOMODULEPROTO
