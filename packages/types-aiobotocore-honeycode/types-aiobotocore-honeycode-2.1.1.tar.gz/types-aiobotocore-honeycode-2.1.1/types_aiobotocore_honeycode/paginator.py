...
class ListTableColumnsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListTableColumnsResultTypeDef]:
        """
...
class ListTableRowsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListTableRowsResultTypeDef]:
        """
...
class ListTablesPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListTablesResultTypeDef]:
        """
...
class QueryTableRowsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[QueryTableRowsResultTypeDef]:
        """
