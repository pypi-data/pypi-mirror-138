...
GOSLATE
Goslate module.
https://github.com/yeahwhat-mc/goslate
"""
...
__copyright__ = "2013, https://zhuoqiang.me"
__license__ = "MIT"
__date__ = '2013-05-11'
...
# noinspection HttpUrlsUsage,PyPep8Naming,PyShadowingNames,PyMissingOrEmptyDocstring,PyUnresolvedReferences
class Goslate(object):
    ...
    :type opener: `urllib2.OpenerDirector <https://docs.python.org/2/library/urllib2.html#urllib2.OpenerDirector>`_
    ...
    def _basic_translate(self, text, target_language, source_language):
        ...
        if not text.strip():
            return tuple(u'' for _ in range(len(self._writing))), str(target_language)
