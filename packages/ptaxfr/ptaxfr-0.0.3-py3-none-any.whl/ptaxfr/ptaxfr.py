...
class ptaxfr:
    ...
    def run(self, args):
        ...
        if self.vulnerable_only:
            ptmisclib.ptprint(ptmisclib.out_ifnot("Vulnerable domains:", "TITLE", self.use_json or self.silent))
...
def get_help():
    return [
        ...
        {"options": [
            ...
            ["-pr", "--print_records",    "",           "Print DNS records"],
...
def parse_args():
    ...
    parser.add_argument("-pr", "--print_records", action="store_true")
