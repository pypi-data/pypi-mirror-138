...
class DescribeBucketsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeBucketsResponseTypeDef]:
        """
...
class GetUsageStatisticsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[GetUsageStatisticsResponseTypeDef]:
        """
...
class ListClassificationJobsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListClassificationJobsResponseTypeDef]:
        """
...
class ListCustomDataIdentifiersPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListCustomDataIdentifiersResponseTypeDef]:
        """
...
class ListFindingsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListFindingsResponseTypeDef]:
        """
...
class ListFindingsFiltersPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListFindingsFiltersResponseTypeDef]:
        """
...
class SearchResourcesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[SearchResourcesResponseTypeDef]:
        """
