...
def compare_gh_uv(data_source='cassandra',ana_data_source='cmadaas',
    ...
    hgt_ana = get_model_grid(data_source=data_source, init_time=anl_time, fhour=0, data_name=ana_data_name, var_name='hgt', level=hgt_lev, extent=map_extent)
    u_ana = get_model_grid(data_source=data_source, init_time=anl_time, fhour=0, data_name=ana_data_name, var_name='u', level=uv_lev, extent=map_extent)
    v_ana = get_model_grid(data_source=data_source, init_time=anl_time, fhour=0, data_name=ana_data_name, var_name='v', level=uv_lev, extent=map_extent)
