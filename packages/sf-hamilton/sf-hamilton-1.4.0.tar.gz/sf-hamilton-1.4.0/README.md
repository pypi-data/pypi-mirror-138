...
a central dataframe, you instead think about the column(s)/output(s) you want to create, and what inputs are required. There
is no need for you to think about maintaining a dataframe/central object, meaning you do not need to think about any "glue" code;
