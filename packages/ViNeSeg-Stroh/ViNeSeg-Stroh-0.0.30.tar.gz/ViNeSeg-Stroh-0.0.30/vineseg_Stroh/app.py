...
#        self.currentModel = self.settings.value("currentModel", str) or None
    ...
    def microscope(self):
        ...
        # refresh: list all images and create mean img

        # refresh: perform autosegmentation with loaded _meanImg (if micModeOn)


        # refresh will check if sufficient new images were loaded or maybe just create mean image whenever clicked (unless there are no new images)

        # next/prev image should now only find _mean.png files and automatically do the labeling
