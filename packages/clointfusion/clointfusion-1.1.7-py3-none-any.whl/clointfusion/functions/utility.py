        ...
        def find(function_partial_name=""):
            ...
            try:
                if function_partial_name:
                    import clointfusion.clointfusion as cf_docs
                    pi.search(cf_docs, name=function_partial_name)
        ...
        def download_this_file(url="", output_folder_path=""):
            ...
            try:
                ...
                if "export" in url:
                    ...
                    message_toast("File downloaded",
                                  file_folder_path=download_file_path)
