from clointfusion.check_system import os_name, windows_os, mac_os, linux_os, python_version, python_37, python_38, python_39, python_310, report_error, browser_driver, helium_service_launched
import sys
...
if os_name == windows_os:
    ...
    if python_version == python_37:
        ...
        class ChromeBrowser:
            ...
            def open_browser(self, dummy_browser:bool=True, profile:str="Default", incognito:bool=False, ):
                ...
                try:
                    with DisableLogger():
                        ...
                        self.browser_driver = webdriver.Chrome(ChromeDriverManager().install(), options=self.options)
            ...
            def mouse_hover(self,User_Visible_Text_Element:str="", element:str="", )->bool:
