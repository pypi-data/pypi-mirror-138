from typing import (
    Any, BinaryIO, List, Optional, Sequence, SupportsIndex, Tuple, Union,
...
class Surface:
    ...
    @overload
    def write_to_png(self, target: Union[str, BinaryIO]) -> None:
        ...
...
class ImageSurface(Surface):
    ...
    @classmethod
    def create_from_png(cls, source: Union[str, BinaryIO]) -> ImageSurface:
        ...
...
class PDFSurface(Surface):
    def __init__(
        self, target: Union[str, BinaryIO, None], width_in_points: float,
...
class RecordingSurface(Surface):
    def __init__(
        self, content: int, extents: _Rectangle
    ) -> None:
        ...
