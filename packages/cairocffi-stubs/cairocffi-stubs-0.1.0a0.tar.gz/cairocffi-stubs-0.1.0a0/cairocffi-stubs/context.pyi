...
class Context():
    ...
    def user_to_device_distance(self, dx: float,
    ...
    def device_to_user_distance(self, dx: float,
                                dy: float) -> Tuple[float, float]:
        ...
    ...
    def rel_curve_to(
        self, dx1: float, dy1: float, dx2: float, dy2: float, dx3: float,
        dy3: float
    ) -> None:
        ...
    ...
    def tag_begin(self, tag_name: str, attributes: Optional[str] = ...) -> None:
        ...
