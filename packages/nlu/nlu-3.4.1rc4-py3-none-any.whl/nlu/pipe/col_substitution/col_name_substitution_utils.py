...
IF there is only 1 component of <type> in the component_list, the <type> will/can be ommitted.
...
class ColSubstitutionUtils:
    ...
    def get_final_output_cols_of_component(c, df, anno_2_ex):
        ...
        """Get's a list of all columns that have been derived in the pythonify procedure from the component
        ...
        # find all metadata fields generated by component
