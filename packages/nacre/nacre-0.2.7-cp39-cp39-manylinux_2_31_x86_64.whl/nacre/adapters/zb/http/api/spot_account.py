...
class ZbSpotAccountHttpAPI:
    ...
    async def get_order(
        self, symbol: str, id: Optional[int] = None, client_order_id: Optional[str] = None
    ) -> Dict[str, Any]:
        if (id is not None) == (client_order_id is not None):
            raise ValueError("pass client_order_id or id")
