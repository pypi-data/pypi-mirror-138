...
class Dataset(DataLoader):
    ...
    Args:
        ...
        settings: dict or path to a yaml file. If a path is provided it must
            be provided as an absolute path. The possible keys for the settings:
                ...
                - categorical_curves (optional - default []): The curves to be considered as categorical when identifying which column as numerical
    ...
    def __init__(
        ...
        self.ingest_init_input(att_name="settings", att_val=settings)
        for key, val in self.settings.items():
            setattr(self, key, val)

        self.ingest_init_input(att_name="mappings", att_val=mappings)
        ...
        # If a preprocessing_pipeline was defined in the settings file ensure
