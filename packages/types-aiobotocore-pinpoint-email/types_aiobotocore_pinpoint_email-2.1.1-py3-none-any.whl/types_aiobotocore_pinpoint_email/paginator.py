...
class GetDedicatedIpsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[GetDedicatedIpsResponseTypeDef]:
        """
...
class ListConfigurationSetsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListConfigurationSetsResponseTypeDef]:
        """
...
class ListDedicatedIpPoolsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListDedicatedIpPoolsResponseTypeDef]:
        """
...
class ListDeliverabilityTestReportsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListDeliverabilityTestReportsResponseTypeDef]:
        """
...
class ListEmailIdentitiesPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListEmailIdentitiesResponseTypeDef]:
        """
