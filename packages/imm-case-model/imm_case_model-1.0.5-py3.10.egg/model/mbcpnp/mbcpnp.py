...
from model.common.bcpnp import Bcpnp,BcpnpBackground
from model.common.commonmodel import CommonModel


class MBcpnpModel(CommonModel):
    # person
    personal:Personal
    marriage:Marriage
    ...
    #bcpnp
    bcpnp:Bcpnp
    bcpnpbackground:BcpnpBackground
    ...
    def __init__(self,excels=None,output_excel_file=None):
        if output_excel_file:
            excels=[
                'template/excel/tr.xlsx',
                'template/excel/pa.xlsx'
            ]
        else:
