...
from model.errordict import error_dict
...
class CommonModel(BaseModel):
    ...
    def __init__(self,excels,output_excel_file,global_dict):
        ...
        *original_excel_objs,new_excel_obj=self._addupExcels(excels) # the last one is new_excel_obj, before this are all original_objs 
        if output_excel_file:
            self._generateExcel(global_dict,new_excel_obj,output_excel_file)
        else:
            ...
            try:
                ...
                pass    # since in _getinput has capatured exceptions, here we do nothing.
    ...
    def _generateExcel(self,global_dict,new_excel_obj,excel_file):    
        ...
        new_excel_obj.makeExcel(excel_file,sheets=sheets,tables=tables)
