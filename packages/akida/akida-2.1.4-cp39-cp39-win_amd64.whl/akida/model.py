...
class Model(ModelBase):
    ...
    def fit(self, inputs, input_labels=None, batch_size=None):
        ...
        - x, representing the first dimension,
        - y, representing the second dimension,
        - c, representing the channel, or more generally the feature (last dimension).

        The input shape must be (n, x, y, c), for both events and images.
        ...
        Returns:
            a numpy array of shape (n, out_x, out_y, out_c).
