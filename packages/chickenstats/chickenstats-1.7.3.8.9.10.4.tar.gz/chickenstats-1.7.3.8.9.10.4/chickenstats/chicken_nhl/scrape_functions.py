...
def scrape_pbp(game_ids, _print = True):
    ...
    for game_id_idx, game_id in enumerate(game_ids):
        ...
        for x in list(range(1, 3)):
            ...
            next_not_fo = np.logical_and(near_faceoff, pbp_df.event.shift(-x-1) != 'FAC')
            ...
            #conds = [pbp_df.event_zone == 'OFF', pbp_df.event_zone == 'DEF', pbp_df.event_zone == 'NEU']
    ...
    if CONCAT_LIST == []:
        ...
        columns = ['season', 'session', 'game_date', 'game_id', 'event_idx','period', 'time', 'event_team', 'event', 'description', 'strength',
                   ...
                   'opp_goalie', 'home_skaters', 'home_on', 'home_goalie', 'home_on_1', 'home_on_1_pos', 'home_on_2', 'home_on_2_pos',
