...
class SnowFinch:
    ...
    def connect(cls, methods: List[str] = ['local'], *args, **kwargs):
        ...
        from snowfinch.sfconnect import SnowFinch
        conn = SnowFinch.connect(method=['secretsmanager'], credsman_name='acme')
        """
        available_methods = {
        ...
        for method in methods:
            ...
            raise InvalidMethodException(
                f'methods {methods} are not a valid connection methods. Valid methods are "secretsmanager, local"')
    ...
    def execute_simple(self, sql: str):
        ...
        connector execute() method found here:
        https://docs.snowflake.net/manuals/user-guide/python-connector-api.html#execute
