...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, base_path=None, pulp_labels=None, repository_version=None, pulp_created=None, content_guard=None, repository=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
