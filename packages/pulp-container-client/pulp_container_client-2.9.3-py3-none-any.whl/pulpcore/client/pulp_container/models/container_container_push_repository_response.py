...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, name=None, pulp_href=None, retain_repo_versions=None, pulp_created=None, versions_href=None, latest_version_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
