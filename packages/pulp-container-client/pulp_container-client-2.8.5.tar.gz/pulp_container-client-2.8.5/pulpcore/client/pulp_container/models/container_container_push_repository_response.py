...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, pulp_href=None, retain_repo_versions=None, versions_href=None, description=None, latest_version_href=None, name=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
