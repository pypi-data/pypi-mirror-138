...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, versions_href=None, latest_version_href=None, pulp_created=None, name=None, description=None, pulp_href=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
