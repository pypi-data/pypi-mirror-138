...
import org.optaplanner.core.impl.score.director.drools
import typing
...
class ScoreDirectorFactoryConfig(org.optaplanner.core.config.AbstractConfig['ScoreDirectorFactoryConfig']):
    ...
    def getGizmoKieBaseSupplier(self) -> java.util.function.Supplier[org.kie.api.KieBase]:
        ...
        """
        ...
    def getGizmoKieRuntimeBuilderWrapper(self) -> org.optaplanner.core.impl.score.director.drools.KieRuntimeBuilderWrapper: ...
    ...
    def setGizmoKieBaseSupplier(self, supplier: typing.Union[java.util.function.Supplier[org.kie.api.KieBase], typing.Callable[[], org.kie.api.KieBase]]) -> None:
        ...
        """
        ...
    def setGizmoKieRuntimeBuilderWrapper(self, kieRuntimeBuilderWrapper: org.optaplanner.core.impl.score.director.drools.KieRuntimeBuilderWrapper) -> None: ...
    ...
    def withGizmoKieBaseSupplier(self, supplier: typing.Union[java.util.function.Supplier[org.kie.api.KieBase], typing.Callable[[], org.kie.api.KieBase]]) -> 'ScoreDirectorFactoryConfig':
        ...
        """
        ...
    def withGizmoKieRuntimeBuilderWrapper(self, kieRuntimeBuilderWrapper: org.optaplanner.core.impl.score.director.drools.KieRuntimeBuilderWrapper) -> 'ScoreDirectorFactoryConfig': ...
