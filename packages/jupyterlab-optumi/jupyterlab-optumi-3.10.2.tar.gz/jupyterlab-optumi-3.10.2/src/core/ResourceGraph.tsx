    ...
    public componentDidMount = () => {
        ...
        let newState: Partial<IState> = {
            data: [
                ...
                { x: [], y: [], mode: 'lines', type: 'scatter', line: { shape: 'spline', color: Colors.DISK }, fill: 'tonexty', fillcolor: Colors.DISK + '60', name: 'SWAP', legendgroup: 'SWAP' },
                { x: [], y: [], mode: 'lines', type: 'scatter', line: { shape: 'spline', width: 0 }, fill: 'tonexty', fillcolor: Colors.DISK + '60', name: 'SWAP min', hoverinfo: 'none', legendgroup: 'SWAP', showlegend: false },
