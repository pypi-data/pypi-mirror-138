...
from fudataqa.tensorflow.core.protobuf import rewriter_config_pb2 as tensorflow_dot_core_dot_protobuf_dot_rewriter__config__pb2
...
_RPCOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_ssl', full_name='tensorflow.RPCOptions.use_ssl', index=5,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='client_ssl_cert', full_name='tensorflow.RPCOptions.client_ssl_cert', index=6,
...
_RPCOPTIONS.fields_by_name['client_ssl_cert'].message_type = tensorflow_dot_core_dot_protobuf_dot_ssl__pb2._CLIENTSSLCERT
