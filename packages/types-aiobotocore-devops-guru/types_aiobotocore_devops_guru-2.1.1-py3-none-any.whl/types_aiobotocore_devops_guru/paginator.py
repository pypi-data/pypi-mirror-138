...
class DescribeOrganizationResourceCollectionHealthPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeOrganizationResourceCollectionHealthResponseTypeDef]:
        """
...
class DescribeResourceCollectionHealthPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[DescribeResourceCollectionHealthResponseTypeDef]:
        """
...
class GetCostEstimationPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[GetCostEstimationResponseTypeDef]:
        """
...
class GetResourceCollectionPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ResourceCollectionType: ResourceCollectionTypeType,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[GetResourceCollectionResponseTypeDef]:
        """
...
class ListAnomaliesForInsightPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        AccountId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListAnomaliesForInsightResponseTypeDef]:
        """
...
class ListEventsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        AccountId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListEventsResponseTypeDef]:
        """
...
class ListInsightsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListInsightsResponseTypeDef]:
        """
...
class ListNotificationChannelsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListNotificationChannelsResponseTypeDef]:
        """
...
class ListOrganizationInsightsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        OrganizationalUnitIds: Sequence[str] = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListOrganizationInsightsResponseTypeDef]:
        """
...
class ListRecommendationsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        AccountId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListRecommendationsResponseTypeDef]:
        """
...
class SearchInsightsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[SearchInsightsResponseTypeDef]:
        """
...
class SearchOrganizationInsightsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[SearchOrganizationInsightsResponseTypeDef]:
        """
