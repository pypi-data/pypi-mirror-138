...
#----------------------------------------------------------------
        ...
        if filesource==False:
            pause=False
        frame_from_file = None # backup for effects; also for CAMERA now!
        ...
        while connection_ok: #========================================================
            ...
            if connection_ok:
                ...
                if (tracker!=None) and (not pause):
                    ...
                    tracker_list.append( (round(cx), round(cy)) )
...
""")
                ...
                if (not frame is None) and (rpi_name!="") and (key == ord('f')):
                    ...
                    measure_fov = round(measure_fov*1.5)
                    if measure_fov>180:
                        measure_fov = 180
                if (not frame is None) and (rpi_name!="") and (key == ord('F')):
