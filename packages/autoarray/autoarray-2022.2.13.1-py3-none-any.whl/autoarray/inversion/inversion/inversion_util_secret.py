...
# @numba_util.jit()
# def curvature_matrix_via_w_tilde_preload_and_natural_interpolation_from(
#     w_tilde_preload : np.ndarray,
#     sub_native_index_for_sub_slim_index : np.ndarray,
#     pixelization_pixels,
...
# ) -> np.ndarray:
#
#     image_pixels = len(sub_native_index_for_sub_slim_index)
#
#     curvature_matrix = np.zeros(
#         (pixelization_pixels, pixelization_pixels)
#     )
#
#     for ip0 in range(image_pixels):
#
#         neighbor_indexes_0 = neighbor_indexes[ip0]
#         neighbor_weights_0 = neighbor_weights[ip0]
#         n0 = neighbor_sizes[ip0]
#
#         ip0_y, ip0_x = sub_native_index_for_sub_slim_index[ip0]
#
#         for ip1 in range(image_pixels):
#
#             neighbor_indexes_1 = neighbor_indexes[ip1]
#             neighbor_weights_1 = neighbor_weights[ip1]
#             n1 = neighbor_sizes[ip1]
#
#             ip1_y, ip1_x = sub_native_index_for_sub_slim_index[ip1]
#
#             y_diff = ip1_y - ip0_y
#             x_diff = ip1_x - ip0_x
#
...
#                 for j in range(n1):
#
#                     sp0 = neighbor_indexes_0[i]
#                     sp1 = neighbor_indexes_1[j]
#                     w0 = neighbor_weights_0[i]
#                     w1 = neighbor_weights_1[j]
#
#                     curvature_matrix[sp0, sp1] += w_tilde_preload[y_diff, x_diff] * w0 * w1
#
#     return curvature_matrix
