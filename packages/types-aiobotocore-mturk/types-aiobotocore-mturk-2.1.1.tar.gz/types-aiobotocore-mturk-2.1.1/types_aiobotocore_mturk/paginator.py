...
class ListAssignmentsForHITPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListAssignmentsForHITResponseTypeDef]:
        """
...
class ListBonusPaymentsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        AssignmentId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListBonusPaymentsResponseTypeDef]:
        """
...
class ListHITsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListHITsResponseTypeDef]:
        """
...
class ListHITsForQualificationTypePaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListHITsForQualificationTypeResponseTypeDef]:
        """
...
class ListQualificationRequestsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, QualificationTypeId: str = ..., PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListQualificationRequestsResponseTypeDef]:
        """
...
class ListQualificationTypesPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListQualificationTypesResponseTypeDef]:
        """
...
class ListReviewableHITsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListReviewableHITsResponseTypeDef]:
        """
...
class ListWorkerBlocksPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListWorkerBlocksResponseTypeDef]:
        """
...
class ListWorkersWithQualificationTypePaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListWorkersWithQualificationTypeResponseTypeDef]:
        """
