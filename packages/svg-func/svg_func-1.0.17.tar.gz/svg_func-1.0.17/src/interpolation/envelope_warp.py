...
def main(svgpath=None,sample_n=10,filetype='path',c_svg=None,csvg_filetype='path',arch_per=0.3,pos='up',fix='top', mode='arch',file_path = None):
    ...
    svg, xml = save_l_svg(domTree,transed_points, bh_indx, bh_color, bh_hz, mode=mode, file_path=file_path,n=sample_n)
    sat = time.time()
...
if __name__ == "__main__":
    ...
    svg,xml = main(svgpath=r"C:\Users\25790\Downloads\SVG\资源 3.svg",c_svg=r'C:\Users\25790\Downloads\未标题-2-05.svg',file_path=r'C:\Users\25790\Downloads\result.svg', filetype='path',csvg_filetype='path',mode='random')
    # print(time.time()-st1)
    # print(xml)
