...
if __name__ == "__main__":
    ...
    svg,xml = main(svgpath=r"C:\Users\25790\Downloads\封套扭曲待修复\25.svg",c_svg=r'C:\Users\25790\Downloads\封套扭曲待修复\1-2.svg',file_path=r'C:\Users\25790\Downloads\result.svg', filetype='path',csvg_filetype='path',mode='random')
    # print(time.time()-st1)
    # print(xml)
