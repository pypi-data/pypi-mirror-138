...
class Chunk(object):
    ...
    def values(self) -> typing.Iterator[np.ndarray]:
        """values()
        Returns a context-manager object which saves values automatically
    ...
    def enumerate(self) -> typing.Iterator[typing.Tuple[int, int, int, typing.Any]]:
        ...
        When the generator is evaluated, it will returns tuples of the
    ...
    def object_extent(self):
        """The extent of the object this Chunk is from

        Returns:
            cegalprizm.pythontool.Extent: the extent of the object this Chunk is from"""
    ...
    def as_dataframe(self) -> pd.DataFrame:
        ...
        This method is only available when running under CPython."""
        import pandas as pd
