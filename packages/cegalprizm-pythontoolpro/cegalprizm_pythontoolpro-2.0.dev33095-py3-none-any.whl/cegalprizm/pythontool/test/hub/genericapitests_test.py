...
class GenericApiTestsTest(PetreltestUnitCase):
    ...
    def test_BridgeAccessors(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\bridge_accessors_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_BridgeIterOop(self):
        ...
        try:
            ...
            for (guid, prop) in list(petrellink.properties.items()):
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\bridge_iter_oop_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_BridgeInjection(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\bridge_injection_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertydiscreteCodes(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridpropertydiscrete_codes_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertydiscreteApiValues(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridpropertydiscrete_api_values_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_SurfaceattributediscreteApiValues(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\surfaceattributediscrete_api_values_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Oneplusone(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\oneplusone_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertyApiAcceptsFloats(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridproperty_api_accepts_floats_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertyApiEnumerate(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridproperty_api_enumerate_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertyApiSmoketest(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridproperty_api_smoketest_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertyApiValues(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridproperty_api_values_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertyRetrieveStats(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridproperty_retrieve_stats_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Seismic3dApiAnnotationRoundtrip(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\seismic3D_api_annotation_roundtrip_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Seismic3dApiGriddingRoundtrip(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\seismic3D_api_gridding_roundtrip_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_SurfaceattributeApiGriddingRoundtrip(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\surfaceattribute_api_gridding_roundtrip_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_SurfaceattributeApiEnumerate(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\surfaceattribute_api_enumerate_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_SurfaceattributeApiValues(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\surfaceattribute_api_values_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_UndefValueSmoketest(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\undef_value_smoketest_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PetrelconnectionPingOop(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_ping_oop_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
