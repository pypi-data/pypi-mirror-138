...
class PythonToolTestProject2ScriptsTest(PetreltestUnitCase):
    ...
    def test_PetrelconnectionWellsWelllogsPaths(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_wells_welllogs_paths_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PetrelconnectionPointsetsPolylinesetsPaths(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_pointsets_polylinesets_paths_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PetrelconnectionSurfaceSurfaceattributesPaths(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_surface_surfaceattributes_paths_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PetrelconnectionGridsGridpropertiesPaths(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_grids_gridproperties_paths_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PetrelconnectionHorizonHorizonpropertiesPaths(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_horizon_horizonproperties_paths_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PetrelconnectionSeismic3dSeismic2dPaths(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_seismic3D_seismic2D_paths_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PetrelconnectionPropertycollectionsPaths(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\petrelconnection_propertycollections_paths_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Seismic3dClippedCloneOop(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\seismic3D_clipped_clone_oop_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\grid_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertyRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridproperty_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GlobalwelllogRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\globalwelllog_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GlobalwelllogdiscreteRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\globalwelllogdiscrete_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GridpropertydiscreteRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\gridpropertydiscrete_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Horizoninterpretation3dRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\horizoninterpretation3D_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Seismic3dRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\seismic3D_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Seismic2dRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\seismic2D_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_SurfaceRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\surface_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_SurfaceattributeRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\surfaceattribute_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_SurfaceattributediscreteRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\surfaceattributediscrete_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WelllogRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\welllog_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WelllogdiscreteRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\welllogdiscrete_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PointsetRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\pointset_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PolylinesetRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\polylineset_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PolylinesetCloneRootOop(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\polylineset_clone_root_oop_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WaveletBasic(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\wavelet_basic_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WaveletCloneOop(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\wavelet_clone_oop_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WaveletRetrievehistory(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\wavelet_retrievehistory_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WaveletSetter(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\wavelet_setter_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PolylinesetClear(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\polylineset_clear_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_PolylinesetEmptyClone(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\polylineset_empty_clone_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_Workflows(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\workflows_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_ObserveddataBasic(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\observeddata_basic_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_ObserveddatasetBasic(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\observeddataset_basic_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_ObserveddatasetAppendRow(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\observeddataset_append_row_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_ObserveddatasetAddobserveddata(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\observeddataset_addobserveddata_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_GlobalobserveddataPredefined(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\globalobserveddata_predefined_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
    ...
    def test_WellObserveddatasets(self):
        ...
        try:
            ...
            print(e.__class__.__name__)
            print(e)
        with open(r'..\..\blueback.PythonTool.PythonApi.PetrelTest\PythonApiTests\ValidatedScripts\well_observeddatasets_expected.txt', 'r') as f:
            expected_output =  f.read()
        output.seek(0)
        actual_output = output.read()
        sys.stdout = sys_out
