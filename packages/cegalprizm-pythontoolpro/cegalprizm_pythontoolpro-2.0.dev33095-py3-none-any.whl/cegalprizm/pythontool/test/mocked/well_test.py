...
class WellLogTest(InprocessTestCase):
    ...
    def test_mock_borehole(self):
        bh = self.bridge.well_logs['gamma'].borehole
...
class GlobalWellLogTest(InprocessTestCase):
    ...
    def test_can_get_log(self):
        ...
        self.assertEqual(wl.borehole.petrel_name, 'borehole1')
    ...
    def test_can_get_logs_with_different_boreholes(self):
        ...
        self.assertEqual('borehole1', gwl.logs['borehole1'].borehole.petrel_name)
        self.assertEqual('borehole2', gwl.logs['borehole2'].borehole.petrel_name)
