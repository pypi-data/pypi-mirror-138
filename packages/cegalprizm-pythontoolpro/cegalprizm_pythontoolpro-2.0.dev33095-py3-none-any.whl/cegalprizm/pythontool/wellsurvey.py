...
class WellSurvey(PetrelObject):
    ...
    def azimuth_reference(self) -> str:
        """Return the azimuth reference for well survey types MD inclination azimuth survey and DX DY TVD survey 
    ...
    def tie_in_md(self, value: float):
        """Set the tie-in MD for this well survey
    ...
    def as_dataframe(self) -> pd.DataFrame:
        ...
        Returns:
            DataFrame: A dataframe containing the available columns from the well survey spreadsheet
        """
        import numpy as np
        import pandas as pd
