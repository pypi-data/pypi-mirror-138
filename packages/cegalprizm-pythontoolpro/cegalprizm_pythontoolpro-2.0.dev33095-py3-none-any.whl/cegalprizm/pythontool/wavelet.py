...
class Wavelet(PetrelObject):
    ...
    def sample_count(self) -> int:
        ...
        returns:
            int: The number of points in the wavelet.
    ...
    def time_unit_symbol(self) -> str:
        """Returns the unit of the wavelet object
        """        
    ...
    def set(self, amplitudes: typing.Iterable[float], 
        ...
        Args:
            amplitudes (`list` of `float'): a list of the amplitude values
            sampling_start('float'): the starting values of the wavelet
            sampling_interval('float'): the sampling interval of the wavelet

        Raises:
            PythonToolException: if the log is readonly
            ValueError: if the  and values are of difference lengths
        """
