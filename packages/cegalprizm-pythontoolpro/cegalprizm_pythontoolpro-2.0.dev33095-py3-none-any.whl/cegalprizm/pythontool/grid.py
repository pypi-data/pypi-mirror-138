...
class Grid(PetrelObject):
    ...
    def indices(self, x: float, y: float, z: float) -> primitives.Indices:
        ...
        Returns:
            cegalprizm.pythontool.Indices: object representing
               the indices of the containing cell.
    ...
    def position(self, i: int, j: int, k: int) -> primitives.Point:
        ...
        Returns:
            cegalprizm.pythontool.Point: the world coordinates of the cell center
    ...
    def vertices(self, i: int, j: int, k: int) -> typing.List[primitives.Point]:
        ...
        Returns:
            list: A list of :class:`cegalprizm.pythontool.Point` objects.
    ...
    def ijks_to_positions(self, 
            ...
            -> typing.Tuple[typing.List[float], typing.List[float], typing.List[float]]:
        """Converts a 3-tuple with i and j indices to xyz.
    ...
    def properties(self) -> "gridproperty.GridProperties":
        ...
        Returns: 
            cegalprizm.pythontool.GridProperties: the properties for the grid"""
