...
class GridProperty(PetrelObject):
    ...
    def chunk(self,
        ...
        Args:
            i (tuple(int, int)): inclusive range in the i-direction
            j (tuple(int, int)): inclusive range in the j-direction
            k (tuple(int, int)): inclusive range in the k-direction
    ...
    def layer(self, k: int) -> Chunk:
        ...
        Args:
            k (int): the index in the k-direction (the layer)
    ...
    def columns(self,
        ...
        Args:
          ...
          irange (iterable): an iterable (e.g list) of i-values to
                             generate columns for.  If `None`,
                             generate for all i-values

          jrange (iterable): an iterable (e.g. list) of j-values to
                             generate columns for.  If `None`,
    ...
    def layers(self, krange: typing.Tuple[int, int] = None)\
        ...
        Returns a generator of layer
        :class:`cegalprizm.pythontool.Chunk` objects covering the
        `krange` passed

        Args:

          krange (iterable): an iterable (e.g.) of k-values to
                             generate layers for.  If `None`, generate
                             for all k-values

        Raises:
            ValueError: if the k-index is invalid.
    ...
    def has_same_parent(self, other: "GridProperty") -> bool:
        ...
        Args:
            other (cegalprizm.pythontool.GridProperty): the other grid property
