...
class ObservedDataSet(PetrelObject):
    ...
    def well(self) -> "borehole.Well":
        """The well to which this observed data set belongs to

        Returns:
            cegalprizm.pythontool.Well: the well for this observed data set"""
    ...
    def observed_data(self) -> WellObservedData:
        ...
        Returns:
            cegalprizm.pythontool.WellObservedData: the observed data for the observed data set"""
    ...
    def append_row(self, date: datetime.datetime, observed_data: typing.List[ObservedData], observed_data_values: typing.List[float]):
        ...
        Args: 
            date (datetime.datetime): the next date to append, new date must be greater than the the last date entry
            observed_data: the order of the observed data for the new observed_data_values
            observed_data_values: values to user for the new entry, order must match observed_data input
    ...
    def add_observed_data(self, global_observed_data_id: str, observed_data_values: typing.List[float]) -> ObservedData:
        ...
        Args:
            global_observed_data_id (string): the id for the global observed data to add to this observed data set
