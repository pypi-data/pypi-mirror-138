...
class Workflow(PetrelObject):
    ...
    def run(self, 
            args: typing.Dict[typing.Union[str,ReferenceVariable], typing.Union[str, float, int, bool, datetime.datetime, PetrelObject]] = {})\
            -> typing.Dict[ReferenceVariable, typing.Union[PetrelObject, None]]:
        """Executes the workflow in Petrel.

        Args:
        Dictionary: Dictionary with input variables as keys and input as values. It is possible to define additional input variables in this dictionary.
        """
        referenceVars = []
        referenceTargets = [] 
        doubleNames = [] 
