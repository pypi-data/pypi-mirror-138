...
class PointSet(PetrelObject):
    ...
    It is not meant to be explicitely instantiated.
    Use the get_pointset method of the PetrelConnection class.
    ...
    **  The implementation of point sets is in a preliminary state. Handling large point sets may
    ...
    def as_dataframe(self, 
        ...
        **Examples**:
        ...
        Args:
            indices (list of integers, optional): A list or tuple of point indices. Values must be monotonically increasing.
            start (integer, optional): Start index, larger or equal to zero.
            end (integer, optional): End index.
            step (integer, optional): The step. Typically used together with ``start`` and ``end``.
            x_range (2-tuple with integers, optional): A list with minimum and maximum point coordinate in x dimension
            y_range (2-tuple with integers, optional): A list with minimum and maximum point coordinate in y dimension
            z_range (2-tuple with integers, optional): A list with minimum and maximum point coordinate in z dimension
            max_points (integer, optional): Maximum number of points in dataframe.
    ...
    def add_point(self, point: primitives.Point) -> None:
        ...
        **Example**:
        ...
        Args:
            point (cegalprizm.pythontool.Point): the point to add
    ...
    def delete_point(self, point: PointsetPoint) -> None:
        ...
        **Example**:
        ...
        Args:
            point (cegalprizm.pythontool.PointsetPoint): the point to delete
    ...
    def set_values(self, data: pd.DataFrame, create: typing.List[str] = []) -> None:
        ...
        **Example**:
        ...
        Args:
            data (Dataframe): A Pandas Dataframe of attributes with format as returned by as_dataframe() 
            create (list, optional): A list of attribute names to create. Defaults to [].
        """
        import pandas as pd
    ...
    def _attributes_info(self, as_string = False):
        ...
        **Example**:
        ...
        # lines = [] 
        # for property_name, property_dict in parsed.items(): # TODO: parsed is not defined!
        #     lines.append(property_name)
        #     for kk, vv in property_dict.items():
