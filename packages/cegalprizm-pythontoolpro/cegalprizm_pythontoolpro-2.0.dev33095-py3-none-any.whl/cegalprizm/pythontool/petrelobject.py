...
class PetrelObject(object):
    ...
    def petrel_name(self) -> str:
        """The name of this object in Petrel"""
    ...
    def path(self) -> str:
        ...
        :raises:
            NotImplementedError: If invoked when not running as a Python Tool Pro script"""
    ...
    def droid(self) -> str:
        ...
        This property is only available in Python Tool Pro.  This
        property is planned to be deprecated in favour of a similar
    ...
    def template(self) -> str:
        """The Petrel Template for the object

        Returns the Petrel template for the object as a string.
        If not available, will throw an empty string.
        
        Returns:
            str: The petrel template of the object
        """
