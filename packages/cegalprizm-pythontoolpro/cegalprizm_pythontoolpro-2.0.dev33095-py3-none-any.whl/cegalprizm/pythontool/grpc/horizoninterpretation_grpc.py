...
class HorizonProperty3dGrpc(PetrelObjectGrpc):
    ...
    def GetParentHorizonInterpretation3d(self):
        ...
        return grpc_utils.pb_PetrelObjectRef_to_grpcobj(response.GetParentHorizonInterpretation3d, self._plink) if response.GetParentHorizonInterpretation3d.guid else None #TODO: Double check
...
class HorizonInterpretation3dGrpc(HorizonProperty3dGrpc):
    ...
    def GetParent(self):
        ...
        return HorizonInterpretationGrpc(response.GetParent.guid, self._plink) if response.GetParent.guid else None #TODO: Double check
...
class HorizonInterpretationGrpc(PetrelObjectGrpc):
    ...
    def GetHorizonInterpretation3dObjects(self):
        ...
        return [HorizonInterpretation3dGrpc(item.guid, self._plink) if item.guid else None for sublist in responses for item in sublist.GetHorizonInterpretation3dObjects] #TODO: Double check
