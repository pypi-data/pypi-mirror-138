...
class WorkflowGrpc(PetrelObjectGrpc):
    ...
    def GetWorkflowInputReferences(self):
        ...
        return [ReferenceVariableGrpc(item.guid, self._plink) if item.guid else None for sublist in responses for item in sublist.GetWorkflowInputReferences] #TODO: Double check
    ...
    def GetWorkflowOutputReferences(self):
        ...
        return [ReferenceVariableGrpc(item.guid, self._plink) if item.guid else None for sublist in responses for item in sublist.GetWorkflowOutputReferences] #TODO: Double check
    ...
    def RunSingle(
        ...
        return [grpc_utils.pb_PetrelObjectRef_to_grpcobj(val, self._plink) for val in response.RunSingle] #TODO: Double check
