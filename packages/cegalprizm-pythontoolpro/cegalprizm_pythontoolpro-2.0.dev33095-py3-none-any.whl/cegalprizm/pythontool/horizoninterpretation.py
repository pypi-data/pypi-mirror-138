...
class HorizonProperty3d(PetrelObject):
    ...
    def chunk(self, i: typing.Optional[typing.Tuple[int, int]] = None, j: typing.Optional[typing.Tuple[int, int]] = None) -> chunk.Chunk:
        ...
        Args:
            i: A 2-tuple with a start and end inclusive end index for which rows to include
               chunk. If None include all rows.
            j: A 2-tuple with a start and end inclusive end index for which columns to include
               chunk. If None include all columns.
    ...
    def positions_to_ijks(self, positions: typing.Union[typing.Tuple[typing.List[float], typing.List[float]], typing.Tuple[typing.List[float], typing.List[float], typing.List[float]]])\
        ...
        Args:
        positions: 2-tuple with lists repsenting x and y coordinates.

        Returns:
            2-tuple with lists representing the closest i and j indices to each coordinate.
        """ 
        if len(positions) == 2:
    ...
    def ijks_to_positions(self, indices: typing.Tuple[typing.List[float], typing.List[float]])\
        ...
        """Converts a 2-tuple with i and j indices to xyz.


        Args:
            indices: 2-tuple with lists with i and j indices.
    ...
    def horizon_interpretation_3d(self) -> "HorizonInterpretation3d":
        """The parent HorizonInterpretation3d of the horizon interpretation attribute

        Returns:

            cegalprizm.pythontool.HorizonInterpretation3d: The parent HorizonInterpretation3d of the horizon interpretation attribute
        """        
...
class HorizonInterpretation3d(HorizonProperty3d):
    ...
    def horizon_interpretation(self) -> HorizonInterpretation:
        """The parent HorizonInterpretation of the horizon interpretation3d

        Returns:

            cegalprizm.pythontool.HorizonInterpretation: The parent HorizonInterpretation of the horizon interpretation 3d object
        """            
    ...
    def horizon_property_3ds(self) -> typing.List[HorizonProperty3d]:
        """ A list with the Horison Property 3d objects contained within an interpretation.

        returns:
            List of Horizon Property 3ds: A list with Horizon Property 3d objects.
