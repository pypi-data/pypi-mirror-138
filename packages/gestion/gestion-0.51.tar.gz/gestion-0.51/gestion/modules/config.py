...
GESTION_DB_NAME		= "gestion_db_dev2"
...
defaults = 	{
				...
				"node_type"			: "client",
				"project"			: "default",
				"workspace"			: { "root" : os.path.join(os.path.expanduser( "~" ), GESTION_FOLDER_NAME, "default" ) },
