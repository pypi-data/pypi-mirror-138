...
setuptools.setup(
    ...
    description="streamlit-text-annotation is a simple streamlit component for displaying and editing text annotations.",
    long_description="""# streamlit-text-annotation
...
""",
    ...
    url="https://github.com/victoryhb/streamlit-text-annotation",
