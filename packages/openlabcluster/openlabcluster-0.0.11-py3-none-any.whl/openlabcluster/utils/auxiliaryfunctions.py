...
def create_config_template(multianimal=False):
    ...
    #   - is_single_action: true if vidoes contain multiple different actions, false otherwise
...
def get_deeplabcut_path():
    ...
    return os.path.split(importlib.util.find_spec("openlabcluster").origin)[0]
