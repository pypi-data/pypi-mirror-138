...
time_frame = "5m"
wf_freq = '1 D' # Y frequency for walk forward
train_period = ('2021-03-29','2021-04-29')
test_period = ('2021-04-29','2022-01-14')
start_time = "00:00:00"
end_time = "23:55:00" 
...
date_range = pd.date_range(start=start,end=end,freq='1 M') 
