# pyvesynclevoit [![build status](https://img.shields.io/pypi/v/pyvesynclevoit.svg)](https://pypi.python.org/pypi/pyvesynclevoit) [![Build Status](https://dev.azure.com/webdjoe/pyvesynclevoit/_apis/build/status/webdjoe.pyvesynclevoit?branchName=master)](https://dev.azure.com/webdjoe/pyvesynclevoit/_build/latest?definitionId=4&branchName=master) [![Open Source? Yes!](https://badgen.net/badge/Open%20Source%20%3F/Yes%21/blue?icon=github)](https://github.com/Naereen/badges/) [![PyPI license](https://img.shields.io/pypi/l/ansicolortags.svg)](https://pypi.python.org/pypi/ansicolortags/) <!-- omit in toc -->

pyvesynclevoit is a library to manage VeSync compatible [smart home devices](#supported-devices)
...
```python
from pyvesynclevoit import VeSync
