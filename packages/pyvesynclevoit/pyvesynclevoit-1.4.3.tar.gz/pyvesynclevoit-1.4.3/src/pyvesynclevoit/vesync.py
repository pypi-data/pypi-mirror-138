...
from pyvesynclevoit.helpers import Helpers
from pyvesynclevoit.vesyncbasedevice import VeSyncBaseDevice
from pyvesynclevoit.vesyncbulb import VeSyncBulbESL100, VeSyncBulbESL100CW
from pyvesynclevoit.vesyncfan import (
    VeSyncAir131,
    VeSyncHumid200300S,
    VeSyncAir200S,
    VeSyncAir300S400S,
)
from pyvesynclevoit.vesyncoutlet import (
    VeSyncOutlet7A,
    VeSyncOutlet10A,
    VeSyncOutlet15A,
    VeSyncOutdoorPlug,
)
from pyvesynclevoit.vesyncswitch import VeSyncWallSwitch, VeSyncDimmerSwitch
...
_DEVICE_CLASS: Dict[str, Type[VeSyncBaseDevice]] = {
    ...
    'LAP-C301S-WAAA': VeSyncAir300S400S,
...
_DEVICE_TYPES_DICT: Dict[str, List[str]] = dict(
    ...
    fans=['LV-PUR131S', 'Classic200S', 'Classic300S', 'Core200S',
          ...
          'LUH-D301S-WEU', 'LAP-C201S-AUSR', 'LAP-C601S-WUS', 'LAP-C301S-WAAA', 'LAP-C401S-WAAA'],
