...
class DescribeSchedulePaginator(AioPaginator):
    ...
    ) -> AsyncIterable[DescribeScheduleResponseTypeDef]:
        """
...
class ListChannelsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListChannelsResponseTypeDef]:
        """
...
class ListInputDeviceTransfersPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListInputDeviceTransfersResponseTypeDef]:
        """
...
class ListInputDevicesPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListInputDevicesResponseTypeDef]:
        """
...
class ListInputSecurityGroupsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListInputSecurityGroupsResponseTypeDef]:
        """
...
class ListInputsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListInputsResponseTypeDef]:
        """
...
class ListMultiplexProgramsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListMultiplexProgramsResponseTypeDef]:
        """
...
class ListMultiplexesPaginator(AioPaginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListMultiplexesResponseTypeDef]:
        """
...
class ListOfferingsPaginator(AioPaginator):
    ...
    ) -> AsyncIterable[ListOfferingsResponseTypeDef]:
        """
...
class ListReservationsPaginator(AioPaginator):
    ...
    def paginate(
        ...
        *,
        ...
        VideoQuality: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterable[ListReservationsResponseTypeDef]:
        """
