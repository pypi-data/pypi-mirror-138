...
def send_files(**args):        
    ...
    with tqdm(total=coun_files(args['files']), unit='files', desc='Sending files') as pbar:
        pending_files = handler(args['files'], pbar)
...
def receive_files():
    ...
    def process_message(message_body, fnc):        
