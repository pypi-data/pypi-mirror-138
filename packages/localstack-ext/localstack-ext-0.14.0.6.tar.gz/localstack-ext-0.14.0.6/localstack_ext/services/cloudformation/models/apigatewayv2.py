...
class ApiGatewayV2DomainName(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["DomainName"]==domain_name]or[xtCmr])[0]
  return result
 def get_physical_resource_id(self,attribute,**kwargs):
...
class ApiGatewayV2Authorizer(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["Name"]==auth_name]or[xtCmr])[0]
  return result
 def get_physical_resource_id(self,attribute,**kwargs):
...
class ApiGatewayV2Api(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["Name"]==api_name]or[xtCmr])[0]
  return result
 def get_physical_resource_id(self,attribute=xtCmr,**kwargs):
...
class ApiGatewayV2IntegrationResponse(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return xtCmu(ApiGatewayV2IntegrationResponse,self).get_cfn_attribute(attribute_name)
 @xtCmS
 def get_deploy_templates():
...
class ApiGatewayV2Integration(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  integrations=[r for r in resp.get("Items",[])if int_type==r.get("IntegrationType")and int_uri in[xtCmr,r.get("IntegrationUri")]and int_meth in[xtCmr,r.get("IntegrationMethod")]]
  return(integrations or[xtCmr])[0]
 @xtCmS
 def get_deploy_templates():
...
class ApiGatewayV2Stage(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  stage_name=self.resolve_refs_recursively(stack_name,props.get("StageName"),resources)
  client=aws_stack.connect_to_service("apigatewayv2")
  return client.get_stage(ApiId=api_id,StageName=stage_name)or xtCmr
 def get_physical_resource_id(self,attribute=xtCmr,**kwargs):
  if attribute in REF_ID_ATTRS:
