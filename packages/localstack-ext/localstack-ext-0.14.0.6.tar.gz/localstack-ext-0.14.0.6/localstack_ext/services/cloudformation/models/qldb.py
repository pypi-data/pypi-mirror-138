...
class QLDBLedger(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=FpxTn,**kwargs):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return result
 @FpxTY
 def add_defaults(resource:Dict,stack_name:FpxTI):
 ...
 def get_deploy_templates():
  def _delete_ledger(resource_id,resources,*args,**kwargs):
   ...
   qldb.update_ledger(Name=ledger_name,DeletionProtection=FpxTy)
