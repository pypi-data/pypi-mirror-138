...
class CPVCSMergeManager(SubtypesInstanceManager):
 @rBFSk
 def _is_special_case(obj)->rBFSd:
  return rBFSo(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:rBFSC,to_state_files):
  raise rBFSY("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:rBFSC,from_state_files:rBFSC,to_state_files:rBFSC):
  raise rBFSY("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:rBFSC)->Dict[rBFSC,rBFSC]:
