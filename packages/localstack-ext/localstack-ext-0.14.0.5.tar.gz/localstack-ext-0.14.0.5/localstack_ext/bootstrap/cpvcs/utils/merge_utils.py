...
class CPVCSMergeManager(SubtypesInstanceManager):
 @UstJu
 def _is_special_case(obj)->UstJr:
  return UstJg(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:UstJK,to_state_files):
  raise UstJO("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:UstJK,from_state_files:UstJK,to_state_files:UstJK):
  raise UstJO("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:UstJK)->Dict[UstJK,UstJK]:
