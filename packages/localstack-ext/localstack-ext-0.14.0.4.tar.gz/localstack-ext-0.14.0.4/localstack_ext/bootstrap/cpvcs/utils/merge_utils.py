...
class CPVCSMergeManager(SubtypesInstanceManager):
 @NvJiq
 def _is_special_case(obj)->NvJiR:
  return NvJiK(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:NvJiB,to_state_files):
  raise NvJiI("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:NvJiB,from_state_files:NvJiB,to_state_files:NvJiB):
  raise NvJiI("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:NvJiB)->Dict[NvJiB,NvJiB]:
