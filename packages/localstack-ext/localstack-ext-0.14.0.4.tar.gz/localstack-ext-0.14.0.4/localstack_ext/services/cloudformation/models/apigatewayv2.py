...
class ApiGatewayV2DomainName(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["DomainName"]==domain_name]or[CEcRa])[0]
  return result
 def get_physical_resource_id(self,attribute,**kwargs):
...
class ApiGatewayV2Authorizer(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["Name"]==auth_name]or[CEcRa])[0]
  return result
 def get_physical_resource_id(self,attribute,**kwargs):
...
class ApiGatewayV2Api(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["Name"]==api_name]or[CEcRa])[0]
  return result
 def get_physical_resource_id(self,attribute=CEcRa,**kwargs):
...
class ApiGatewayV2IntegrationResponse(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return CEcRJ(ApiGatewayV2IntegrationResponse,self).get_cfn_attribute(attribute_name)
 @CEcRA
 def get_deploy_templates():
...
class ApiGatewayV2Integration(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  integrations=[r for r in resp.get("Items",[])if int_type==r.get("IntegrationType")and int_uri in[CEcRa,r.get("IntegrationUri")]and int_meth in[CEcRa,r.get("IntegrationMethod")]]
  return(integrations or[CEcRa])[0]
 @CEcRA
 def get_deploy_templates():
...
class ApiGatewayV2Stage(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  stage_name=self.resolve_refs_recursively(stack_name,props.get("StageName"),resources)
  client=aws_stack.connect_to_service("apigatewayv2")
  return client.get_stage(ApiId=api_id,StageName=stage_name)or CEcRa
 def get_physical_resource_id(self,attribute=CEcRa,**kwargs):
  if attribute in REF_ID_ATTRS:
