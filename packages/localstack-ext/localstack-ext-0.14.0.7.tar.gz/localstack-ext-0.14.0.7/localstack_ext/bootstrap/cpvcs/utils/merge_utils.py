...
class CPVCSMergeManager(SubtypesInstanceManager):
 @ljUyG
 def _is_special_case(obj)->ljUyT:
  return ljUyi(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:ljUyQ,to_state_files):
  raise ljUyr("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:ljUyQ,from_state_files:ljUyQ,to_state_files:ljUyQ):
  raise ljUyr("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:ljUyQ)->Dict[ljUyQ,ljUyQ]:
