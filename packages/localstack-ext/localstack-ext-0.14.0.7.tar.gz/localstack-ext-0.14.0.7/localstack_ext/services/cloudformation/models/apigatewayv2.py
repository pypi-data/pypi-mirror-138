...
class ApiGatewayV2DomainName(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["DomainName"]==domain_name]or[hVQqo])[0]
  return result
 def get_physical_resource_id(self,attribute,**kwargs):
...
class ApiGatewayV2Authorizer(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["Name"]==auth_name]or[hVQqo])[0]
  return result
 def get_physical_resource_id(self,attribute,**kwargs):
...
class ApiGatewayV2Api(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  result=([a for a in apis if a["Name"]==api_name]or[hVQqo])[0]
  return result
 def get_physical_resource_id(self,attribute=hVQqo,**kwargs):
...
class ApiGatewayV2IntegrationResponse(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return hVQqb(ApiGatewayV2IntegrationResponse,self).get_cfn_attribute(attribute_name)
 @hVQqd
 def get_deploy_templates():
...
class ApiGatewayV2Integration(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  integrations=[r for r in resp.get("Items",[])if int_type==r.get("IntegrationType")and int_uri in[hVQqo,r.get("IntegrationUri")]and int_meth in[hVQqo,r.get("IntegrationMethod")]]
  return(integrations or[hVQqo])[0]
 @hVQqd
 def get_deploy_templates():
...
class ApiGatewayV2Stage(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  stage_name=self.resolve_refs_recursively(stack_name,props.get("StageName"),resources)
  client=aws_stack.connect_to_service("apigatewayv2")
  return client.get_stage(ApiId=api_id,StageName=stage_name)or hVQqo
 def get_physical_resource_id(self,attribute=hVQqo,**kwargs):
  if attribute in REF_ID_ATTRS:
