...
import azureml._vendor.azure_cli_core.decorators as decorators
...
def flush():
    ...
    # disabling telemetry of vendored azure-cli-core
    # save(get_az_config_dir(), _session.generate_payload())
...
def is_telemetry_enabled():
    from azureml._vendor.azure_cli_core.cloud import cloud_forbid_telemetry
