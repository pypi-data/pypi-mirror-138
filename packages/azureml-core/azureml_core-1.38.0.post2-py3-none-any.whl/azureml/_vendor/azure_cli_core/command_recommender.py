...
class CommandRecommender():  # pylint: disable=too-few-public-methods
    ...
    def _set_aladdin_recommendations(self):  # pylint: disable=too-many-locals
        ...
        from azureml._vendor.azure_cli_core import __version__ as version
    ...
    def provide_recommendations(self):
        ...
        from azureml._vendor.azure_cli_core.style import Style, highlight_command
        from azureml._vendor.azure_cli_core.parser import OVERVIEW_REFERENCE
    ...
    def _disable_aladdin_service(self):
        ...
        from azureml._vendor.azure_cli_core.cloud import CLOUDS_FORBIDDING_ALADDIN_REQUEST
