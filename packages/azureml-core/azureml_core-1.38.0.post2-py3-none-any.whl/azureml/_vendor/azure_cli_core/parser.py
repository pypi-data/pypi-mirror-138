...
from azureml._vendor.azure_cli_core.commands import ExtensionCommandSource
from azureml._vendor.azure_cli_core.commands import AzCliCommandInvoker
from azureml._vendor.azure_cli_core.commands.events import EVENT_INVOKER_ON_TAB_COMPLETION
from azureml._vendor.azure_cli_core.command_recommender import CommandRecommender
from azureml._vendor.azure_cli_core.azclierror import UnrecognizedArgumentError
from azureml._vendor.azure_cli_core.azclierror import RequiredArgumentMissingError
from azureml._vendor.azure_cli_core.azclierror import InvalidArgumentValueError
from azureml._vendor.azure_cli_core.azclierror import ArgumentUsageError
from azureml._vendor.azure_cli_core.azclierror import CommandNotFoundError
from azureml._vendor.azure_cli_core.azclierror import ValidationError
...
class AzCliCommandParser(CLICommandParser):
    ...
    def error(self, message):
        ...
        if '--query' in message:
            from azureml._vendor.azure_cli_core.util import QUERY_REFERENCE
    ...
    def _check_value(self, action, value):
        ...
        if action.choices is not None and value not in action.choices:  # pylint: disable=too-many-nested-blocks
            ...
            if not self.command_source:
                from azureml._vendor.azure_cli_core.extension.dynamic_install import try_install_extension
                candidates = []
