...
class AzCli(CLI):
    ...
    def __init__(self, **kwargs):
        ...
        from azureml._vendor.azure_cli_core.commands import register_cache_arguments
        from azureml._vendor.azure_cli_core.commands.arm import (
            register_ids_argument, register_global_subscription_argument)
        from azureml._vendor.azure_cli_core.cloud import get_active_cloud
        from azureml._vendor.azure_cli_core.commands.transform import register_global_transforms
        from azureml._vendor.azure_cli_core._session import ACCOUNT, CONFIG, SESSION, INDEX, VERSIONS
        from azureml._vendor.azure_cli_core.util import handle_version_update
        from azureml._vendor.azure_cli_core.commands.query_examples import register_global_query_examples_argument
        ...
        # This tried to update azure cli and validate config files related to azure cli
        # Since this part is only used for interactive auth we do not need to validate cli versions
    ...
    def get_progress_controller(self, det=False, spinner=None):
        import azureml._vendor.azure_cli_core.commands.progress as progress
    ...
    def show_version(self):
        from azureml._vendor.azure_cli_core.util import get_az_version_string, show_updates
        from azureml._vendor.azure_cli_core.commands.constants import SURVEY_PROMPT_STYLED, UX_SURVEY_PROMPT_STYLED
        from azureml._vendor.azure_cli_core.style import print_styled_text
    ...
    def exception_handler(self, ex):  # pylint: disable=no-self-use
        from azureml._vendor.azure_cli_core.util import handle_exception
    ...
    def _configure_style(self):
        ...
        from azureml._vendor.azure_cli_core.style import format_styled_text, get_theme_dict, Style
...
class MainCommandsLoader(CLICommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        import pkgutil
        import traceback
        from azureml._vendor.azure_cli_core.commands import (
            _load_module_command_loader, _load_extension_command_loader, BLOCKED_MODS, ExtensionCommandSource)
        from azureml._vendor.azure_cli_core.extension import (
        ...
        def _update_command_table_from_modules(args, command_modules=None):
            ...
            for mod in [m for m in command_modules if m not in BLOCKED_MODS]:
                try:
                    ...
                    # module loading.
                    import azureml._vendor.azure_cli_core.telemetry as telemetry
            ...
            if extensions:
                ...
                for ext in allowed_extensions:
                    try:
                        ...
                        from azureml._vendor.azure_cli_core.extension.operations import check_version_compatibility
        ...
        if use_command_index:
            ...
            if index_result:
                ...
                from azureml._vendor.azure_cli_core.util import roughly_parse_command
    ...
    def load_arguments(self, command=None):
        from azureml._vendor.azure_cli_core.commands.parameters import (
...
class CommandIndex:
    ...
    def __init__(self, cli_ctx=None):
        ...
        """
        from azureml._vendor.azure_cli_core._session import INDEX
        self.INDEX = INDEX
        if cli_ctx:
...
class AzCommandsLoader(CLICommandsLoader):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, cli_ctx=None, command_group_cls=None, argument_context_cls=None,
        ...
        from azureml._vendor.azure_cli_core.commands import AzCliCommand, AzCommandGroup, AzArgumentContext
    ...
    def _apply_doc_string(self, dest, command_kwargs):
        from azureml._vendor.azure_cli_core.profiles._shared import APIVersionException
    ...
    def get_api_version(self, resource_type=None, operation_group=None):
        from azureml._vendor.azure_cli_core.profiles import get_api_version
    ...
    def supported_api_version(self, resource_type=None, min_api=None, max_api=None, operation_group=None):
        from azureml._vendor.azure_cli_core.profiles import supported_api_version
    ...
    def supported_resource_type(self, resource_type=None):
        from azureml._vendor.azure_cli_core.profiles import supported_resource_type
        return supported_resource_type(
            cli_ctx=self.cli_ctx,
            resource_type=resource_type or self._get_resource_type())

    def get_sdk(self, *attr_args, **kwargs):
        from azureml._vendor.azure_cli_core.profiles import get_sdk
    ...
    def _cli_command(self, name, operation=None, handler=None, argument_loader=None, description_loader=None, **kwargs):
        ...
        def default_command_handler(command_args):
            from azureml._vendor.azure_cli_core.util import get_arg_list, augment_no_wait_handler_args
            from azureml._vendor.azure_cli_core.commands.client_factory import resolve_client_arg_name
    ...
    def get_op_handler(self, operation, operation_group=None):
        ...
        from azureml._vendor.azure_cli_core.profiles import AZURE_API_PROFILES
        from azureml._vendor.azure_cli_core.profiles._shared import get_versioned_sdk_path
...
def get_default_cli():
    from azureml._vendor.azure_cli_core.azlogging import AzCliLogging
    from azureml._vendor.azure_cli_core.commands import AzCliCommandInvoker
    from azureml._vendor.azure_cli_core.parser import AzCliCommandParser
    from azureml._vendor.azure_cli_core._config import GLOBAL_CONFIG_DIR, ENV_VAR_PREFIX
    from azureml._vendor.azure_cli_core._help import AzCliHelp
    from azureml._vendor.azure_cli_core._output import AzOutputProducer
