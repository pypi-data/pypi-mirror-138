...
# --------------------------------------------------------------------------------------------
import argparse
from azureml._vendor.azure_cli_core import AzCommandsLoader, EXCLUDED_PARAMS
...
class GenericUpdateCommandOperation(BaseCommandOperation):     # pylint: disable=too-many-instance-attributes
    ...
    def handler(self, command_args):  # pylint: disable=too-many-locals, too-many-statements, too-many-branches
        ...
        from azureml._vendor.azure_cli_core.commands import cached_get, cached_put, _is_poller
        from azureml._vendor.azure_cli_core.util import find_child_item, augment_no_wait_handler_args
        from azureml._vendor.azure_cli_core.commands.arm import add_usage, remove_usage, set_usage,\
    ...
    def _extract_op_handler_and_args(self, args, op_path):
        from azureml._vendor.azure_cli_core.commands.arm import EXCLUDED_NON_CLIENT_PARAMS
    ...
    def arguments_loader(self):
        """ Callback function of CLICommand arguments_loader """
        from azureml._vendor.azure_cli_core.commands.arm import set_usage, add_usage, remove_usage
...
class ShowCommandOperation(BaseCommandOperation):
    ...
    def handler(self, command_args):
        """ Callback function of CLICommand handler """
        from azureml._vendor.azure_cli_core.commands.arm import show_exception_handler, EXCLUDED_NON_CLIENT_PARAMS
...
class WaitCommandOperation(BaseCommandOperation):
    ...
    def handler(self, command_args):    # pylint: disable=too-many-statements, too-many-locals
        ...
        from knack.util import CLIError
        from azureml._vendor.azure_cli_core.commands.arm import EXCLUDED_NON_CLIENT_PARAMS, verify_property
