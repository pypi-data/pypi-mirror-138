...
from azureml._vendor.azure_cli_core.commands.constants import CLI_PARAM_KWARGS, CLI_POSITIONAL_PARAM_KWARGS
from azureml._vendor.azure_cli_core.commands.validators import validate_tag, validate_tags, generate_deployment_name
from azureml._vendor.azure_cli_core.decorators import Completer
from azureml._vendor.azure_cli_core.profiles import ResourceType
from azureml._vendor.azure_cli_core.local_context import LocalContextAttribute, LocalContextAction, ALL
...
def get_subscription_locations(cli_ctx):
    from azureml._vendor.azure_cli_core.commands.client_factory import get_subscription_service_client
...
class AzArgumentContext(ArgumentsContext):
    ...
    def __init__(self, command_loader, scope, **kwargs):
        from azureml._vendor.azure_cli_core.commands import _merge_kwargs as merge_kwargs
