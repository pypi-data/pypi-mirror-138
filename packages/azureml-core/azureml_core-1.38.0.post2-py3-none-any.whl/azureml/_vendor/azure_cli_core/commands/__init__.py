...
from azureml._vendor.azure_cli_core.commands.constants import (
...
from azureml._vendor.azure_cli_core.extension import get_extension
from azureml._vendor.azure_cli_core.util import (
    get_command_type_kwarg, read_file_content, get_arg_list, poller_classes)
from azureml._vendor.azure_cli_core.local_context import LocalContextAction
import azureml._vendor.azure_cli_core.telemetry as telemetry
from azureml._vendor.azure_cli_core.commands.progress import IndeterminateProgressBar
...
def _explode_list_args(args):
    ...
    '''
    from azureml._vendor.azure_cli_core.commands.validators import IterateValue
...
class CacheObject:
    ...
    def path(self, args, kwargs):
        ...
        from azureml._vendor.azure_cli_core.commands.client_factory import get_subscription_id
...
class AzCliCommandInvoker(CommandInvoker):
    ...
    def execute(self, args):
        ...
        from azureml._vendor.azure_cli_core.commands.events import (
    ...
    def _validate_arg_level(self, ns, **_):  # pylint: disable=no-self-use
        from azureml._vendor.azure_cli_core.azclierror import AzCLIError
...
class LongRunningOperation:  # pylint: disable=too-few-public-methods
    ...
    def _generate_template_progress(self, correlation_id):  # pylint: disable=no-self-use
        ...
        from azureml._vendor.azure_cli_core.commands.client_factory import get_mgmt_service_client
    ...
    def __call__(self, poller):  # pylint: disable=too-many-statements
        ...
        try:
            ...
            from azureml._vendor.azure_cli_core.commands.arm import handle_long_running_operation_exception
            if self.progress_bar:
                self.progress_bar.stop()
...
class AzCommandGroup(CommandGroup):
    ...
    def generic_update_command(self, name, getter_name='get', getter_type=None,
        ...
        from azureml._vendor.azure_cli_core.commands.command_operation import GenericUpdateCommandOperation
        self._check_stale()
    ...
    def _wait_command(self, name, getter_name='get', getter_type=None, custom_command=False, **kwargs):
        from azureml._vendor.azure_cli_core.commands.command_operation import WaitCommandOperation
        self._check_stale()
        merged_kwargs = self._flatten_kwargs(kwargs, get_command_type_kwarg(custom_command))
        self._apply_tags(merged_kwargs, kwargs, name)
    ...
    def _show_command(self, name, getter_name='get', getter_type=None, custom_command=False, **kwargs):
        from azureml._vendor.azure_cli_core.commands.command_operation import ShowCommandOperation
        self._check_stale()
        merged_kwargs = self._flatten_kwargs(kwargs, get_command_type_kwarg(custom_command))
        self._apply_tags(merged_kwargs, kwargs, name)
