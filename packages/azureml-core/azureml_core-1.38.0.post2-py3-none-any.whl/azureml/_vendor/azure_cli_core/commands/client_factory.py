...
import azureml._vendor.azure_cli_core._debug as _debug
from azureml._vendor.azure_cli_core.auth.util import resource_to_scopes
from azureml._vendor.azure_cli_core.extension import EXTENSIONS_MOD_PREFIX
from azureml._vendor.azure_cli_core.profiles import ResourceType, CustomResourceType, get_api_version, get_sdk
from azureml._vendor.azure_cli_core.profiles._shared import get_client_class, SDKProfile
from azureml._vendor.azure_cli_core.util import get_az_user_agent, is_track2
...
def _prepare_client_kwargs_track2(cli_ctx):
    ...
    from azureml._vendor.azure_cli_core.sdk.policies import SafeNetworkTraceLoggingPolicy
