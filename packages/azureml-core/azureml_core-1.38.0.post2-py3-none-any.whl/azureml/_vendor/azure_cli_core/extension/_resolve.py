...
from azureml._vendor.azure_cli_core.extension import ext_compat_with_cli, WHEEL_INFO_RE
from azureml._vendor.azure_cli_core.extension._index import get_index_extensions
