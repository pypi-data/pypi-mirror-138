...
from azureml._vendor.azure_cli_core import CommandIndex
from azureml._vendor.azure_cli_core.util import CLIError, reload_module, rmtree_with_retry
from azureml._vendor.azure_cli_core.extension import (extension_exists, build_extension_path, get_extensions, get_extension_modname,
...
from azureml._vendor.azure_cli_core.telemetry import set_extension_management_detail
...
def _install_deps_for_psycopg2():  # pylint: disable=too-many-statements
    ...
    import platform
    import subprocess
    from azureml._vendor.azure_cli_core.util import get_linux_distro
