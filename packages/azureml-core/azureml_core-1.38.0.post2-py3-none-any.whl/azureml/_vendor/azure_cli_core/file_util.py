...
from azureml._vendor.azure_cli_core._help import CliCommandHelpFile, CliGroupHelpFile
...
def create_invoker_and_load_cmds_and_args(cli_ctx):
    ...
    from azureml._vendor.azure_cli_core.commands.arm import register_global_subscription_argument, register_ids_argument
