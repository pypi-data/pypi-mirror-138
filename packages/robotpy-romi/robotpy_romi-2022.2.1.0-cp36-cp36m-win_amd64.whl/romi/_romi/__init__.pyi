...
class RomiGyro(wpilib.interfaces._interfaces.Gyro):
    ...
    def reset(self) -> None: 
        ...
        """
    pass
class RomiMotor(wpilib._wpilib.PWMMotorController, wpilib.interfaces._interfaces.MotorController, wpilib.interfaces._interfaces.SpeedController, wpilib._wpilib.MotorSafety, wpiutil._wpiutil.Sendable):
    """
    RomiMotor
